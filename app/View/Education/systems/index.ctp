	...
	<table class="table table-striped table-hover table-bordered">
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo $this->Html->link($obj[$model]['name'], array('action' => 'levels', Inflector::underscore($model.'Id') => $obj[$model]['id'])); ?></td>
				<td class="center"><?php echo $this->Html->link($this->Icon->get('details'), array('action' => $_action.'View', $obj[$model]['id']), array('escape' => false)); ?></td>
			</tr>
			<?php } ?>
		</tbody>
	</table>
