...
echo $this->Html->link(__('View'), array('action' => 'classes', $selectedYear), array('class' => 'divider'));
$this->end();
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class="table_cell cell_value cell_number total_classes"><?php echo $totalClasses; ?></td>
                        <td class="table_cell cell_value cell_number total_seats"><?php echo $totalSeats; ?></td>
                    </tr>
                </tfoot>
            </table>
        </fieldset>
