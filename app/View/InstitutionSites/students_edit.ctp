...
<div id="students" class="content_wrapper edit">
	...
	?>
	<h1>
		<span><?php echo __('Edit Programme Students'); ?></span>
	...
	<fieldset class="section_group" id="student_group" style="min-height: 280px;">
		<legend>
			<span><?php echo __('Student List'); ?></span>
			<?php if($_delete) { ?>
			<!--a class="divider void"><?php echo __('Remove All'); ?></a-->
			<?php } ?>
		</legend>
