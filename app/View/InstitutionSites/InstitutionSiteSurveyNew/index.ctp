...
<div class="panel-group" id="survey_accordion" role="tablist" aria-multiselectable="true">
					...
					<a class="collapsed" data-toggle="collapse" data-parent="#survey_accordion" href="#collapse<?php echo $i; ?>" aria-expanded="false" aria-controls="collapse<?php echo $i; ?>">
						<table width="100%">
							<tr>
								...
								<td align="right">
									<small><i><?php echo __('To be completed by : '); ?></i><b><?php echo $obj['SurveyStatus']['date_disabled']; ?></b></small>
								</td>
							</tr>
						</table>
					</a>
