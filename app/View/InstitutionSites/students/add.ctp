...
//	));
	...
	<div class="info">
		...
		<?php 
				...
				echo $this->Form->input('institution_site_programme_id', array('id' => 'InstitutionSiteProgrammeId', 'class' => 'default form-control', 'options' => $programmeOptions, 'label' => $labelOptions));
				
				$labelOptions['text'] = $this->Label->get('general.status');
				echo $this->Form->input('student_status_id', array('class' => 'default form-control', 'options' => $statusOptions, 'label' => $labelOptions));
