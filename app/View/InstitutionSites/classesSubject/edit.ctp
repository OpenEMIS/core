		...
		<tbody>
			...
			<tr>
				<td class="checkbox-column">
					...
					echo $this->Form->hidden($i . '.institution_site_class_id', array('value' => $id));
					echo $this->Form->hidden($i . '.education_grade_subject_id', array('value' => $obj['EducationGradeSubject']['id']));
