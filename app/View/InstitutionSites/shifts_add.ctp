...
<div id="shifts" class="content_wrapper edit add">
    ...
    <div class="row">
        ...
        <div class="value">
            <?php echo $this->Form->input('location_institution_site_name', array('id' => 'locationName', 'value' => $institutionSiteName)); ?>
            <?php echo $this->Form->hidden('location_institution_site_id', array('id' => 'locationInstitutionSiteId', 'value' => $institutionSiteId)); ?>
        </div>
    </div>
    <div class="controls">
