...
?>
		...
		<div class="table_row">
			...
			<div class="table_cell" name="<?php echo $obj['first_name'] . ' ' . $obj['last_name']; ?>"><?php echo $firstName; ?></div>
			<div class="table_cell" name="<?php echo $obj['first_name'] . ' ' . $obj['last_name']; ?>"><?php echo $lastName; ?></div>
			<div class="table_cell cell_icon_action"><span class="icon_plus" row-id="<?php echo $obj['id']; ?>"></span></div>
		</div>
