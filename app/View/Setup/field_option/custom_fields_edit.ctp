...
<div id="custom" class="content_wrapper">
	...
	<h1>
		...
		<?php echo $this->Html->link(__('View'), array('action' => 'fieldOption', $defaultModel, $sitetype), array('class' => 'divider')); ?>
	</h1>
	...
	<div class="controls">
		...
		<?php echo $this->Html->link(__('Cancel'), array('action' => 'fieldOption', $defaultModel, $sitetype), array('class' => 'btn_cancel btn_left')); ?>
	</div>
