...
class NavigationComponent extends Component {
	...
	public function getInstitutionsLinks() {
		$links = array(
			...
			array(
				array(
					$this->createLink('Institution Details', 'Institutions', 'view', 'view$|^edit$|history$'),
					$this->createLink('Attachments', 'Institutions', 'attachments'),
					$this->createLink('Additional Info', 'Institutions', 'additional'),
			...
			array(
				'SITE INFORMATION' => array(
					...
					$this->createLink('Additional Info', 'InstitutionSites', 'additional'),
				...
				'CENSUS' => array(
					...
					$this->createLink('Other Forms', 'Census', 'otherforms')
				)
			)
		);
		return $links;
