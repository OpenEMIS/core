...
class InstitutionSiteStudentAbsence extends AppModel {
	...
	public function reportsGetData($args) {
		...
		if ($index == 1) {
			...
			$options['order'] = array('SchoolYear.name', 'InstitutionSiteStudentAbsence.first_date_absent', 'Student.first_name', 'Student.middle_name', 'Student.third_name', 'Student.last_name');
