...
class EducationCertification extends AppModel {
	...
	public $_action = 'certifications';
	public $_header = 'Education Certifications';
	...
	public function certifications($controller, $params) {
		$data = $this->find('all', array('order' => $this->alias.'.order'));
		$controller->set(compact('data'));
	}
	
	public function certificationsAdd($controller, $params) {
	...
	public function certificationsView($controller, $params) {
	...
	public function certificationsEdit($controller, $params) {
		$id = isset($params->pass[0]) ? $params->pass[0] : 0;
		$data = $this->findById($id);
