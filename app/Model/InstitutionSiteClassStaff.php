	...
	public function getStaffs($classId, $mode = 'all') {
		$data = $this->find('all', array(
			...
			'fields' => array(
				...
				'InstitutionSiteClassStaff.education_subject_id', 'EducationSubject.name'
			),
			'joins' => array(
				array(
					'table' => 'staff',
				...
				array(
					...
					'type' => 'LEFT',
					'conditions' => array('EducationSubject.id = InstitutionSiteClassStaff.education_subject_id')
				)
			),
