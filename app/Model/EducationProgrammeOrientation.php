...
class EducationProgrammeOrientation extends AppModel {
	...
	public $_action = 'orientations';
	public $_header = 'Programme Orientations';
	...
	public function orientations($controller, $params) {
		$data = $this->find('all', array('order' => $this->alias.'.order'));
		$controller->set(compact('data'));
	}
	
	public function orientationsAdd($controller, $params) {
	...
	public function orientationsView($controller, $params) {
	...
	public function orientationsEdit($controller, $params) {
		$id = isset($params->pass[0]) ? $params->pass[0] : 0;
		$data = $this->findById($id);
