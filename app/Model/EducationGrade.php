...
class EducationGrade extends AppModel {
	...
	public $virtualFields = array(
		...
		'programme_order' => "SELECT `EducationProgramme`.`order` from `education_programmes` AS `EducationProgramme` WHERE `EducationProgramme`.`id` = `EducationGrade.education_programme_id`"
	);
