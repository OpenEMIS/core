    ...
    <div class="controls">
        ...
        <?php }else{?>
            <?php 
               ...
               if(!$wizardEnd){
                    echo $this->Form->submit(__('Next'), array('div'=>false, 'name'=>'submit', 'name'=>'submit','class'=>"btn_cancel btn_cancel_button btn_right",'onclick'=>"return Config.checkValidate();")); 
               }else{
