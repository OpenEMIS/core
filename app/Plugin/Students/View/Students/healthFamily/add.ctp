...
echo $this->Form->input('health_relationship_id', array('options' => $healthRelationshipsOptions, 'label' => array('text' => $this->Label->get('HealthRelationship.name'), 'class' => 'col-md-3 control-label')));
