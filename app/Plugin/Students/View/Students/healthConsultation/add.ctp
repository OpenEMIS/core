...
<div id="student" class="content_wrapper edit add">
	<h1>
		...
		if(!empty($this->data[$modelName]['id'])){
			echo $this->Html->link(__('View'), array('action' => 'healthConsultationView', $this->data[$modelName]['id']), array('class' => 'divider'));
		}
		else{
	...
	echo $this->Form->create($modelName, array(
		'url' => array('controller' => 'Students', 'action' => 'healthConsultationAdd', 'plugin'=>'Students'),
		'type' => 'file',
	...
	<div class="controls view_controls">
		...
		<?php echo $this->Html->link(__('Cancel'), array('action' => 'healthConsultation'), array('class' => 'btn_cancel btn_left')); ?>
	</div>
