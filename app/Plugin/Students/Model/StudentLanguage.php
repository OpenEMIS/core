...
class StudentLanguage extends StudentsAppModel {
    ...
    public function languagesView($controller, $params) {
        ...
        $controller->Session->write('StudentLanguageId', $id);
    ...
    public function languagesDelete($controller, $params) {
        if ($controller->Session->check('StudentId') && $controller->Session->check('StudentLanguageId')) {
            $id = $controller->Session->read('StudentLanguageId');
            if ($this->delete($id)) {
            ...
            $controller->Session->delete('StudentLanguageId');
            return $controller->redirect(array('action' => 'languages'));
        }
    }
