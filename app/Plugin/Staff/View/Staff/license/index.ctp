...
<div id="license" class="content_wrapper">
    <h1>
        ...
        <?php
		if($_edit) {
			echo $this->Html->link(__('Add'), array('action' => 'license_add'), array('class' => 'divider'));
		}
		?>
    </h1>
    <?php echo $this->element('alert'); ?>
    <?php if(isset($data)) { ?>
    <div class="table allow_hover full_width" action="<?php echo $this->params['controller'];?>/license_view/">
