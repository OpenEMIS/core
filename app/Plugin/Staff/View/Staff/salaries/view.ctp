...
<div class="row">
	...
	<div class="col-md-6"><?php echo $this->Utility->formatDate($data['salary_date']); ?></div>
</div>

<div class="row">
	<div class="col-md-3"><?php echo __('Gross Salary'); ?></div>
	<div class="col-md-6"><?php echo $data['gross_salary']; ?></div>
</div>

<div class="row">
	<div class="col-md-3"><?php echo __('Net Salary'); ?></div>
	<div class="col-md-6"><?php echo $data['net_salary']; ?></div>
</div>

<div class="row">
	<div class="col-md-3"><?php echo __('Comment'); ?></div>
	<div class="col-md-6"><?php echo $data['comment']; ?></div>
</div>

<div class="row">
	<div class="col-md-3"><?php echo __('Additions'); ?></div>
	<div class="col-md-9">
		<?php
		$tableHeader = array(__('Type'), __('Amount'));
		$tableData = array();

		foreach ($salaryObj['StaffSalaryAddition'] as $obj) {
			$row = array();
			$row[] = $additionOptions[$obj['salary_addition_type_id']];
			$row[] = array($obj['addition_amount'], array('class' => 'cell-number'));
			$tableData[] = $row;
		}
		...
		$tableFooter = array(
			array(
				...
				array(empty($data['additions'])? 0 :$data['additions'] , array('class' => 'cell-number'))
		));
		?>
...
<div class="row">
	<div class="col-md-3"><?php echo __('Deductions'); ?></div>
	<div class="col-md-9">
		<?php
		$tableHeader = array(__('Type'), __('Amount'));
		$tableData = array();

		foreach ($salaryObj['StaffSalaryDeduction'] as $obj) {
			$row = array();
			$row[] = $deductionOptions[$obj['salary_deduction_type_id']];
			$row[] = array($obj['deduction_amount'], array('class' => 'cell-number'));
			$tableData[] = $row;
		}
		...
		$tableFooter = array(
			array(
				array(__('Total'), array('class' => 'cell-number')),
				array(empty($data['deductions'])?0:$data['deductions'] , array('class' => 'cell-number'))
		));
		?>
		<div class="table-responsive">
			<table class="table table-striped table-hover table-bordered">
  ...
  <fieldset class="section_group">
    ...
    <div class="table full_width">
        ...
        <div class="table_body">
            <?php
            $totalAdditions = 0;
            if(isset($salaryObj['StaffSalaryAddition']) && !empty($salaryObj['StaffSalaryAddition'])){ 
            foreach($salaryObj['StaffSalaryAddition'] as $key=>$value){ ?>
                <?php 
                $index = $key;
                $order = $index;
                ?>
    ...
    <div class="table full_width">
        ...
        <div class="table_body">
            <?php
            $totalDeductions = 0;
            if(isset($salaryObj['StaffSalaryDeduction']) && !empty($salaryObj['StaffSalaryDeduction'])){ 
            foreach($salaryObj['StaffSalaryDeduction'] as $key=>$value){ ?>
                <?php 
                $index = $key;
                $order = $index;
                ?>
...
*/ ?>
   <div class="row">
        ...
        <div class="col-md-6"><?php echo trim($salaryObj['ModifiedUser']['first_name'] . ' ' . $salaryObj['ModifiedUser']['last_name']); ?></div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6"><?php echo trim($salaryObj['CreatedUser']['first_name'] . ' ' . $salaryObj['CreatedUser']['last_name']); ?></div>
    </div>
