...
<div id="bankAccountEdit" class="content_wrapper add">
   <h1>
	...
	<div class="row edit">
		...
		<div class="value"><?php echo $this->Form->input('bank_branch_id', array('class' => 'full_width', $this->request->data['StaffBankAccount']['bank_branch_id'], 'label'=>false, 'options'=>$bankBranch, 'empty' => __('--Select--'))); ?></div>
	</div>
