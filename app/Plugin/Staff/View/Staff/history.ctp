	...
	<fieldset class="section_break">
        ...
        <div class="row">
            ...
            <div class="col-md-6"><?php //pr($data); ?>
                            <span style="margin-left: 8px;"><?php echo $data['SecurityUser']['openemis_no']; ?></span>
                            <?php if(@sizeof($data2['openemis_no'])>0){ ?>
		...
		<div class="row">
			...
			<div class="col-md-6">
                            <span style="margin-left: 8px;"><?php echo $data['SecurityUser']['first_name']; ?></span>
        ...
        <div class="row">
			...
			<div class="col-md-6">
                            <span style="margin-left: 8px;"><?php echo $data['SecurityUser']['middle_name']; ?></span>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                            <span style="margin-left: 8px;"><?php echo $data['SecurityUser']['third_name']; ?></span>
		...
		<div class="row">
			...
			<div class="col-md-6">
                            <span style="margin-left: 8px;"><?php echo $data['SecurityUser']['last_name']; ?></span>
