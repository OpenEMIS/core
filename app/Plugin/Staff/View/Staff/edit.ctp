...
/*echo $this->Form->create('Staff', array(
	'url' => array('controller' => 'Staffs', 'action' => 'edit'),
	'type' => 'file',
...
echo $this->Form->create('Staff', $formOptions);
?>
...
<fieldset class="section_break">
	...
	<?php 
			...
			if($autoid==''){
				...
				$tempIdNo = isset($this->data['Staff']['identification_no'])?$this->data['Staff']['identification_no'] : '';
				echo $this->Form->hidden(null, array('id'=>'validate_staff_identification', 'name' => 'validate_staff_identification', 'value'=>$tempIdNo));
			}else{
			...
			$tempDob = isset($this->data['Staff']['date_of_birth'])?array('data-date' => $this->data['Staff']['date_of_birth']) : array();
...
<fieldset class="section_break">
	...
	<?php 
		...
		$tempPostCode = isset($this->data['Staff']['postal_code'])?$this->data['Staff']['postal_code'] : '';
...
<fieldset class="section_break area">
	<legend id="area"><?php echo __('Address Area'); ?></legend>
		<?php echo @$this->Utility->getAreaPicker($this->Form, 'address_area_id',$this->data['Staff']['address_area_id'], array()); ?>

</fieldset>

<fieldset class="section_break area">
	<legend id="area"><?php echo __('Birth Place Area'); ?></legend>
		<?php echo @$this->Utility->getAreaPicker($this->Form, 'birthplace_area_id',$this->data['Staff']['birthplace_area_id'], array()); ?>
