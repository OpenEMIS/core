...
<fieldset class="section_break">
	...
	<?php echo $this->FormUtility->areapicker('address_area_id', array('model' => 'AreaAdministrative', 'value' => $addressAreaId)); ?>
</fieldset>

<fieldset class="section_break">
	<legend><?php echo __('Birth Place Area'); ?></legend>
	<?php echo $this->FormUtility->areapicker('birthplace_area_id', array('model' => 'AreaAdministrative', 'value' => $birthplaceAreaId)); ?>
</fieldset>
