...
<div id="students" class="content_wrapper search">
	...
	echo $this->Form->hidden('area_id', array('id' => 'area_id', 'value' => $session->read('Staff.AdvancedSearch.area_id')));
	?>
	<div class="row">
		<div class="label"><?php echo __('Area'); ?></div>
		<div class="value"><?php echo $this->Form->input('area', array('id' => 'area', 'type' => 'text', 'onfocus' => 'this.select()', 'value' => $session->read('Staff.AdvancedSearch.area'))); ?></div>
	</div>
