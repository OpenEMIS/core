...
<div id="student" class="content_wrapper edit add">
	<h1>
		...
		if(!empty($this->data[$modelName]['id'])){
			echo $this->Html->link(__('View'), array('action' => 'healthFamilyView', $this->data[$modelName]['id']), array('class' => 'divider'));
		}
		else{
			echo $this->Html->link(__('List'), array('action' => 'healthFamily'), array('class' => 'divider'));
		}
		?>
	</h1>
	...
	echo $this->Form->create($modelName, array(
		'url' => array('controller' => 'Staff', 'action' => 'healthFamilyAdd', 'plugin'=>'Staff'),
		'type' => 'file',
	...
	<div class="controls view_controls">
		...
		<?php echo $this->Html->link(__('Cancel'), array('action' => 'healthFamily'), array('class' => 'btn_cancel btn_left')); ?>
	</div>
