...
<div id="bank_accounts" class="content_wrapper">
	...
	if($_add) {
		echo $this->Form->create('StaffBankAccount', array(
			'id' => 'StaffBankAccount',
			'url' => array('controller' => 'Staff', 'action' => 'bankAccounts')
		));
	?>
			...
			echo '<div class="table_row">
					<div class="table_cell">
						<div class="input_wrapper">
							<input type="text" name="data[StaffBankAccount][account_name]" value="" />
						</div>
					</div>
					<div class="table_cell">
						<div class="input_wrapper">
							<input type="text" name="data[StaffBankAccount][account_number]" value=""/>
						</div>
					</div>
					<div class="table_cell">
					...
					<div class="table_cell">
						<select name="data[StaffBankAccount][bank_branch_id]" class="full_width">
