		...
		<table class="table table-striped table-hover table-bordered table-checkable table-input">
			...
			<tbody>
				<?php foreach($arrv as $arrValues) {
					...
					$arrExtra = array('hiddenField' => false,'type'=>'checkbox','class' => 'icheck-input','name'=>'data[Reports][]','value'=>$chkval, 'disabled' => (($chkval == '2000' || $chkval == '2001'|| $chkval == '2011')?'':'disabled'));
