			...
			if($_execute) {
				if($obj['training_status_id'] == 2 || $obj['training_status_id']==3){
					if($obj['training_status_id'] == 2){
						echo $this->Html->link(__('Activate'), array('action' => 'resultActivate'), array('class' => 'divider', 'onclick' => 'return jsForm.confirmDelete(this)'));
					}
					echo $this->Html->link(__('Inactivate'), array('action' => 'resultInactivate'), array('class' => 'divider', 'onclick' => 'return jsForm.confirmDelete(this)'));
				}
			}
		?>
	</h1>
