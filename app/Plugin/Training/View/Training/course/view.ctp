...
<div id="training_course" class="content_wrapper">
	...
	<?php echo $this->element('alert'); ?>
		...
		<div class="row">
			...
			<!--div class="value"><?php echo $this->TrainingUtility->getTrainingStatus($modelName,$data['TrainingStatus']['name'],$data['TrainingStatus']['id']); ?> <?php echo(isset($workflowStatus)?  $workflowStatus : ''); ?></di-->
