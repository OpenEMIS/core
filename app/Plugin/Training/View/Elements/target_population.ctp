	...
	<td class="table_cell cell_description" style="width:90%">
		<div class="input_wrapper">
	 	<div class="position-title-name-<?php echo $index;?>">
			<?php echo $this->Form->input('TrainingCourseTargetPopulation.' . $index . '.position_name', array('id' => 'searchTargetPopulation'.$index, 'div' => false, 'maxlength'=>50, 'label' => false, 'placeholder' => __('Position Title'))); ?>	
		</div>
		<?php echo $this->Form->hidden('TrainingCourseTargetPopulation.' . $index . '.staff_position_title_id', array('class' => 'position-title-id-'.$index)); ?>
