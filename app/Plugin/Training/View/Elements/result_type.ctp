...
<tr class="table_row <?php echo ($index+1)%2==0 ? 'li_even' : ''; ?>" row-id="<?php echo $index;?>">
	<td class="table_cell cell_description" style="width:90%">
		...
		'label' => false, 'options' => $trainingResultTypeOptions, 'class' => 'form-control result-type-validate-'.$index . ' validate-result-type','onchange'=>'objTrainingCourses.validateResultType();')); ?>	
    </td>
