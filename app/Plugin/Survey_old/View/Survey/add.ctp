...
$this->assign('contentHeader', __('New Surveys'));
...
<!-- No Database value for the moment -->
    <div>
        <?php echo $this->Form->input('year', array('options' => $year, 'id' => 'year'));  ?>
        <?php echo $this->Form->input('category', array('options' => $category, 'id' => 'category', 'onChange' => 'Survey.siteTypeChange();'));  ?>
        <?php echo $this->Form->input('siteTypes', array('div'=>'form-group SiteTypeDDL', 'options' => $siteTypes, 'id'=> 'siteTypes', 'onChange' => 'Survey.siteTypeChange();'));  ?>
        <?php echo $this->Form->input('filename', array('type' => 'text', 'id' => 'filename'));  ?>
    </div>
                                    ...
                                    <?php if($arrSecVal['type']=='Grid_Multi'){ ?> 
                                        ...
                                        <table style=" <?php if($arrSecVal['type']=='Grid_Fix' || $arrSecVal['type']=='Grid_Unlimited'){ echo 'display:none'; } ?>;" class="table table-striped table-hover table-bordered">
                                            <thead>
                                                ...
                                                <th style="width:80px;">
                                                <?php
                                                    echo $this->Form->input($topic.'.'.$section.'.checked', array('label'=>false, 'div'=>false, 'between'=>false, 'after'=>false, 'type' => 'checkbox','onchange'=>'Survey.activate(this, \'.table_row\')'));
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                        echo $this->Form->input($topic.'.'.$section.'.questions.'.$question.'.checked', 
                                                                            array('label'=>false, 'div'=>false, 'between'=>false, 'after'=>false, 'type' => 'checkbox','onchange'=>'Survey.activateQuestion(this, \'.table_row\')'));
                                        ...
                                        <table style=" <?php if($arrSecVal['type']=='Grid_Fix' || $arrSecVal['type']=='Grid_Unlimited'){ echo ''; } ?>;" class="table table-striped table-hover table-bordered">
                                            <thead>
                                                ...
                                                <?php
                                                    echo $this->Form->input($topic.'.'.$section.'.checked', array(
                                                        'label'=>false, 'div'=>false, 'between'=>false, 'after'=>false, 'type' => 'checkbox',
                                            ...
                                            <?php foreach($arrSecVal['questions'] as $question => $arrQuestionVal) { ?>
                                                <tr>
                                                    ...
                                                    <?php
                                                        echo $this->Form->input($topic.'.'.$section.'.questions.'.$question.'.checked', 
                                                                            array('label'=>false, 'between'=>false, 'after'=>false, 'type' => 'checkbox','onchange'=>'Survey.activateQuestion(this, \'.table_row\')'));
                                                        echo $this->Form->input($topic.'.'.$section.'.questions.'.$question.'.order', 
                                                                            array( 'value' => $arrQuestionVal['order'], 'type' => 'hidden'));
                                                        echo $this->Form->input($topic.'.'.$section.'.questions.'.$question.'.type', 
                                                                            array( 'value' => $arrQuestionVal['type'], 'type' => 'hidden'));
