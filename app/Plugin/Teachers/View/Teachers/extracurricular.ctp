...
<div id="extracurricular" class="content_wrapper">
	...
	<div class="table allow_hover full_width" action="Teachers/extracurricularView/">
		...
		<div class="table_body">
			...
			<div class="table_row" row-id="<?php echo $obj['TeacherExtracurricular']['id']; ?>">
				<div class="table_cell"><?php echo $obj['SchoolYears']['name']; ?></div>
				<div class="table_cell"><?php echo $this->Utility->formatDate($obj['TeacherExtracurricular']['start_date']); ?></div>
				<div class="table_cell"><?php echo $obj['ExtracurricularType']['name']; ?></div>
                <div class="table_cell"><?php echo $obj['TeacherExtracurricular']['name']; ?></div>
			</div>
			<?php endforeach; ?>
		</div>
	</div>
