...
<div id="bankAccountEdit" class="content_wrapper add">
   <h1>
	...
	echo $this->Form->create('TeacherBankAccount', array(
			...
			'url' => array('controller' => 'Teachers', 'action' => 'bankAccountsEdit', $id, $selectedBank),
	...
	<div class="row edit branch">
		...
		<div class="value"><?php echo $this->Form->input('bank_branch_id', array($this->request->data['TeacherBankAccount']['bank_branch_id'], 'label'=>false, 'options'=>$bankBranch, 'empty' => __('--Select--'))); ?></div>
	</div>
