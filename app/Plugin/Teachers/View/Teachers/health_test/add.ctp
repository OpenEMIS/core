...
<div id="student" class="content_wrapper edit add">
	<h1>
		...
		if(!empty($this->data[$modelName]['id'])){
			echo $this->Html->link(__('View'), array('action' => 'health_test_view', $this->data[$modelName]['id']), array('class' => 'divider'));
		}
		else{
	...
	echo $this->Form->create($modelName, array(
		'url' => array('controller' => 'Teachers', 'action' => 'health_test_add', 'plugin'=>'Teachers'),
		'type' => 'file',
