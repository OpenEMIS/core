...
<div id="nationality" class="content_wrapper edit add">
	...
	echo $this->Form->create('TeacherNationality', array(
		'url' => array('controller' => 'Teachers', 'action' => 'nationalitiesEdit'),
		'inputDefaults' => array('label' => false, 'div' => false, 'class' => 'default', 'autocomplete' => 'off')
	));
	?>
    <?php $obj = @$this->request->data['TeacherNationality']; ?>
	<?php echo $this->Form->input('TeacherNationality.id');?>
	 ...
	 <div class="controls">
	   <?php if(!$WizardMode){ ?>
        ...
        <?php echo $this->Html->link(__('Cancel'), array('action' => 'nationalitiesView'), array('class' => 'btn_cancel btn_left')); ?>
        <?php }else{?>
            <?php 
