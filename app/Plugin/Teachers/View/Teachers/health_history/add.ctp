...
<div id="student" class="content_wrapper edit add">
	<h1>
		...
		if(!empty($this->data[$modelName]['id'])){
			echo $this->Html->link(__('View'), array('action' => 'health_history_view', $this->data[$modelName]['id']), array('class' => 'divider'));
		}
		else{
			echo $this->Html->link(__('List'), array('action' => 'health_history'), array('class' => 'divider'));
		}
		?>
	</h1>
	...
	echo $this->Form->create($modelName, array(
		'url' => array('controller' => 'Teachers', 'action' => 'health_history_add', 'plugin'=>'Teachers'),
		'type' => 'file',
	...
	<div class="controls view_controls">
		...
		<?php echo $this->Html->link(__('Cancel'), array('action' => 'health_history'), array('class' => 'btn_cancel btn_left')); ?>
	</div>
