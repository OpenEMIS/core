            ...
            foreach($this->request->data['TeacherSalaryAddition'] as $key=>$value){ ?>
                ...
                <div data-id="<?php echo $index; ?>" class="table_row new_row <?php echo $order%2==0 ? 'even' : ''; ?>">
                    <div class="table_cell">
                        ...
                        <?php echo $this->Form->input('TeacherSalaryAddition.'.$index.'.salary_addition_type_id', array('class'=>'default', 'label' => false, 'options' => $additionOptions, 'default'=>$value['salary_addition_type_id'], 'empty'=>__('--Select'))); ?>
                    </div>
                    <div class="table_cell">
            ...
            foreach($this->request->data['TeacherSalaryDeduction'] as $key=>$value){ ?>
                ...
                <div data-id="<?php echo $index; ?>" class="table_row new_row <?php echo $order%2==0 ? 'even' : ''; ?>">
                    <div class="table_cell">
                        ...
                        <?php echo $this->Form->input('TeacherSalaryDeduction.'.$index.'.salary_deduction_type_id', array('class'=>'default', 'label' => false, 'options' => $deductionOptions, 'default'=>$value['salary_deduction_type_id'], 'empty'=>__('--Select'))); ?>
                    </div>
                    <div class="table_cell">                        
