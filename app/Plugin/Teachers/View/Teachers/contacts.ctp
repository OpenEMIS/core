...
<div id="contact" class="content_wrapper">
	...
	<div class="table allow_hover full_width" action="Teachers/contactsView/">
		...
		<div class="table_body">
			...
			<div class="table_row" row-id="<?php echo $obj['TeacherContact']['id']; ?>">
				<div class="table_cell"><?php echo $obj['ContactType']['name']; ?></div>
				<div class="table_cell"><?php echo $obj['TeacherContact']['value']; ?></div>
				<div class="table_cell cell_visible"><?php echo $this->Utility->checkOrCrossMarker($obj['TeacherContact']['preferred']==1); ?></div>
			</div>
			<?php } ?>
			<?php endforeach; ?>
		</div>
