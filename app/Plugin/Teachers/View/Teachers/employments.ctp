...
<div id="employment" class="content_wrapper">
	...
	<div class="table allow_hover full_width" action="Teachers/employmentsView/">
		...
		<div class="table_body">
			...
			<div class="table_row" row-id="<?php echo $obj['TeacherEmployment']['id']; ?>">
				<div class="table_cell"><?php echo $obj['EmploymentType']['name']; ?></div>
				<div class="table_cell"><?php echo $this->Utility->formatDate($obj['TeacherEmployment']['employment_date']); ?></div>
				<div class="table_cell"><?php echo $obj['TeacherEmployment']['comment']; ?></div>
			</div>
			<?php endforeach; ?>
		</div>
	</div>
