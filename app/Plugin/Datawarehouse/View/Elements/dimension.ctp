...
<div class="tab-pane" id="tab-<?php echo $type;?>">
	...
	<?php echo $this->Form->input('DatawarehouseField.'.$type.'_datawarehouse_field_id', array('class'=>$type.'FieldOption form-control','options'=>${$type.'DatawarehouseOperatorFieldOptions'},  'label'=>array('text'=> $this->Label->get('Datawarehouse.function'),'class'=>'col-md-3 control-label'), 'onchange'=>'objDatawarehouse.populateByOperator(this, "'.$type.'");'));?>
	<?php echo $this->Form->input('DatawarehouseField.'.$type.'_datawarehouse_operator', array('type'=> 'hidden', 'class'=>$type.'OperatorOption form-control')); ?>

	<div class="<?php echo $type;?>Dimension">
		<?php echo $this->Form->input('DatawarehouseField.'.$type.'_datawarehouse_dimension_id', array('type'=>'select', 'multiple'=>'checkbox', 'label'=>array('text'=> $this->Label->get('Datawarehouse.dimensions'),'class'=>'col-md-3 control-label'), 'div'=>'form-group form-dimension', 'class'=>'col-md-6 filter-dimension', 'options'=>${$type.'DatawarehouseDimensionOptions'})); ?>
		<div style="height: 200px; overflow-x: hidden;overflow-y: scroll;" class="divSubgroupList">
