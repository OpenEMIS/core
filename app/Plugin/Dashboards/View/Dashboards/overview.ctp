...
<div id="dashboard" class="dashboard_wrapper edit add">
	...
	<div class="row left">
        ...
        <div class="value"><?php echo $this->Form->input('geo_level_id', array('options' => $geoLvlOptions, 'default' => $geoLvlId, 'class' => 'dash_options', 'url' => 'Dashboards/dashboardsAjaxGetArea', 'onchange' => 'Dashboards.areaChange(this)')); ?></div>
    </div>
	<div class="row left">
