...
$this->start('contentBody');
	...
	echo $this->Form->create('SurveyQuestion', $formOptions);
		...
		echo $this->Form->hidden('SurveyTemplate.name', array('value' => $data['SurveyTemplate']['name']));
		$labelOptions['text'] = __('Name');
		echo $this->Form->input('survey_template_name', array('disabled' => 'disabled', 'label' => $labelOptions, 'value' => $data['SurveyTemplate']['name']));
