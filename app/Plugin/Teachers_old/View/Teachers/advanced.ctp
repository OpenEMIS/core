...
<div id="teachers" class="content_wrapper search">
	<h1>
	...
	echo $this->Form->create('Search', array(
		'url' => array('controller' => 'Teachers', 'action' => 'advanced'),
		'inputDefaults' => array('label' => false, 'div' => false, 'class' => 'default')
	));
	echo $this->Form->hidden('area_id', array('id' => 'area_id', 'value' => $session->read('Teacher.AdvancedSearch.Search.area_id')));
	?>
        <h3><?php echo __('General'); ?></h3>
	<div class="row">
		<div class="label"><?php echo __('Area'); ?></div>
		<div class="value"><?php echo $this->Form->input('area', array('id' => 'area', 'type' => 'text', 'onfocus' => 'this.select()', 'value' => $session->read('Teacher.AdvancedSearch.Search.area'))); ?></div>
	</div>
	<h3>Custom Fields</h3>
...
$(document).ready(function() {
    ...
    objCustomFieldSearch.getDataFields(0,'Teacher');
