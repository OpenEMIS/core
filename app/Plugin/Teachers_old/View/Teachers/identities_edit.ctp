...
<div id="identity" class="content_wrapper edit add">
	...
	echo $this->Form->create('TeacherIdentity', array(
		'url' => array('controller' => 'Teachers', 'action' => 'identitiesEdit'),
		'inputDefaults' => array('label' => false, 'div' => false, 'class' => 'default', 'autocomplete' => 'off')
	));
	?>
    <?php $obj = @$this->request->data['TeacherIdentity']; ?>
    ...
    <div class="row">
	 ...
	 <div class="controls">
	   <?php if(!$WizardMode){ ?>
        ...
        <?php echo $this->Html->link(__('Cancel'), array('action' => 'identitiesView'), array('class' => 'btn_cancel btn_left')); ?>
        <?php }else{?>
            <?php 
