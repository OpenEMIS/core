	...
	<div class="table full_width">
		...
		<div class="table_body">
			...
			<div class="table_row">
				...
				<div class="table_cell">
					<?php echo $this->Utility->formatDate($record['InstitutionSiteTeacher']['start_date'],'F Y'); ?>
				</div>
				<div class="table_cell">
					<?php echo $this->Utility->formatDate($record['InstitutionSiteTeacher']['end_date'],'F Y'); ?>
				</div>
			</div>
			<?php endforeach; ?>
		</div>
