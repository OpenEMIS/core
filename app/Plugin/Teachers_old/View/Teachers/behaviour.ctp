...
<div id="behaviour" class="content_wrapper">
    ...
    <?php if(!empty($data)) { ?>
	<div class="table full_width allow_hover" action="Teachers/behaviourView/">
		...
		<div class="table_body">
			...
			<div class="table_row" row-id="<?php echo $obj['TeacherBehaviour']['id']; ?>">
				<div class="table_cell"><?php echo $this->Utility->formatDate($obj['TeacherBehaviour']['date_of_behaviour']); ?></div>
