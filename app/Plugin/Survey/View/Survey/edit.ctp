...
<div id="surveyedit" class="content_wrapper">
	...
	echo $this->Form->create('add', array(
		...
		'url' => array('controller' => 'Survey', 'action' => 'edit')
	));
	?>
	<h1>
		...
		if($_add) {
			...
			//echo $this->Html->link(__('Download'), array('action' => 'download',$name), array('class' => 'divider'));
		}
		?>
	</h1>
	...
	<div class="controls">
        ...
        <input type="hidden" name="year" id="year" value="<?php echo $myYear; ?>"/>
        <input type="hidden" name="category" id="category" value="<?php echo $myCategory; ?>"/>
        <input type="hidden" name="siteTypes" id="siteTypes" value="<?php echo $mySiteID; ?>"/>
