	...
	<div class="row">
            ...
            <div class="left" style="width:300px;">
                <div class="search_wrapper">
					<?php echo $this->Form->input('Search', array(
                        ...
                        'label' => false));
                    ?>
                    <span class="icon_clear" onclick="location.href='<?php echo $this->Html->url(array('controller'=>'Survey','action'=>'synced'));?>'">X</span>
                </div>
                <?php echo $this->Js->submit('', array(
                    'id'=>'searchbutton',
                    'class'=>'icon_search',
                    'url'=> $this->Html->url(array('action'=>'synced','full_base'=>true))));
                ?>
        	</div>
		...
		<div class="action_pullright">
			<div class="right" style="padding-left:20px;">
                <div class="left">
                <?php echo $this->Html->image('icons/sync.png',array(
									'controller' => 'Survey',
									'action' => 'download')); ?> 
                </div>
                <div class="left" style="padding-left:10px;">
                <?php
                    echo $this->Html->link('' . __('ReSync'),array(
									'controller' => 'Survey',
									'action' => 'download'));
                ?>
                </div>
