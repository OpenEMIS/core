...
UPDATE security_functions SET _view = 'StudentSpecialNeed|StudentSpecialNeed.index|StudentSpecialNeed.view', _edit = '_view:StudentSpecialNeed.edit', _add = '_view:StudentSpecialNeed.add', _delete = '_view:StudentSpecialNeed.remove', _execute = '_view:StudentSpecialNeed.excel' WHERE controller = 'Students' AND module = 'Students' AND category = 'General' AND name = 'Special Needs';
...
UPDATE security_functions SET _view = 'StaffSpecialNeed|StaffSpecialNeed.index|StaffSpecialNeed.view', _edit = '_view:StaffSpecialNeed.edit', _add = '_view:StaffSpecialNeed.add', _delete = '_view:StaffSpecialNeed.remove', _execute = '_view:StaffSpecialNeed.excel' WHERE controller = 'Staff' AND module = 'Staff' AND category = 'General' AND name = 'Special Needs';
