...
INSERT INTO `institution_site_staff` (`id`, `FTE`, `start_date`, `start_year`, `end_date`, `end_year`, `staff_id`, `staff_type_id`, `staff_status_id`, `institution_site_id`, `institution_site_position_id`, `modified_user_id`, `modified`, `created_user_id`, `created`)
  SELECT `id`, `FTE`, `start_date`, `start_year`, `end_date`, `end_year`, `staff_id`, `staff_type_id`, `staff_status_id`, `institution_site_id`, `institution_site_position_id`, `modified_user_id`, `modified`, `created_user_id`, `created` from `1278_institution_site_staff` where 1;
