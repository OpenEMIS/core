...
UPDATE `security_functions` SET `controller` = 'QualityRubrics', `_view` = 'index|RubricTemplate|RubricTemplate.index|RubricTemplate.view|RubricSection|RubricSection.index|RubricSection.view|RubricCriteria|RubricCriteria.index|RubricCriteria.view|RubricCriteria.preview|RubricTemplateOption|.index|RubricTemplateOption.view', `_edit` = '_view:RubricTemplate.edit|RubricSection.edit|RubricSection.reorder|RubricCriteria.edit|RubricCriteria.reorder|RubricTemplateOption.edit|RubricTemplateOption.reorder', `_add` = '_view:RubricTemplate.add|RubricSection.add|RubricCriteria.add|RubricTemplateOption.add', `_delete` = '_view:RubricTemplate.remove|RubricSection.remove|RubricCriteria.remove|RubricTemplateOption.remove' WHERE `controller` = 'Quality' AND `module` = 'Administration' AND `category` = 'Quality' AND `name` = 'Rubrics';
UPDATE `security_functions` SET `controller` = 'QualityStatuses', `_view` = 'index|view', `_edit` = '_view:edit' , `_add` = '_view:add', `_delete` = '_view:remove' WHERE `controller` = 'Quality' AND `module` = 'Administration' AND `category` = 'Quality' AND `name` = 'Status';

UPDATE `security_functions` SET `controller` = 'InstitutionSites', `_view` = 'InstitutionSiteQualityRubric|InstitutionSiteQualityRubric.index|InstitutionSiteQualityRubric.view', `_edit` = '_view:InstitutionSiteQualityRubric.edit' , `_add` = NULL, `_delete` = '_view:InstitutionSiteQualityRubric.remove', `_execute` = NULL WHERE `controller` = 'Quality' AND `module` = 'Institutions' AND `category` = 'Quality' AND `name` = 'Rubrics';
