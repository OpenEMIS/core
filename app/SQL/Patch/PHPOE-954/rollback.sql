...
UPDATE `navigations` SET `visible` = 1 WHERE `controller` = 'Reports' AND `action` IN ('InstitutionAttendance', 'InstitutionAssessment', 'InstitutionBehaviors', 'InstitutionFinance', 'InstitutionTotals', 'InstitutionQuality');
