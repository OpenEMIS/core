...
(NULL , 'General', 'Reports', 'Reports', 'Institutions', '-1', 'InstitutionGeneral', NULL , NULL , NULL , '_view:InstitutionGeneralDownload|InstitutionGeneralViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),
(NULL , 'Details', 'Reports', 'Reports', 'Institutions', '-1', 'InstitutionDetails', NULL , NULL , NULL , '_view:InstitutionDetailsDownload|InstitutionDetailsViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),
(NULL , 'Attendance', 'Reports', 'Reports', 'Institutions', '-1', 'InstitutionAttendance', NULL , NULL , NULL , '_view:InstitutionAttendanceDownload|InstitutionAttendanceViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),
(NULL , 'Assessment', 'Reports', 'Reports', 'Institutions', '-1', 'InstitutionAssessment', NULL , NULL , NULL , '_view:InstitutionAssessmentDownload|InstitutionAssessmentViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),
(NULL , 'Behaviors', 'Reports', 'Reports', 'Institutions', '-1', 'InstitutionBehaviors', NULL , NULL , NULL , '_view:InstitutionBehaviorsDownload|InstitutionBehaviorsViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),
(NULL , 'Finance', 'Reports', 'Reports', 'Institutions', '-1', 'InstitutionFinance', NULL , NULL , NULL , '_view:InstitutionFinanceDownload|InstitutionFinanceViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),
(NULL , 'Totals', 'Reports', 'Reports', 'Institutions', '-1', 'InstitutionTotals', NULL , NULL , NULL , '_view:InstitutionTotalsDownload|InstitutionTotalsViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),
(NULL , 'Quality', 'Reports', 'Reports', 'Institutions', '-1', 'InstitutionQuality', NULL , NULL , NULL , '_view:InstitutionQualityDownload|InstitutionQualityViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),

(NULL , 'General', 'Reports', 'Reports', 'Students', '-1', 'StudentGeneral', NULL , NULL , NULL , '_view:StudentGeneralDownload|StudentGeneralViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),
(NULL , 'Details', 'Reports', 'Reports', 'Students', '-1', 'StudentDetails', NULL , NULL , NULL , '_view:StudentDetailsDownload|StudentDetailsViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),
(NULL , 'Finance', 'Reports', 'Reports', 'Students', '-1', 'StudentFinance', NULL , NULL , NULL , '_view:StudentFinanceDownload|StudentFinanceViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),
(NULL , 'Health', 'Reports', 'Reports', 'Students', '-1', 'StudentHealth', NULL , NULL , NULL , '_view:StudentHealthDownload|StudentHealthViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),

(NULL , 'General', 'Reports', 'Reports', 'Staff', '-1', 'StaffGeneral', NULL , NULL , NULL , '_view:StaffGeneralDownload|StaffGeneralViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),
(NULL , 'Details', 'Reports', 'Reports', 'Staff', '-1', 'StaffDetails', NULL , NULL , NULL , '_view:StaffDetailsDownload|StaffDetailsViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),
(NULL , 'Finance', 'Reports', 'Reports', 'Staff', '-1', 'StaffFinance', NULL , NULL , NULL , '_view:StaffFinanceDownload|StaffFinanceViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),
(NULL , 'Health', 'Reports', 'Reports', 'Staff', '-1', 'StaffHealth', NULL , NULL , NULL , '_view:StaffHealthDownload|StaffHealthViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),
(NULL , 'Training', 'Reports', 'Reports', 'Staff', '-1', 'StaffTraining', NULL , NULL , NULL , '_view:StaffTrainingDownload|StaffTrainingViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),

(NULL , 'General', 'Reports', 'Reports', 'Yearbook', '-1', 'YearbookGeneral', NULL , NULL , NULL , '_view:YearbookGeneralDownload|YearbookGeneralViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),

(NULL , 'General', 'Reports', 'Reports', 'Maps', '-1', 'MapGeneral', NULL , NULL , NULL , '_view:MapGeneralDownload|MapGeneralViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),

(NULL , 'General', 'Reports', 'Reports', 'Dashboards', '-1', 'DashboardGeneral', NULL , NULL , NULL , '_view:DashboardGeneralDownload|DashboardGeneralViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),

(NULL , 'Data Quality', 'Reports', 'Reports', 'System', '-1', 'SystemDataQuality', NULL , NULL , NULL , '_view:SystemDataQualityDownload|SystemDataQualityViewHtml', (@securityFuncLatestOrder := @securityFuncLatestOrder + 1), '1', NULL , NULL , '1', '0000-00-00 00:00:00'),
