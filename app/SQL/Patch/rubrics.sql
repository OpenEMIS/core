...
-- ALTER TABLE `institution_site_class_staffs ` DROP INDEX `teacher_id`, ADD INDEX `staff_id` ( `staff_id` );

ALTER TABLE `quality_institution_rubrics` CHANGE `teacher_id` `staff_id` INT( 11 ) NOT NULL ;

ALTER TABLE `quality_institution_rubrics` DROP INDEX `teacher_id`, ADD INDEX `staff_id` ( `staff_id` );

ALTER TABLE `quality_institution_visits` CHANGE `teacher_id` `staff_id` INT( 11 ) NOT NULL ;

ALTER TABLE `quality_institution_visits` DROP INDEX `teacher_id`, ADD INDEX `staff_id` ( `staff_id` );
