...
(NULL, 'Visualizer', 'Visualizer', 'Visualizer', -1, 'index|indicator|unit|dimension|area|time|source|visualization|review|reset', NULL, NULL, NULL, 'genCSV', 0, 1, NULL, NULL, 1, '0000-00-00 00:00:00');
...
UPDATE `security_functions` SET `_view` = 'index|indicator|unit|dimension|area|time|source|visualization|review|reset' WHERE `security_functions`.`name` = 'Visualizer' AND  `security_functions`.`controller` = 'Visualizer' ;