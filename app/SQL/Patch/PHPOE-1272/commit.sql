...
DELETE FROM config_items WHERE type = 'Wizard - Add New Student' AND name = 'student_nationalities';
DELETE FROM config_items WHERE type = 'Wizard - Add New Student' AND name = 'student_identities';
DELETE FROM config_items WHERE type = 'Wizard - Add New Staff' AND name = 'staff_nationalities';
DELETE FROM config_items WHERE type = 'Wizard - Add New Staff' AND name = 'staff_identities';
