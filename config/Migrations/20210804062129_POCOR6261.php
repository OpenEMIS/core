...
class POCOR6261 extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        ...
        // user_identities
        $this->execute('CREATE TABLE `zz_6261_user_identities` LIKE `user_identities`');
        $this->execute('INSERT INTO `zz_6261_user_identities` SELECT * FROM `user_identities`');
        
        // security_users
        $this->execute('CREATE TABLE `zz_6261_security_users` LIKE `security_users`');
        $this->execute('INSERT INTO `zz_6261_security_users` SELECT * FROM `security_users`');
    ...
    public function down()
    {
        ...
        $this->execute('RENAME TABLE `zz_6261_user_identities` TO `user_identities`');
        
        // security_users
        $this->execute('DROP TABLE IF EXISTS `security_users`');
        $this->execute('RENAME TABLE `zz_6261_security_users` TO `security_users`');
    }
}
