...
class POCOR5189Update extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        ...
        $this->execute('CREATE TABLE `zz_5189Update_security_functions` LIKE `security_functions`');
        $this->execute('INSERT INTO `zz_5189Update_security_functions` SELECT * FROM `security_functions`');
        ...
        $this->execute("INSERT INTO `security_functions` (`name`, `controller`, `module`, `category`, `parent_id`, `_view`, `_edit`, `_add`, `_delete`, `_execute`, `order`, `visible`, `description`, `modified_user_id`, `modified`, `created_user_id`, `created`) 
            VALUES ('Associations', 'Associations.excel', 'Institutions', 'Staff - Career', '3000', 'StaffAssociations.index|StaffAssociations.view', NULL, NULL, NULL, NULL, '212', '1', NULL, '2', '2020-10-27 13:28:45', '1', '2016-11-27 03:17:43')");
        $this->execute("INSERT INTO `security_functions` (`name`, `controller`, `module`, `category`, `parent_id`, `_view`, `_edit`, `_add`, `_delete`, `_execute`, `order`, `visible`, `description`, `modified_user_id`, `modified`, `created_user_id`, `created`) 
    ...
    public function down()
    {
        ...
        $this->execute('RENAME TABLE `zz_5189Update_security_functions` TO `security_functions`');
    }
}
