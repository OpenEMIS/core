...
class POCOR5789 extends AbstractMigration
{
    ...
    public function up()
    {
		...
		SET student_attendance_marked_records.education_grade_id = institution_class_grades.education_grade_id');
		...
		SET institution_student_absences.education_grade_id = institution_class_grades.education_grade_id');
		...
		SET institution_student_absence_details.education_grade_id = institution_class_grades.education_grade_id');
