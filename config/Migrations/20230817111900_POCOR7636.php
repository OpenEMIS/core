...
class POCOR7636 extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $this->execute('CREATE TABLE IF NOT EXISTS `summary_institution_grade_nationalities`( `academic_period_id` int NOT NULL, `academic_period_name` varchar(150) DEFAULT NULL, `institution_id` int NOT NULL, `institution_code` varchar(150) DEFAULT NULL, `grade_id` int NOT NULL, `grade_name` varchar(150) DEFAULT NULL, `nationality_id` int DEFAULT NULL, `nationality_name` varchar(150) DEFAULT NULL, `total_students` int NOT NULL, `total_students_female` int NOT NULL, `total_students_male` int NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3');
        $this->execute('CREATE TABLE IF NOT EXISTS `summary_institution_nationalities`( `academic_period_id` int NOT NULL, `academic_period_name` varchar(150) DEFAULT NULL, `institution_id` int NOT NULL, `institution_code` varchar(150) DEFAULT NULL, `nationality_id` int DEFAULT NULL, `nationality_name` varchar(150) DEFAULT NULL, `total_students` int NOT NULL, `total_students_female` int NOT NULL, `total_students_male` int NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3');
