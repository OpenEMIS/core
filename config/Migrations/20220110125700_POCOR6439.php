...
class POCOR6439 extends AbstractMigration
{
    ...
    public function down()
    {
        ...
        $this->execute('DELETE FROM report_queries WHERE name like `report_student_attendance_summary`'); 
    }
}
