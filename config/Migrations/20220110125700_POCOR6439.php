...
class POCOR6439 extends AbstractMigration
{
    ...
    //fix existing events
    $this->execute('DROP EVENT `openemis_core_day`');
    ...
    $this->execute('DROP EVENT `openemis_core_minute`');
    ...
    $this->execute('DROP EVENT `openemis_core_hour`');
    ...
    $this->execute('DROP EVENT `openemis_core_month`');
    ...
    $this->execute('DROP EVENT `openemis_core_week`');
    ...
    $this->execute('DROP EVENT `openemis_core_year`');
