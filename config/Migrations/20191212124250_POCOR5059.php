...
class POCOR5059 extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        // user_identities
        $this->execute('DROP TABLE IF EXISTS `zz_5059_user_identities`');
		...
		// security_users
        $this->execute('DROP TABLE IF EXISTS `zz_5059_security_users`');
        ...
        // update identity number in security_users table
