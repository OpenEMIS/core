...
class POCOR6914 extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $this->execute('INSERT INTO `zz_6848_report_queries` (`name`, `query_sql`, `frequency`, `status`, `modified_user_id`, `modified`, `created_user_id`, `created`) VALUES ("system_errors_truncate", "TRUNCATE system_errors;", "week", 1, NULL, NULL, 1, CURRENT_TIMESTAMP');
    }
