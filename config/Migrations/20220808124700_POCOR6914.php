...
class POCOR6914 extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $this->execute('INSERT INTO `report_queries` (`id`, `name`, `query_sql`, `frequency`, `status`, `modified_user_id`, `modified`, `created_user_id`, `created`) VALUES (NULL, "system_errors_truncate", "TRUNCATE system_errors;", "week", 1, NULL, NULL, 1, CURRENT_TIMESTAMP)');
    }
