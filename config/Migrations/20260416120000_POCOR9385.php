    ...
    public function up(): void
    {
        ...
        $this->execute("
            ...
            VALUES
                ...
                (1358, 'Excluded Security Roles for Student Creation', 'student_creation_excluded_roles', 'Add New Student', 'Excluded Security Roles', '', '', '', 1, 1, 'Dropdown', 'database:Security.SecurityRoles', NULL, NULL, 1, NOW()) //POCOR-9385: option_type loads from security_roles via AppTable::getList()
        ");
