...
class POCOR6757 extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $this->execute('UPDATE report_queries SET frequency = `week` WHERE report_queries.name IN (`report_student_assessment_summary_truncate`,`report_student_assessment_summary_insert`)');
