...
class POCOR5051 extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $this->execute('ALTER TABLE `report_cards` ADD COLUMN generate_start_date date NOT NULL AFTER end_date');
         $this->execute('ALTER TABLE `report_cards` ADD COLUMN generate_end_date date NOT NULL AFTER generate_start_date');
    }
