...
class POCOR6430 extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $this->execute("UPDATE `security_functions` SET  `_add` = 'Committees.add' , `_edit` = 'Committees.edit', `_delete` = 'Committees.remove' WHERE `name` = 'Institution Committees' AND `controller` = 'Institutions' AND `module` = 'Institutions' AND `category` = 'Committees'");
