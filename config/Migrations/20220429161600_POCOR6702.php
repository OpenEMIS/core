...
class POCOR6702 extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $this->execute('
        CREATE TABLE `report_student_assessment_summary_20220429` (
