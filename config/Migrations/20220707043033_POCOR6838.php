...
class POCOR6838 extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $sql4 = 'INSERT INTO `security_functions` (`id`, `name`, `controller`, `module`, `category`, `parent_id`, `_view`, `_edit`, `_add`, `_delete`, `_execute`, `order`, `visible`, `description`, `modified_user_id`, `modified`, `created_user_id`, `created`) VALUES (NULL, "Download All Pdf", "Institutions", "Institutions", "Report Cards", "1000", NULL, NULL, NULL, NULL, "ReportCardStatuses.generate|ReportCardStatuses.generateAll|InstitutionStudentsReportCards.download|ReportCardStatuses.downloadAll", "120", "1", NULL, "2",  NOW() , "1",  NOW() ) ';
        $this->execute($sql4);
    }
