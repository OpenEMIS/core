...
WHERE attendance_marked.institution_id IS NULL";
            ...
            $get_old_records_sql = "INSERT IGNORE INTO report_student_attendance_summary SELECT * FROM z_7879_report_student_attendance_summary";
//        try {
...
//
//        try {
            $this->execute($get_old_records_sql);
