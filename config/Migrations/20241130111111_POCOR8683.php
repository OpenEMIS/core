...
class POCOR8683 extends AbstractMigration
{
    ...
    private function updateAddMappingFields(): void
    {
        ...
        $data = [
            ...
            ['User.Users', 'guardian_nationality_id', null, 37, 0, 2, 'FieldOption', 'Nationalities', 'id'],
            ['User.Users', 'guardian_identity_type', 'Code', 38, 0, 1, 'FieldOption', 'IdentityTypes', 'national_code'],
