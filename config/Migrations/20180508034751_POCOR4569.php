    ...
    public function up()
    {
        ...
        $this->execute('
            INSERT INTO `institution_staff_appraisals` 
                (`id`, `title`, `appraisal_period_from`, `appraisal_period_to`, `date_appraised`, `file_name`, `file_content`, `comment`, `institution_id`, `staff_id`, `appraisal_type_id`, `appraisal_period_id`, `appraisal_form_id`, `modified_user_id`, `modified`, `created_user_id`, `created`)
            SELECT `id`, `title`, `from`, `to`, `created`, `file_name`, `file_content`, `comment`, `institution_id`, `staff_id`, `appraisal_type_id`, `appraisal_period_id`, `appraisal_form_id`, `modified_user_id`, `modified`, `created_user_id`, `created`
