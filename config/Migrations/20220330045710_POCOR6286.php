    ...
    public function up()
    {
        ...
        $data = [
            [   
                ...
                '_add' => NULL,
                '_delete' => NULL,
                '_execute' => 'InstitutionProfiles.generate|InstitutionProfiles.generateAll',
                'order' => $data[0] + 1,
                'visible' => 1,
                'description' => NULL,
                'created_user_id' => 1,
                ...
                '_add' => NULL,
                '_delete' => NULL,
                '_execute' => 'StaffProfiles.generate|StaffProfiles.generateAll',
                'order' => $data[0] + 3,
                'visible' => 1,
                'description' => NULL,
                'created_user_id' => 1,
                ...
                '_add' => NULL,
                '_delete' => NULL,
                '_execute' => 'StudentProfiles.generate|StudentProfiles.generateAll',
                'order' => $data[0] + 5,
                'visible' => 1,
                'description' => NULL,
                'created_user_id' => 1,
