...
class POCOR7711 extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $this->execute("INSERT import_mapping (`id`, `model`, `column_name`, `description`, `order`, `is_optional`, `foreign_key`, `lookup_plugin`, `lookup_model`, `lookup_column`) VALUES (NULL, 'Institution.Staff', 'staff_position_grade_id', 'id', '8', '0', '2', 'Institution', 'StaffPositionGrades', 'id');");
