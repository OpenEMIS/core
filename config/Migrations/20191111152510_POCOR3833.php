...
class POCOR3833 extends AbstractMigration
{
    public function up()
    {
		...
		$this->execute("INSERT INTO `config_item_options` (`option_type`, `option`, `value`, `order`, `visible`) VALUES('name_type','identity - first_name last_name','1','1','1')");
		$this->execute("INSERT INTO `config_item_options` (`option_type`, `option`, `value`, `order`, `visible`) VALUES('name_type','identity - full_name','2','2','1')");
    }
