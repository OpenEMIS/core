...
class POCOR1161 extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute("CREATE TABLE `institution_budgets` ( `id` int(11) NOT NULL AUTO_INCREMENT, `academic_period_id` int(11) NOT NULL, `budget_type_id` int(11) NOT NULL, `amount` decimal(6,2) NOT NULL, `attachment` longblob, `description` text, `modified_user_id` int(11) DEFAULT NULL, `modified` datetime DEFAULT NULL, `created_user_id` int(11) NOT NULL, `created` datetime NOT NULL, PRIMARY KEY (`id`) )");
        $this->execute("CREATE TABLE `institution_incomes` ( `id` int(11) NOT NULL AUTO_INCREMENT, `academic_period_id` int(11) NOT NULL, `date` date NOT NULL, `income_source_id` int(11) NOT NULL, `income_type_id` int(11) NOT NULL, `amount` decimal(6,2) DEFAULT NULL, `attachment` longblob, `description` text, `modified_user_id` int(11) DEFAULT NULL, `modified` datetime DEFAULT NULL, `created_user_id` int(11) NOT NULL, `created` datetime NOT NULL, PRIMARY KEY (`id`) )");
        $this->execute("CREATE TABLE `institution_expenditures` ( `id` int(11) NOT NULL AUTO_INCREMENT, `academic_period_id` int(11) NOT NULL, `date` date NOT NULL, `budget_type_id` int(11) NOT NULL, `expenditure_type_id` int(11) NOT NULL, `amount` decimal(6,2) DEFAULT NULL, `attachment` longblob, `description` text, `modified_user_id` int(11) DEFAULT NULL, `modified` datetime DEFAULT NULL, `created_user_id` int(11) NOT NULL, `created` datetime NOT NULL, PRIMARY KEY (`id`) )");
    }
