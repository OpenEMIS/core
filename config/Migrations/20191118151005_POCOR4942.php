...
class POCOR4942 extends AbstractMigration
{
    public function up()
    {
		...
		$this->execute("INSERT INTO `import_mapping` (`model`, `column_name`, `description`, `order`, `is_optional`, `foreign_key`, `lookup_plugin`, `lookup_model`, `lookup_column`) VALUES('Staff.Qualifications','staff_id',NULL,'1','1','0',NULL,NULL,NULL)");
		...
		$this->execute("INSERT INTO `import_mapping` (`model`, `column_name`, `description`, `order`, `is_optional`, `foreign_key`, `lookup_plugin`, `lookup_model`, `lookup_column`) VALUES('Staff.Qualifications','graduate_year','','9','1','2','AcademicPeriod','AcademicPeriods','id')");
