...
class POCOR5033p extends AbstractMigration
{
    public function up()
    {
        ...
        $this->execute("INSERT INTO `security_functions` (`name`, `controller`, `module`, `category`, `parent_id`, `_view`, `_edit`, `_add`, 
		`_delete`, `_execute`, `order`, `visible`, `description`, `modified_user_id`, `modified`, `created_user_id`, `created`) 
		VALUES('Import Competency Templates','Competencies','Administration','Competencies','5000',NULL,NULL,NULL,NULL,'ImportCompetencyTemplates.add|ImportCompetencyTemplates.template|ImportCompetencyTemplates.results|ImportCompetencyTemplates.downloadFailed|ImportCompetencyTemplates.downloadPassed','9012','1',NULL,'2',NOW(),'1',NOW())");
