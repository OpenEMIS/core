...
class POCOR6269 extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        $this->execute('CREATE TABLE `z_6269_assessment_item_results` LIKE `assessment_item_results`');
        $this->execute('INSERT INTO `z_6269_assessment_item_results` SELECT * FROM `assessment_item_results`');
    ...
    public function down()
    {
        ...
        $this->execute('RENAME TABLE `z_6269_assessment_item_results` TO `assessment_item_results`');
    }
}
