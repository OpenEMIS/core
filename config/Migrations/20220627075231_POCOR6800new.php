...
class POCOR6800new extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        /** backup */
        $this->execute('CREATE TABLE `zz_6800new_security_functions` LIKE `security_functions`');
        $this->execute('INSERT INTO `zz_6800new_security_functions` SELECT * FROM `security_functions`');
    ...
    public function down()
    {
        ...
        $this->execute('RENAME TABLE `zz_6800new_security_functions` TO `security_functions`');
    }
}
