...
class POCOR8123 extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $this->execute('ALTER TABLE `institution_staff_surveys` DROP FOREIGN KEY `institution_staff_surveys_ibfk_6`; ALTER TABLE `institution_staff_surveys` ADD CONSTRAINT `institution_staff_surveys_ibfk_6` FOREIGN KEY (`parent_form_id`) REFERENCES `institution_surveys`(`survey_form_id`) ON DELETE RESTRICT ON UPDATE RESTRICT');
