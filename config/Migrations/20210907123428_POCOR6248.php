...
class POCOR6248 extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $this->execute("INSERT INTO `config_items` (`id`, `name`, `code`, `type`, `label`, `value`, `value_selection`, `default_value`, `editable`, `visible`, `field_type`, `option_type`, `modified_user_id`, `modified`, `created_user_id`, `created`) VALUES (NULL, 'Position', 'student_education_code', 'Columns for Student List Page', 'Position', '1', '', '0', '0', '1', 'Dropdown', 'completeness', '2', '2021-09-03 08:27:31', '2', '2021-08-27 00:00:00')");
        $this->execute("INSERT INTO `config_items` (`id`, `name`, `code`, `type`, `label`, `value`, `value_selection`, `default_value`, `editable`, `visible`, `field_type`, `option_type`, `modified_user_id`, `modified`, `created_user_id`, `created`) VALUES (NULL, 'Start Date', 'student_class', 'Columns for Student List Page', 'Start Date', '1', '', '0', '0', '1', 'Dropdown', 'completeness', '2', '2021-09-03 08:27:41', '2', '2021-08-27 00:00:00')");
        ...
        $this->execute("INSERT INTO `config_items` (`id`, `name`, `code`, `type`, `label`, `value`, `value_selection`, `default_value`, `editable`, `visible`, `field_type`, `option_type`, `modified_user_id`, `modified`, `created_user_id`, `created`) VALUES (NULL, 'Position', 'staff_position_code', 'Columns for Staff List Page', 'Position', '1', '', '0', '0', '1', 'Dropdown', 'completeness', '2', '2021-09-03 08:27:31', '2', '2021-08-27 00:00:00')");
