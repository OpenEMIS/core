...
class POCOR5331 extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $this->execute('CREATE TABLE `z_5331_security_roles` LIKE `security_roles`');
		$this->execute('INSERT INTO `z_5331_security_roles` SELECT * FROM `security_roles`');
    ...
    public function down()
    {
        ...
        $this->execute('RENAME TABLE `z_5331_security_roles` TO `security_roles`');
    }
}
