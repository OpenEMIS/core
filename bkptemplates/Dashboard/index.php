<?= $this->Html->script('angular/dashboard/jquery.min.js', ['block' => true]); ?>
<?= $this->Html->script('angular/dashboard/jquery-ui.min.js', ['block' => true]); ?>
<?= $this->Html->script('angular/dashboard/angular.js', ['block' => true]); ?>
