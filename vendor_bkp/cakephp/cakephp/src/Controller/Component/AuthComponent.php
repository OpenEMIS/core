...
class AuthComponent extends Component implements EventDispatcherInterface
{
    ...
    {
        if ($name === 'sessionKey') {
            // For backward compatibility, we need to return the sessionKey value
            // but the parent signature requires ?Component. This is a limitation
            // of the backward compatibility layer. We'll return null and handle
            // sessionKey access through the storage() method instead.
            return null;
        }
