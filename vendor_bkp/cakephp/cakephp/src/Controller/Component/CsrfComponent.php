...
class CsrfComponent extends Component
{
    ...
    public function startup(Event $event)
    {
        ...
        // }
        // Note: 'requested' detector was removed in CakePHP 5 as requestAction() was deprecated
        // Using the actual request from the controller instead of creating a new one
