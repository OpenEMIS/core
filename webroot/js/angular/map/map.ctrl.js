angular.module('map.ctrl', [])
    .controller('MapCtrl', ['$scope', '$window', '$timeout', function($scope, $window, $timeout) {
        console.log('loading map data', institutionsData);
        ...
        // fake delay from server
        $timeout(getDataFromServer, 3000);
