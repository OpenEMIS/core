 ...
 *  ```
 */
class AngularInputsContext implements ContextInterface
{
    ...
    {
        /**
         * Always return true so that our input wrapper will include error message div
         */
        return true;
    }
    ...
    {
        /**
         * straight away returns the whole errors
         */
