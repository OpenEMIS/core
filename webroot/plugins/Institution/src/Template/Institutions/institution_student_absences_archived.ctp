...
<?= $this->Html->script('Institution.angular/student_attendances/institution.student.attendances.archive.svc', ['block' => true]); ?>
<?= $this->Html->script('Institution.angular/student_attendances/institution.student.attendances.archive.ctrl', ['block' => true]); ?>
