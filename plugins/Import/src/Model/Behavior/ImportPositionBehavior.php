...
class ImportPositionBehavior extends Behavior
{
    ...
    public function initialize(array $config): void
    {
        ...
        // $this->getConfig('max_size', $this->system_memory_limit());
        // $this->getConfig('max_rows', 50000);
        //
    ...
    public function beforeAction($event)
    {
        ...
        //$this->institutionId  =  $this->_table->getQuery('institution_id');
        ...
        return function ($model, $entity) {
            ...
            for ($row = $startCheck; $row <= $highestRow; ++$row) {
                ...
                if ($extra['entityValidate'] == true) {
                    ...
                    $shiftArr = $InstitutionShifts->find('all',['fields'=>['id','shift_option_id'],'conditions'=>['academic_period_id'=> $selectedPeriod, 'location_institution_id'=>$tempRow['institution_id']]])->toArray();
