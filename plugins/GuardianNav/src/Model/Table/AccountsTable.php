...
class AccountsTable extends AppTable {
    ...
    private function setupTabElements()
    {
        ...
        $isStudent = $session->read('GuardianNav.GuardianNavs.is_student');
        $isGuardian = $session->read('GuardianNav.GuardianNavs.is_guardian');
        //$studentToGuardian = $session->read('GuardianNav.GuardianNavs.studentToGuardian');
        //$guardianToStudent = $session->read('GuardianNav.GuardianNavs.guardianToStudent');
