...
//POCOR-8222 develop GPA system functionlity
class GpaGradingTypesTable extends ControllerActionTable {
    ...
    public function initialize(array $config) : void
    {
        ...
        $this->hasMany('GradingOptions', ['className' => 'Gpa.GpaGradingOptions', 'dependent' => true, 'cascadeCallbacks' => true]);
    ...
    public function beforeAction(EventInterface $event, ArrayObject $extra) {
        ...
        $this->field('grading_options', [
            'type' => 'element',
            'element' => 'Gpa.Gradings/grading_options',
    ...
    public function editAfterSave(EventInterface $event, Entity $entity, ArrayObject $requestData, ArrayObject $patchOptions, ArrayObject $extra)
    {
        ...
        if (!empty($query)) {
            ...
            if (!empty($removedGradingOptionIds)) {
                ...
                $this->GradingOptions->deleteAll([
                    $this->GradingOptions->aliasField('gpa_grading_type_id') => $entity->id
                ]);
            }
        }
    }
