...
<?php if ($_sync) : ?>
    <button class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="bottom" data-container="body" title="<?= __('Sync'); ?>" ng-show="action == 'view'" ng-click="ExaminationsResultsController.onSyncClick()">
        <i class="kd-process"></i>
    </button>
