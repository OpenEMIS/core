...
class QualificationsTable extends ControllerActionTable {
	...
	public function beforeAction() {
		// $this->fields['qualification_title_id']['type'] = 'select';
		// $this->fields['qualification_level']['type'] = 'string';
		// $this->fields['qualification_country_id']['type'] = 'select';
		// // $this->fields['qualification_institution']['type'] = 'string';
	...
	public function indexBeforeAction(Event $event) {
		// $this->fields['qualification_title_id']['visible'] = false;
		// $this->fields['qualification_country_id']['visible'] = false;
	...
	public function addEditBeforeAction(Event $event) {
		...
		// $this->setFieldOrder('qualification_title', $order++);
		// $this->setFieldOrder('qualification_title_id', $order++);
		// $this->setFieldOrder('graduate_year', $order++);
		// $this->setFieldOrder('document_no', $order++);
