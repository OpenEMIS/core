...
//            '${academic_year}' => 'Academic Year.',
    ...
    public function onStudentEnrolmentSetupFields(EventInterface $event, Entity $entity)
    {
        $this->onAlertRuleSetupFields($event, $entity);
    }

    public function onGetStudentEnrolmentThreshold(EventInterface $event, Entity $entity)
    {
