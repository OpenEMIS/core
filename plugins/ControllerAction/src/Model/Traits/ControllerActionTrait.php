...
trait ControllerActionTrait {
	protected $_controllerActionEvents = [
		...
		// public function onFormatDate(EventInterface $event, Time $dateObject) {}

		'ControllerAction.Model.onFormatTime'				=> 'onFormatTime', // called before displaying time fields
		// public function onFormatTime(EventInterface $event, Time $dateObject) {}

		'ControllerAction.Model.onFormatDateTime'			=> 'onFormatDateTime', // called before displaying datetime fields
		// public function onFormatDateTime(EventInterface $event, Time $dateObject) {}

		'ControllerAction.Model.onInitializeButtons'		=> 'onInitializeButtons',
		// public function onInitializeButtons(EventInterface $event, ArrayObject $buttons, $action, $isFromModel) {}
		...
		// public function indexAfterPaginate(EventInterface $event, $data) {}

		'ControllerAction.Model.index.afterAction'			=> 'indexAfterAction',
		// v4 - public function indexAfterAction(EventInterface $event, Query $query, ResultSet $data, ArrayObject $extra) {}
        // v3 - public function indexAfterAction(EventInterface $event, $data) {}
		...
		// public function viewOnReload(EventInterface $event, Entity $entity, ArrayObject $data, ArrayObject $options) {}
		...
		// public function addBeforeSave(EventInterface $event, Entity $entity, ArrayObject $data) { return function() {}; }
		...
		// public function addOnReload(EventInterface $event, Entity $entity, ArrayObject $data, ArrayObject $options) {}
		...
		// public function editAfterPatch(EventInterface $event, Entity $entity, ArrayObject $data, ArrayObject $options) {}

		'ControllerAction.Model.edit.beforeSave'			=> 'editBeforeSave', // you can overwrite this function to implement your own saving logic
		// public function editBeforeSave(EventInterface $event, Entity $entity, ArrayObject $data) { return function() {}; }
		...
		// public function editOnReload(EventInterface $event, Entity $entity, ArrayObject $data, ArrayObject $options) {}
        ...
        // public function onBeforeDelete(EventInterface $event, ArrayObject $options, $id, ArrayObject $extra) {}
		...
		// public function transferBeforeAction(EventInterface $event, ArrayObject $extra) {}

		'ControllerAction.Model.transfer.onInitialize'		=> 'transferOnInitialize',
		// public function transferOnInitialize(EventInterface $event, Entity $entity, Query $query, ArrayObject $extra) {}
