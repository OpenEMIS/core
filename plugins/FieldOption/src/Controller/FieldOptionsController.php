...
class FieldOptionsController extends AppController
{
    ...
    public function ScholarshipInstitutionChoiceTypes()     { $this->ControllerAction->process(['alias' => __FUNCTION__, 'className' => $this->FieldOption->getClassName(__FUNCTION__)]); }
