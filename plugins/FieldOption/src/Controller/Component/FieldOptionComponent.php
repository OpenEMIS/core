...
class FieldOptionComponent extends Component
{
    ...
    // Infrastructure
        ...
        'InfrastructureWashSanitationTypes' => ['className' => 'Institution.InfrastructureWashSanitationTypes', 'parent' => 'Infrastructure'],
        'InfrastructureWashSanitationUses' => ['className' => 'Institution.InfrastructureWashSanitationUses', 'parent' => 'Infrastructure'],
        'InfrastructureWashSanitationQualities' => ['className' => 'Institution.InfrastructureWashSanitationQualities', 'parent' => 'Infrastructure'],
        'InfrastructureWashSanitationAccessibilities' => ['className' => 'Institution.InfrastructureWashSanitationAccessibilities', 'parent' => 'Infrastructure'],
        'InfrastructureWashHygieneTypes' => ['className' => 'Institution.InfrastructureWashHygieneTypes', 'parent' => 'Infrastructure'],
        'InfrastructureWashHygieneSoapashAvailabilities' => ['className' => 'Institution.InfrastructureWashHygieneSoapashAvailabilities', 'parent' => 'Infrastructure'],
        'InfrastructureWashHygieneEducations' => ['className' => 'Institution.InfrastructureWashHygieneEducations', 'parent' => 'Infrastructure'],
        ...
        'InfrastructureWashSewageTypes' => ['className' => 'Institution.InfrastructureWashSewageTypes', 'parent' => 'Infrastructure'],
        'InfrastructureWashSewageFunctionalities' => ['className' => 'Institution.InfrastructureWashSewageFunctionalities', 'parent' => 'Infrastructure'],
