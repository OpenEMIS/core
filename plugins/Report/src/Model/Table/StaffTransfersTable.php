...
class StaffTransfersTable extends AppTable {
    ...
    public function initialize(array $config)
    {
        ...
        $this->addBehavior('Excel', [
            'excludes' => ['new_staff_type_id', 'new_FTE', 'new_end_date', 'previous_institution_staff_id', 'previous_staff_type_id', 'previous_FTE', 'previous_end_date', 'initiated_by', 'transfer_type'],
            'pages' => false
        ]);
