...
/**
 * 
 * This class is used to add the template in class template tabs
 * We can add/edit/delete/export report from this class
 * @author Anubhav Jain <anubhav.jain@mail.valuecoders.com>
 * 
 */
class ClassTemplatesTable extends ControllerActionTable
{
    use OptionsTrait;
    ...
    {
        $filename = 'class_profile_template';
        $fileType = 'xlsx';
