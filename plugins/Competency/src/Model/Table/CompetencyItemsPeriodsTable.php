...
class CompetencyItemsPeriodsTable extends AppTable {
    ...
    public function initialize(array $config) {
        ...
        $this->belongsTo('Periods',     ['className' => 'Competency.CompetencyPeriods', 'dependent' => true, 'foreignKey' => ['competency_period_id', 'academic_period_id'], 'foreignKey' => ['id', 'academic_period_id']]);
        $this->addBehavior('CompositeKeyBehavior');
    }
}