        ...
        $query
            ->formatResults(function (ResultSetInterface $results) use (
                ...
                return $results->map(function ($row) use (
                    ...
                    $SecurityInstitutionsTable = TableRegistry::getTableLocator()->get('Security.SecurityGroupInstitutions');
                    $SecurityRoleFunTable = TableRegistry::getTableLocator()->get('Security.SecurityRoleFunctions');
                    $SecurityRoleTable = TableRegistry::getTableLocator()->get('Security.SecurityRoles');
                    $SecurityGroupTable=TableRegistry::getTableLocator()->get('Security.UserGroups');
