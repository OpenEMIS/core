...
class InstitutionsController extends AppController
{
    ...
    public function StaffBehaviours()               { $this->ControllerAction->process(['alias' => __FUNCTION__, 'className' => 'Institution.StaffBehaviours']); }
    ...
    public function Workflows()                     { $this->ControllerAction->process(['alias' => __FUNCTION__, 'className' => 'Institution.InstitutionWorkflows']); }
    // End
