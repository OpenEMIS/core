...
<?= $this->Html->script('Institution.angular/student_archive/institution.student.archive.svc', ['block' => true]); ?>
<?= $this->Html->script('Institution.angular/student_archive/institution.student.archive.ctrl', ['block' => true]); ?>
