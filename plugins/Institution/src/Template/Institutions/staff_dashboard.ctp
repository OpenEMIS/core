...
<?php if(isset($haveProfilePermission) && $haveProfilePermission == 1 && isset($personalProfileCompletness)) :?>
...
<?php endif ?>
<!---->
<?php if(isset($haveProfilePermission) && $haveProfilePermission == 1 && isset($instituteName)) :?>
