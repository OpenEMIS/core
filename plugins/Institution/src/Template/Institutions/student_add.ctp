...
<div class="pd-10">
    ...
    <div class="stepper-content-wrapper">
        ...
        <div class="actions top">
            ...
            <button type="button" class="btn btn-default btn-next"
            ng-if="InstitutionStudentController.step==='summary' && InstitutionStudentController.isDiffSchool > 0" ng-click="InstitutionStudentController.goToNextStep()">Transfer Student</button>
            <button type="button" class="btn btn-default btn-next"
            ng-if="InstitutionStudentController.step==='transfer_student'" ng-click="InstitutionStudentController.goToNextStep()">Save</button>
            <button type="button" class="btn btn-default btn-next"
            ...
            <div class="step-pane sample-pane" ng-if="InstitutionStudentController.isDiffSchool > 0 && InstitutionStudentController.step === 'transfer_student'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input date required">
                        ...
                        <div class="input-group date" id="Student_transfer_start_date" style="" datepicker="" ng-model="InstitutionStudentController.selectedStudentData.trnasferStartDate" ng-click="[isTransferStartDatepickerOpen = !isTransferStartDatepickerOpen, InstitutionStudentController.error.trnasferStartDate = '']">
                            <input type="text" class="form-control " ng-model="InstitutionStudentController.selectedStudentData.trnasferStartDate" uib-datepicker-popup="yyyy/MM/dd" is-open="isTransferStartDatepickerOpen" datepicker-options="InstitutionStudentController.datepickerOptions" close-text="Close" alt-input-formats="altInputFormats" style="width: calc(100% - 52px) !important" />
                            <span class="input-group-addon" style="background-color: #6699CC; color: #FFF;"><i class="glyphicon glyphicon-calendar"></i></span>
                        </div>
                        <div ng-if="InstitutionStudentController.error.trnasferStartDate" class="error-message">
                            <p>{{ InstitutionStudentController.error.trnasferStartDate }}</p>
                        </div>
                    </div>
                    <div class="input date required">
                        <label for="Students_end_date"><?= __('End Date') ?></label>
