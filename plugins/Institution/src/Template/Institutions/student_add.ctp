        ...
        <div class="step-content">
            ...
            <div class="step-pane sample-pane" ng-show="InstitutionStudentController.step === 'confirmation'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <!-- Birthplace area end -->
                    <div class="row section-header header-space-lg"><?= __('Identities') ?> / <?= __('Nationalities') ?></div>
                    ...
                    <div ng-repeat="customField in InstitutionStudentController.customFieldsArray">
                        ...
                        <div ng-repeat="field in customField.data">
                            ...
                            <div class="input file" ng-class="{'required': field.is_mandatory !== 0}" ng-if="field.field_type === 'FILE'">
                                <input type="file" id="{{field.student_custom_field_id}}" name="{{field.name}}"/>
                                <button ng-click="add()">Add</button>
                                <?php ?>
                                <label for="{{field.student_custom_field_id}}">{{field.name}}</label>
                                <!-- Your PHP code can be translated to AngularJS as follows -->
                                <div class="fileinput" ng-class="{''always-single': alwaysShowOneButton}">
                                    <!-- Left buttons -->
                                    <div class="input-left-btn" ng-if="startWithOneLeftButton || startWithTwoLeftButton">
                                        <button class="btn" ng-class="{ 'fileinput-exists': selectedButton !== 'download' }" ng-click="downloadOnClick">
                                            <i class="fa kd-download"></i>
                                        </button>
                                        <button class="btn" ng-class="{ 'fileinput-exists': selectedButton !== 'import' }" ng-click="importOnClick">
...
<!--                                     Right buttons -->
                                    <a href="#" class="input-group-addon btn fileinput-exists btn-file-cancel" data-dismiss="fileinput" ng-click="removeFile()">
                                    ...
                                    <div class="input-group-addon btn btn-default btn-file">
                                        ...
                                        <input type="file" ng-model="field.answer" ng-change="uploadFile(field)" class="fa fa-folder">
                                    </div>
