...
<div class="pd-10">
    ...
    <div class="stepper-content-wrapper">
        ...
        <div class="actions top">
            ...
            <button  ng-disabled="InstitutionStudentController.isIdentityUserExist"type="button" class="btn btn-default btn-next"
            ...
            ng-if="InstitutionStudentController.step==='summary' && InstitutionStudentController.isDiffSchool" ng-click="InstitutionStudentController.transferStudentNextStep()" style="font-size: 12px;">Transfer Student</button>
            <button type="button" class="btn btn-default btn-next"
