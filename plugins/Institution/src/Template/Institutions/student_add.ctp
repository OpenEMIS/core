...
<div class="pd-10">
    <div class="stepper-content-wrapper" ng-if="!InstitutionStudentController.isGuardianAdding">
        ...
        <div class="actions top">
            ...
            <button type="button" class="btn btn-default btn-next"
                ng-if="InstitutionStudentController.step==='summary'" ng-click="InstitutionStudentController.addGuardian()">Add Guardian</button>
        </div>
        <div class="step-content">
            ...
            <div class="step-pane sample-pane" ng-if="InstitutionStudentController.step === 'user_details'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input string required">
                        ...
                        <input ng-model="InstitutionStudentController.selectedStudentData.first_name" ng-change="InstitutionStudentController.setStudentName()" type="string">
                    ...
                    <div class="input string required">
                        ...
                        <input ng-model="InstitutionStudentController.selectedStudentData.last_name" ng-change="InstitutionStudentController.setStudentName()" type="string">
            ...
            <div class="step-pane sample-pane" ng-if="InstitutionStudentController.step === 'add_student'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input string">
                        <label><?= __('Identity Number') ?></label>
                        <input ng-model="InstitutionStudentController.selectedStudentData.identityNumber" type="string" ng-disabled="true">
                    </div>
                    ...
                    <div class="input string required">
                        ...
                        <input ng-model="InstitutionStudentController.selectedStudentData.username" ng-disabled="true" />
                    </div>
                    <div class="input string required">
                        <label><?= __('Password') ?></label>
                        <input ng-model="InstitutionStudentController.selectedStudentData.password" ng-disabled="true" />
                    </div>
                    <div class="input select required error">
                    ...
                    <div class="input string">
                        ...
                        <input ng-model="InstitutionStudentController.selectedStudentData.studentStatus" ng-disabled="true" />
                    </div>
                    <div class="input date required">
                        ...
                        <div ng-if="InstitutionStudentController.postResponse.error.startDate" class="error-message">
                            <p ng-repeat="error in InstitutionStudentController.postResponse.error.date_of_birth">{{ error }}</p>
                        </div>
                    </div>
                    <div class="input date required">
                        ...
                        <div class="input-group date " id="Students_end_date" style="">
                            <input type="text" class="form-control " name="Student[endDate]" ng-model="InstitutionStudentController.selectedStudentData.endDate">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                        </div>
                    </div>
