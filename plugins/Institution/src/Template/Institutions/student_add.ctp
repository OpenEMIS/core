    ...
    <div class="stepper-content-wrapper">
        <div class="steps-container">
            <ul class="steps" style="margin-left: 0">
                ...
                <li ng-class="{'active': InstitutionStudentController.step === 'add_staff'}">
                    <div class="stepper-steps-wrapper">
                        Add Staff
                        <span class="chevron"></span>
                    </div>
        ...
        <div class="actions top">
            ...
            <button
                ng-if="(InstitutionStudentController.step=='add_staff' && InstitutionStudentController.step!=='summary')"
            ...
            <button type="button" class="btn btn-default btn-next"
                ng-if="InstitutionStudentController.step!=='add_staff' && InstitutionStudentController.step!=='summary'" ng-click="InstitutionStudentController.goToNextStep()">Next</button>
        </div>
        <div class="step-content">
                ...
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input date required">
                        ...
                        <div class="input-group date " id="Student_date_of_birth" style="">
                            <input type="text" class="form-control " name="Staff[date_of_birth]" ng-model="InstitutionStudentController.selectedStudentData.date_of_birth" ng-init="InstitutionStudentController.selectedStudentData.date_of_birth='';">
                    ...
                    <div ng-class="nationality_class">
                        ...
                        <div class="input-select-wrapper">
                            <select name="Staff[nationality_id]" id="staff-nationality_id"
                                ...
                                ng-init="InstitutionStudentController.selectedStudentData.nationality_id='';"
                                >
                                <option value="" >-- <?= __('Select') ?> --</option>
                            </select>
                        </div>
                    ...
                    <div ng-class="InstitutionStudentController.Staff.identity_type_class">
                        ...
                        <div class="input-select-wrapper">
                            <select name="Staff[identities_type_id]" id="staff-identities_type_id"
                                ...
                                ng-change="InstitutionStudentControllerchangeIdentityType()"
                                >
                                <option value="" >-- <?= __('Select') ?> --</option>
                            </select>
                        </div>
                    ...
                    <div ng-class="InstitutionStudentController.identity_class">
                        <label><?= __('{{InstitutionStudentController.selectedStudentData.identity_type_name}}') ?></label>
            ...
            <div class="step-pane sample-pane" ng-if="InstitutionStudentController.step === 'add_staff'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    <div class="input string required">
                        <label><?= __('OpenEMIS ID') ?></label>
                        <input ng-model="InstitutionStudentController.selectedStudentData.openemis_no" type="string" ng-disabled="true">
