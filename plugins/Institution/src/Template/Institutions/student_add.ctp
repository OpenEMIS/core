...
<div class="pd-10">
    ...
    <div class="stepper-content-wrapper">
        ...
        <div class="actions top">
            <button ng-if="(InstitutionStudentController.step=='user_details') || InstitutionStudentController.isNextButtonShouldDisable()" type="button" class="btn close-btn" ng-click="InstitutionStudentController.cancelProcess()" style="font-size: 12px;">Cancel</button>
            <button ng-if="InstitutionStudentController.step!=='user_details'
                && InstitutionStudentController.step!=='summary'
                && InstitutionStudentController.step!=='transfer_student'" type="button" class="btn btn-prev close-btn" ng-click="InstitutionStudentController.goToPrevStep()" style="font-size: 12px;">Back</button>
            <button ng-if="(InstitutionStudentController.step=='add_student'
                && InstitutionStudentController.step!=='summary')" type="button" class="btn btn-default" ng-click="InstitutionStudentController.confirmUser()" style="font-size: 12px;">Confirm</button>
            <button ng-if="InstitutionStudentController.step=='summary'
                && InstitutionStudentController.step==='transfer_student'" type="button" class="btn close-btn" ng-click="InstitutionStudentController.cancelProcess()" style="font-size: 12px;">Close</button>
            <button ng-disabled="InstitutionStudentController.isNextButtonShouldDisable()" type="button" class="btn btn-default btn-next" ng-if="InstitutionStudentController.step!=='add_student'
                && InstitutionStudentController.step!=='summary'
                && InstitutionStudentController.step!=='transfer_student'" ng-click="InstitutionStudentController.goToNextStep()" style="font-size: 12px;">Next</button>
            <button type="button" class="btn btn-default btn-next" ng-if="InstitutionStudentController.step==='summary'
             && InstitutionStudentController.isDiffSchool" ng-click="InstitutionStudentController.transferStudentNextStep()" style="font-size: 12px;">Transfer Student</button>
            <button type="button" class="btn btn-default btn-next" ng-if="InstitutionStudentController.step==='transfer_student'" ng-click="InstitutionStudentController.transferStudent()" style="font-size: 12px;">Save</button>
            <button type="button" class="btn btn-default btn-next" ng-if="InstitutionStudentController.step==='summary'
                && InstitutionStudentController.redirectToGuardian" ng-click="InstitutionStudentController.addGuardian()" style="font-size: 12px;">Add Guardian</button>
        </div>
                ...
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div ng-class="nationality_class" class="input select ">
                        ...
                        <div class="input-select-wrapper">
                            <select name="Student[nationality_id]" id="student-nationality_id" ng-options="option.id as option.name for option in InstitutionStudentController.nationalitiesOptions" ng-model="InstitutionStudentController.selectedStudentData.nationality_id" ng-change="InstitutionStudentController.changeNationality()">
                    ...
                    <div class="input select error required">
                        ...
                        <div class="input-select-wrapper">
                            <select name="Student[gender_id]" id="student-gender_id" ng-options="option.id as option.name for option in InstitutionStudentController.genderOptions" ng-model="InstitutionStudentController.selectedStudentData.gender_id" ng-change="InstitutionStudentController.changeGender()">
                                <option value="">-- <?= __('Select') ?> --</option>
                            </select>
                        </div>
                    ...
                    <div class="input date required">
                        ...
                        <div class="input-group date " id="Student_date_of_birth" style="">
                            <input type="text" class="form-control " name="Student[date_of_birth]" ng-model="InstitutionStudentController.selectedStudentData.date_of_birth" ng-init="InstitutionStudentController.selectedStudentData.date_of_birth = ''" ng-change="InstitutionStudentController.changeEducationGrade()">
            ...
            <div class="step-pane sample-pane" ng-show="InstitutionStudentController.step === 'confirmation'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class=" input select" id="addressArea_dropdown">
                        <label><?= __('Address Area') ?></label>
                        <div class="tree-form" id="address_area_id" ng-controller="SgTreeCtrl as SgTree" ng-init="SgTree.model='Area.AreaAdministratives'; SgTree.outputValue=null; SgTree.userId=2; SgTree.displayCountry=1; SgTree.triggerOnChange=false;">
                    ...
                    <div class="input select" id="birthplaceArea_dropdown">
                        <label><?= __('Birthplace Area') ?></label>
                        <div class="tree-form" id="birthplace_area" ng-controller="SgTreeCtrl as SgTree" ng-init="SgTree.model='Area.AreaAdministratives'; SgTree.outputValue=null; SgTree.userId=2; SgTree.displayCountry=1; SgTree.triggerOnChange=false; ">
                            <!-- POCOR-7720 Here displayCountry is changed to 1 so that dropdown will show all countries on adding student -->
                    ...
                    <!-- Birthplace area end -->
<!--                    <div class="row section-header header-space-lg">--><?php //= __('Other Information') ?><!--</div>-->
<!--                    <div class="input select">-->
<!--                        <label>--><?php //= __('Contact Type') ?><!--</label>-->
<!--                        <div class="input-select-wrapper">-->
...
<!--                            </select>-->
                    <div id="additional_information">
                        ...
                        <!-- Nationality -->
                        <div ng-show="!InstitutionStudentController.canSkipNationality">
                            <h1>Nationality</h1>
                        </div>
                        <!-- Identity -->
                        <div ng-show="!InstitutionStudentController.canSkipIdentity">
                            <h1>Identity</h1>
                        </div>
                        <!-- Contact -->
                        <div ng-show="!InstitutionStudentController.canSkipContact">
                            <h1>Contact</h1>
                            <div class="{{InstitutionStudentController.contactTypeClass}}
                                {{InstitutionStudentController.contactsRequired}}"
                                 ng-show="!InstitutionStudentController.contactsSkipped
                             && InstitutionStudentController.isSearchResultEmpty ">
                                <label><?= __('Contact Type') ?></label>
                                <div class="input-select-wrapper">
                                    <select name="Student[contact_type_id]" id="student-contact_type_id"
                                            ng-options="option.id as option.full_contact_type_name for option in InstitutionStudentController.contactTypeOptions"
                                            ng-model="InstitutionStudentController.selectedStudentData.contact_type_id"
                                            ng-change="InstitutionStudentController.changeContactType()">
                                        <option value="">-- <?= __('Select') ?> --</option>
                                    </select>
                            ...
                            <div class="input string {{InstitutionStudentController.contactsRequired}}"
                                ...
                                <input ng-model="InstitutionStudentController.selectedStudentData.contact_value"
                                       type="string"
                                       ng-disabled="!InstitutionStudentController.isSearchResultEmpty">
...
<!--                        <div class="input"-->
<!--                             ng-show="!InstitutionStudentController.isSearchResultEmpty">-->
<!--                            <label>--><?php //= __('Nationality') ?><!--</label>-->
<!--                            <input ng-model="InstitutionStudentController.selectedStudentData.nationality_name" type="string" ng-disabled="true" />-->
<!--                        </div>-->
                    </div>
<!--                    <div class="input string">-->
<!--                        <label>--><?php //= __('Contact Value') ?><!--</label>-->
<!--                        <input ng-model="InstitutionStudentController.selectedStudentData.contact_value" type="string">-->
<!--                    </div>-->
...
<!--                             ng-show="!InstitutionStudentController.nationalitiesSkipped-->
<!--                                && InstitutionStudentController.isSearchResultEmpty ">-->
<!--                            <label>--><?php //= __('Nationality') ?><!--</label>-->
...
<!--                        <div class="input string"-->
<!--                             ng-show="!InstitutionStudentController.isSearchResultEmpty">-->
<!--                            <label>--><?php //= __('Identity Type') ?><!--</label>-->
...
<!--                             ng-show="!InstitutionStudentController.identitiesSkipped-->
<!--                                && InstitutionStudentController.isSearchResultEmpty ">-->
<!---->
...
<!--                    </div>-->
<!---->
<!--                    <div ng-class="InstitutionStudentController.Staff.identity_type_class" class="input select" ng-show="!InstitutionStudentController.canSkipIdentity">-->
<!--                            <label>--><?php //= __('Identity Type') ?><!--</label>-->
<!--                            <div class="input-select-wrapper">-->
<!--                                <select name="Student[identities_type_id]"-->
<!--                                        id="student-identities_type_id"-->
...
<!--                             ng-show="!InstitutionStudentController.identitiesSkipped">-->
<!--                            <label>--><?php //= __('Identity Number') ?><!--</label>-->
<!--                        <input ng-model="InstitutionStudentController.selectedStudentData.identity_number" type="string"-->
...
<!--                    </div>-->
            ...
            <div class="step-pane sample-pane" ng-show="InstitutionStudentController.step === 'add_student'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input string required"
                        ...
                        <input ng-model="InstitutionStudentController.selectedStudentData.username" ng-focus="InstitutionStudentController.error.username = ''" ng-disabled="InstitutionStudentController.disableFields.username" />
                    ...
                    <div class="input select required error">
                        ...
                        <div class="input-select-wrapper">
                            <select name="Student[academic_period_id]" id="student-academic_period_id" ng-options="option.id as option.name for option in InstitutionStudentController.academicPeriodOptions" ng-model="InstitutionStudentController.selectedStudentData.academic_period_id" ng-change="InstitutionStudentController.changeAcademicPeriod()">
                                <option value="">-- <?= __('Select') ?> --</option>
                            </select>
                        </div>
                    ...
                    <div class="input select required error">
                        ...
                        <div class="input-select-wrapper">
                            <select name="Student[education_grade_id]" id="student-education_grade_id" ng-options="option.education_grade_id as option.name for option in InstitutionStudentController.educationGradeOptions" ng-model="InstitutionStudentController.selectedStudentData.education_grade_id" ng-change="InstitutionStudentController.changeEducationGrade()">
                                <option value="">-- <?= __('Select') ?> --</option>
                            </select>
                        </div>
                    ...
                    <div class="input select">
                        ...
                        <div class="input-select-wrapper">
                            <select name="Student[class_id]" id="student-class_id" ng-options="option.id as option.name for option in InstitutionStudentController.classOptions" ng-model="InstitutionStudentController.selectedStudentData.class_id" ng-change="InstitutionStudentController.changeClass()">
                                <option value="">-- <?= __('Select') ?> --</option>
                            </select>
                        </div>
                    ...
                    <div ng-repeat="customField in InstitutionStudentController.customFieldsArray">
                        ...
                        <div ng-repeat="field in customField.data">
                            ...
                            <div class="input string" ng-class="{'required': field.is_mandatory !== 0}"
                                ...
                                <input ng-if="['TEXT'].includes(field.field_type)" ng-model="field.answer" type="text" ng-required="field.is_mandatory !== 0" />
                                <textarea ng-if="['TEXTAREA', 'NOTE'].includes(field.field_type)"
                                          ng-model="field.answer" type="text" ng-required="field.is_mandatory !== 0"></textarea>
                                <input ng-if="['NUMBER', 'DECIMAL'].includes(field.field_type)"
                                       ng-model="field.answer" type="number" step="{{field.field_type === 'DECIMAL' ? 0.01 : undefined}}"
                            ...
                            <div class="input date" ng-class="{'required': field.is_mandatory !== 0}" ng-if="field.field_type === 'DATE'">
                                ...
                                <div class="input-group date" id="{{field.student_custom_field_id}}" style="" datepicker=""
                                     ng-model="field.answer" ng-click="[field.isDatepickerOpen = !field.isDatepickerOpen]"
                                     ng-init="field.isDatepickerOpen = false">
                                    <input type="text" class="form-control " ng-model="field.answer" uib-datepicker-popup="dd-MM-yyyy"
                                           is-open="field.isDatepickerOpen" datepicker-options="field.datePickerOptions"
                                           close-text="Close" alt-input-formats="altInputFormats"
                                           style="width: calc(100% - 52px) !important" ng-change="field.isDatepickerOpen = false"
                                           ng-required="field.is_mandatory !== 0" />
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                </div>
                                <div ng-if="field.errorMessage" class="error-message">
                            ...
                            <div class="input selection" ng-class="{'required': field.is_mandatory !== 0}" ng-if="field.field_type === 'CHECKBOX'">
                                <label for="{{field.student_custom_field_id}}">{{field.name}}</label>
                                <div class="input-group input-selection">
                                    <div ng-repeat="option in field.option">
                                        <input type="checkbox" id="{{option.option_id}}" name="{{option.option_name}}"
                                               ...
                                               ng-required="field.is_mandatory !== 0">
                                        <label class="selection-label" for="{{option.option_id}}"> {{option.option_name}}</label>
                                    </div>
                                </div>
                                <div ng-if="field.errorMessage" class="error-message">
                                    <p>{{ field.errorMessage }}</p>
                            ...
                            <div class="input file" ng-class="{'required': field.is_mandatory !== 0}" ng-if="field.field_type === 'FILE'">
                                <label for="{{field.student_custom_field_id}}">{{field.name}}</label>

                                <!-- Your PHP code can be translated to AngularJS as follows -->
                                <div class="input-group fileinput" ng-class="{'input-double-btn': startWithTwoLeftButton, 'input-single-btn': startWithOneLeftButton, 'always-single': alwaysShowOneButton}">
                                    <!-- Left buttons -->
                                    ...
                                    <!-- Right buttons -->
                                    <a href="#" ng-if="field.answer" class="input-group-addon btn btn-file-cancel" data-dismiss="fileinput" ng-click="removeFile(field)">
                                    ...
                                    <div class="input-group-addon btn btn-default btn-file">
                                        ...
                                        <input type="file"
                                               ng-model="field.answer"
                                               name="file"
                                               onchange="angular.element(this).scope().uploadFile(angular.element(this).scope().field, event)" class="fa fa-folder">
                                    </div>
            ...
            <div class="step-pane sample-pane" ng-show="InstitutionStudentController.isDiffSchool > 0 && InstitutionStudentController.step === 'transfer_student'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input select required error">
                        <label><?= __('Academic Period') ?></label>
                        <input ng-model="InstitutionStudentController.currentAcademicPeriodName" type="string" ng-disabled="true">
                    </div>
                    <div class="input select required error">
                        <label><?= __('Education Grade') ?></label>
                        <div class="input-select-wrapper">
                    ...
                    <div class="input select required error">
                        ...
                        <div class="input-select-wrapper">
                            <select name="Student[transfer_reason_id]" id="student-transfer_reason_id" ng-options="option.id as option.name for option in InstitutionStudentController.transferReasonsOptions" ng-model="InstitutionStudentController.selectedStudentData.transfer_reason_id" ng-change="InstitutionStudentController.changeTransferReason()">
                                <option value="">-- <?= __('Select') ?> --</option>
                            </select>
                        </div>
                                                        ...
                                                        <table class="table" style="margin-bottom: 0px !important;">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="vertical-align-top">{{InstitutionStudentController.selectedStudentData.contact_type_name}}</td>
                                                                    <td class="vertical-align-top">{{InstitutionStudentController.selectedStudentData.contact_value}}</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
