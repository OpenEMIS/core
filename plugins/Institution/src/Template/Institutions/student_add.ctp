...
<div class="pd-10">
    ...
    <div class="stepper-content-wrapper">
        ...
        <div class="actions top">
            ...
            <button  ng-disabled="InstitutionStudentController.isIdentityUserExist && InstitutionStudentController.step === 'internal_search'"type="button" class="btn btn-default btn-next"
