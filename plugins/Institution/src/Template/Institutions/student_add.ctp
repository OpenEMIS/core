                ...
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input date required">
                        ...
                        <div class="input-group date" id="Student_date_of_birth" style="" datepicker="" ng-model="InstitutionStudentController.selectedStudentData.date_of_birth" ng-click="[isDatepickerOpen = !isDatepickerOpen, InstitutionStudentController.error.date_of_birth = '']">
                            <input type="text" class="form-control " ng-model="InstitutionStudentController.selectedStudentData.date_of_birth" uib-datepicker-popup="MM/dd/yyyy" is-open="isDatepickerOpen" datepicker-options="InstitutionStudentController.dobDatepickerOptions" close-text="Close" alt-input-formats="altInputFormats" style="width: calc(100% - 52px) !important" />
                        ...
                        <div>
                            ...
                            <div class="d-flex">
                                <div class="position-relative">
                                    <!-- <button class="btn btn-xs btn-default fontSize-16" ng-click="InstitutionStudentController.savePhoto(this)">
                                        <i class="fa fa-folder"></i>
                                        <span>Select File</span>
                                    </button>
                                    <input id="image-file" type="file"  class="input-hidden" > -->
                                    <input id="image-file" type="file" class="file-input" onchange="savePhoto(this)" >
                                </div>
                            </div>
                        </div>
                    </div>
