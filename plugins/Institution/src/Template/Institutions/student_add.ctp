...
<div class="pd-10">
    <div class="stepper-content-wrapper" ng-if="!InstitutionStudentController.isGuardianAdding">
            ...
            <div class="step-pane sample-pane" ng-if="InstitutionStudentController.step === 'user_details'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input date required">
                        ...
                        <div class="input-group date " id="Student_date_of_birth" style="" ng-click="InstitutionStudentController.error.date_of_birth = ''">
                            <input type="text" class="form-control " name="Staff[date_of_birth]" ng-model="InstitutionStudentController.selectedStudentData.date_of_birth">
            ...
            <div class="step-pane sample-pane" ng-if="InstitutionStudentController.step === 'add_student'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input date required">
                        ...
                        <div class="input-group date " id="Students_start_date" style="" ng-click="InstitutionStudentController.error.startDate = ''">
                            <input type="text" class="form-control " name="Student[startDate]" ng-model="InstitutionStudentController.selectedStudentData.startDate">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                        </div>
                    ...
                    <div class="input string">
                        ...
                        <input ng-model="selectedUserData.motherLivingWithStudent" type="string" />
                    </div>
                    <div class="input string">
                        <label><?= __('Mother Is Deceased') ?></label>
                        <input ng-model="selectedUserData.motherDeceased" type="string">
                    </div>
                    <div class="input string">
                        <label><?= __('Father Living With Student') ?></label>
                        <input ng-model="selectedUserData.fatherLivingWithStudent" type="string">
                    </div>
                    <div class="input string">
                        <label><?= __('Father Is Deceased') ?></label>
                        <input ng-model="selectedUserData.fatherDeceased" type="string">
                    </div>
                    <div class="input string">
                        <label><?= __('Guardian Living With Student') ?></label>
                        <input ng-model="selectedUserData.guardianLivingWithStudent" type="string">
                    </div>
                    <div class="input string">
                        <label><?= __('Guardian Is Deceased') ?></label>
                        <input ng-model="selectedUserData.guardianDeceased" type="string">
                    </div>
                </form>
            </div>
    ...
    <div class="stepper-content-wrapper" ng-if="InstitutionStudentController.isGuardianAdding">
        <div class="steps-container">
            <ul class="steps" style="margin-left: 0">
                <li ng-class="{'active': InstitutionStudentController.guardianStep === 'user_details'}">
                    <div class="stepper-steps-wrapper">
                        User Details
                        <span class="chevron"></span>
                    </div>
                </li>
                <li ng-class="{'active': InstitutionStudentController.guardianStep === 'internal_search'}">
                    <div class="stepper-steps-wrapper">
                        Internal Search
                        <span class="chevron"></span>
                    </div>
                </li>
                <li ng-class="{'active': InstitutionStudentController.guardianStep === 'external_search'}">
                    <div class="stepper-steps-wrapper">
                        External Search
                        <span class="chevron"></span>
                    </div>
                </li>
                <li ng-class="{'active': InstitutionStudentController.guardianStep === 'confirmation'}">
                    <div class="stepper-steps-wrapper">
                        Confirmation
                        <span class="chevron"></span>
                    </div>
                </li>
                <li ng-class="{'active': InstitutionStudentController.guardianStep === 'summary'}">
                    <div class="stepper-steps-wrapper">
                        Summary
                        <span class="chevron"></span>
                    </div>
        ...
        <div class="actions top">
            <button
                ng-if="(InstitutionStudentController.guardianStep === 'user_details')"
                type="button" class="btn close-btn" ng-click="InstitutionStudentController.cancelProcess()">Cancel</button>
            <button
                ng-if="(InstitutionStudentController.guardianStep !== 'user_details' && InstitutionStudentController.guardianStep !== 'summary')"
                type="button" class="btn btn-prev close-btn" ng-click="InstitutionStudentController.goToPrevStep()">Back</button>
            <button
                ng-if="(InstitutionStudentController.guardianStep === 'confirmation' && InstitutionStudentController.guardianStep !== 'summary')"
                type="button" class="btn btn-default" ng-click="InstitutionStudentController.confirmUser()">Confirm</button>
            <button
                ng-if="(InstitutionStudentController.guardianStep === 'summary')"
                type="button" class="btn close-btn" ng-click="InstitutionStudentController.goToFirstStep()">Close</button>
            <button type="button" class="btn btn-default btn-next"
                ng-if="InstitutionStudentController.guardianStep !== 'confirmation' && InstitutionStudentController.guardianStep !== 'summary'" ng-click="InstitutionStudentController.goToNextStep()">Next</button>
        </div>
        <div class="step-content">
            <div class="alert alert-success">
                <a class="close" aria-hidden="true" href="#" data-dismiss="alert">×</a>Student guardian successfully added.
            </div>
            <div class="step-pane sample-pane" ng-if="InstitutionStudentController.guardianStep === 'user_details'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    <div class="row section-header header-space-lg">Information</div>
                    <div class="input select required error">
            ...
            <div class="step-pane sample-pane" ng-if="InstitutionStudentController.guardianStep === 'internal_search'">
                <div class="table-wrapper">
                    <div>
                        <div class="scrolltabs">
                            <div id="institution-student-table" class="table-wrapper">
            ...
            <div class="step-pane sample-pane" ng-if="InstitutionStudentController.guardianStep === 'external_search'">
                <div class="table-wrapper">
                    <div>
                        <div class="scrolltabs sticky-content">
                            <div id="institution-student-table" class="table-wrapper">
            ...
            <div class="step-pane sample-pane" ng-if="InstitutionStudentController.guardianStep === 'confirmation'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    <div class="row section-header header-space-lg">Information</div>
                    <div class="input string required">
            ...
            <div class="step-pane sample-pane active" ng-if="InstitutionStudentController.guardianStep === 'summary'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post" >
                    <div class="wrapper">
                        <div class="wrapper-child">
                            <div class="panel">
