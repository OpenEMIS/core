    ...
    <div class="stepper-content-wrapper">
        ...
        <div class="actions top">
            ...
            <button
                ...
                type="button" class="btn close-btn" ng-click="InstitutionStudentController.cancelProcess()">Close</button>
            <button type="button" class="btn btn-default btn-next"
                ng-if="InstitutionStudentController.step!=='add_student' && InstitutionStudentController.step!=='summary' && InstitutionStudentController.step!=='transfer_student'" ng-click="InstitutionStudentController.goToNextStep()">Next</button>
            <button type="button" class="btn btn-default btn-next"
            ng-if="InstitutionStudentController.step==='summary' && InstitutionStudentController.isDiffSchool" ng-click="InstitutionStudentController.step = 'transfer_student'">Transfer Student</button>
            <button type="button" class="btn btn-default btn-next"
            ng-if="InstitutionStudentController.step==='transfer_student'" ng-click="InstitutionStudentController.transferStudent()">Save</button>
            <button type="button" class="btn btn-default btn-next"
        ...
        <div class="step-content">
            <div class="step-pane sample-pane" ng-if="InstitutionStudentController.step === 'user_details'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input date required">
                        ...
                        <div class="input-group date" id="Student_date_of_birth" style="" datepicker="" ng-model="InstitutionStudentController.selectedStudentData.date_of_birth" ng-click="[isDatepickerOpen = !isDatepickerOpen, InstitutionStudentController.postResponse.error.date_of_birth = '']">
                            <input type="text" class="form-control " ng-model="InstitutionStudentController.selectedStudentData.date_of_birth" uib-datepicker-popup="yyyy/MM/dd" is-open="isDatepickerOpen" datepicker-options="InstitutionStudentController.dobDatepickerOptions" close-text="Close" alt-input-formats="altInputFormats" style="width: calc(100% - 52px) !important" />
            ...
            <div class="step-pane sample-pane" ng-if="InstitutionStudentController.step === 'add_student'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input date required">
                        ...
                        <div class="input-group date" id="Student_start_date" style="" datepicker="" ng-model="InstitutionStudentController.selectedStudentData.startDate" ng-click="[isStartDatepickerOpen = !isStartDatepickerOpen, InstitutionStudentController.error.startDate = '']">
                            <input type="text" class="form-control " ng-model="InstitutionStudentController.selectedStudentData.startDate" uib-datepicker-popup="yyyy/MM/dd" is-open="isStartDatepickerOpen" datepicker-options="InstitutionStudentController.datepickerOptions" close-text="Close" alt-input-formats="altInputFormats" style="width: calc(100% - 52px) !important" />
                            <span class="input-group-addon" style="background-color: #6699CC; color: #FFF;"><i class="glyphicon glyphicon-calendar"></i></span>
                        </div>
            ...
            <div class="step-pane sample-pane" ng-if="InstitutionStudentController.isDiffSchool > 0 && InstitutionStudentController.step === 'transfer_student'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    <div class="input string">
                        <label><?= __('OpenEMIS ID') ?></label>
                        <input ng-model="InstitutionStudentController.selectedStudentData.openemis_no" type="string" ng-disabled="true">
                    ...
                    <div class="input string">
                        ...
                        <input ng-model="InstitutionStudentController.studentData.currentlyAllocatedTo" type="string" ng-disabled="true">
                    </div>
                    <div class="input select required error">
                        <label><?= __('Academic Period') ?></label>
                    ...
                    <div class="input date required">
                        ...
                        <div class="input-group date" id="Student_transfer_start_date" style="" datepicker="" ng-model="InstitutionStudentController.selectedStudentData.transferStartDate" ng-click="[isTransferStartDatepickerOpen = !isTransferStartDatepickerOpen, InstitutionStudentController.error.transferStartDate = '']">
                            <input type="text" class="form-control " ng-model="InstitutionStudentController.selectedStudentData.transferStartDate" uib-datepicker-popup="yyyy/MM/dd" is-open="isTransferStartDatepickerOpen" datepicker-options="InstitutionStudentController.datepickerOptions" close-text="Close" alt-input-formats="altInputFormats" style="width: calc(100% - 52px) !important" />
                            <span class="input-group-addon" style="background-color: #6699CC; color: #FFF;"><i class="glyphicon glyphicon-calendar"></i></span>
                        </div>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-input">{{InstitutionStudentController.selectedStudentData.gender.name ? InstitutionStudentController.selectedStudentData.gender.name : InstitutionStudentController.selectedStudentData.gender}}</div>
                                    </div>
                                    <div class="row">
