                ...
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    <div id="additional_information">
                        ...
                        <div class="{{InstitutionStudentController.identityTypeClass}}
                            ...
                            <label><?= __('Identity Type') ?></label>
                            <div class="input-select-wrapper">
                                <select name="Student[identities_type_id]" id="student-identities_type_id" ng-options="option.id as option.name for option in InstitutionStudentController.identityTypeOptions" ng-model="InstitutionStudentController.selectedStudentData.identity_type_id" ng-change="InstitutionStudentController.changeIdentityType()">
                                    <option value="">-- <?= __('Select') ?> --</option>
                                </select>
                            </div>
                        ...
                        <div class="input string">
                            ...
                            <input ng-model="InstitutionStudentController.selectedStudentData.identity_number"
                                   type="string" ng-disabled="!InstitutionStudentController.isSearchResultEmpty">
