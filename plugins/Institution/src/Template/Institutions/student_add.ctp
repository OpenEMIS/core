                ...
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div ng-class="nationality_class" class="input select ">
                        ...
                        <div class="input-select-wrapper">
                            <select name="Staff[nationality_id]" id="staff-nationality_id" ng-options="option.id as option.name for option in InstitutionStudentController.nationalitiesOptions" ng-model="InstitutionStudentController.selectedStudentData.nationality_id" ng-change="InstitutionStudentController.changeNationality()">
                    ...
                    <div ng-class="InstitutionStudentController.Staff.identity_type_class" class="input select ">
                        ...
                        <div class="input-select-wrapper">
                            <select name="Staff[identities_type_id]" id="staff-identities_type_id" ng-options="option.id as option.name for option in InstitutionStudentController.identityTypeOptions | orderBy : 'order'" ng-model="InstitutionStudentController.selectedStudentData.identity_type_id" ng-change="InstitutionStudentController.changeIdentityType()">
                                <option value="">-- <?= __('Select') ?> --</option>
                            </select>
                        </div>
                    ...
                    <div class="input select error required">
                        ...
                        <div class="input-select-wrapper">
                            <select name="Staff[gender_id]" id="staff-gender_id" ng-options="option.id as option.name for option in InstitutionStudentController.genderOptions" ng-model="InstitutionStudentController.selectedStudentData.gender_id" ng-change="InstitutionStudentController.changeGender()">
                                <option value="">-- <?= __('Select') ?> --</option>
                            </select>
                        </div>
            ...
            <div class="step-pane sample-pane" ng-show="InstitutionStudentController.step === 'confirmation'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div ng-class="InstitutionStudentController.Staff.identity_type_class" class="input select" ng-show="!InstitutionStudentController.canSkipIdentity">
                        <label><?= __('Identity Type') ?></label>
                        <div class="input-select-wrapper">
                            <select name="Staff[identities_type_id]" id="staff-identities_type_id" ng-options="option.id as option.name for option in InstitutionStudentController.identityTypeOptions" ng-model="InstitutionStudentController.selectedStudentData.identity_type_id" ng-change="InstitutionStudentController.changeIdentityType()">
                                <option value="">-- <?= __('Select') ?> --</option>
                            </select>
                        </div>
                        <div ng-if="InstitutionStudentController.postResponse.error.identities[0].identity_type_id" class="error-message">
                    ...
                    <div class="input string">
                        ...
                        <input ng-model="InstitutionStudentController.selectedStudentData.identity_number" type="string" ng-disabled="InstitutionStudentController.canSkipIdentity">
                        <div ng-if="InstitutionStudentController.error.identity_number" class="error-message">
                            <p>{{ InstitutionStudentController.error.identity_number }}</p>
                        </div>
                    </div>
