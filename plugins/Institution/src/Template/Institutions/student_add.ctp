                ...
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input date required">
                        ...
                        <div class="input-group date" id="Student_date_of_birth" style="" datepicker="" ng-model="InstitutionStudentController.selectedStudentData.date_of_birth" ng-click="[isDatepickerOpen = !isDatepickerOpen, InstitutionStudentController.error.date_of_birth = '']">
                            <input type="text" class="form-control " ng-model="InstitutionStudentController.selectedStudentData.date_of_birth" uib-datepicker-popup="dd/MM/yyyy" is-open="isDatepickerOpen" datepicker-options="InstitutionStudentController.dobDatepickerOptions" close-text="Close" alt-input-formats="altInputFormats" style="width: calc(100% - 52px) !important" />
                ...
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div ng-repeat="customField in InstitutionStudentController.customFieldsArray">
                        ...
                        <div ng-repeat="field in customField.data">
                            ...
                            <div class="input select" ng-if="field.field_type === 'TIME'">
                                <label for={{field.student_custom_field_id}}>{{field.name}}</label>
                                <div class="input-group time" uib-timepicker ng-model="field.answer" ng-change="InstitutionStudentController.changed(field.answer)" hour-step="field.hourStep" minute-step="field.minuteStep" show-meridian="field.isMeridian"></div>
                            </div>
                            <div class="input date" ng-if="field.field_type === 'CHECKBOX'">
                                <label for={{field.student_custom_field_id}}>{{field.name}}</label>
                                <div class="input-group check_box">
                                    <div ng-repeat="option in field.option">
                                        <input type="checkbox" id={{option.option_id}} name={{option.option_name}} value={{option.option_id}} ng-model="option.selected" ng-change="InstitutionStudentController.selectOption(field)">
