        ...
        <div class="step-content">
            <div class="step-pane sample-pane" ng-show="InstitutionStudentController.step === 'user_details'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div ng-class="InstitutionStudentController.Staff.identity_type_class" class="input select required">
                    ...
                    <div ng-class="InstitutionStudentController.identity_class" class="input select required">
