...
<div class="pd-10">
    ...
    <div class="stepper-content-wrapper">
        ...
        <div class="actions top">
           ...
           <span ng-if="!InstitutionStaffController.isIdentityUserExist"> <button type="button" class="btn btn-default btn-next"
                ng-if="InstitutionStaffController.step!=='add_staff' && InstitutionStaffController.step!=='summary' && InstitutionStaffController.step!=='transfer_staff'" ng-click="InstitutionStaffController.goToNextStep()" style="font-size: 12px;">Next</button></span>
