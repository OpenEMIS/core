        ...
        <div class="step-content">
            <div class="step-pane sample-pane" ng-show="InstitutionStaffController.step === 'user_details'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input string required">
                        ...
                        <input ng-model="InstitutionStaffController.selectedStaffData.first_name" ng-change="InstitutionStaffController.setStaffName()" type="string" ng-init="InstitutionStaffController.selectedStaffData.first_name='Abc';">
                    ...
                    <div class="input string required">
                        ...
                        <input ng-model="InstitutionStaffController.selectedStaffData.last_name" ng-change="InstitutionStaffController.setStaffName()" type="string" ng-init="InstitutionStaffController.selectedStaffData.last_name='Abc';">
                    ...
                    <div class="input select required error">
                        ...
                        <div class="input-select-wrapper">
                            <select name="Staff[gender_id]" id="staff-gender_id"
                                ...
                                ng-init="InstitutionStaffController.selectedStaffData.gender_id='number:1';"
                                >
            ...
            <div class="step-pane sample-pane" ng-show="InstitutionStaffController.step === 'confirmation'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="row section-header header-space-lg">Address Area {{addressAreaId}}</div>
                    <div class="input string" >
                    ...
                    <div class="row section-header header-space-lg">Birthplace Area {{birthplaceAreaId}}</div>
                    <div class="input string">
