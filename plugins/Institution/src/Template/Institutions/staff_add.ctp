        ...
        <div class="step-content">
            ...
            <div class="step-pane sample-pane" ng-show="InstitutionStaffController.step === 'confirmation'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div id="additional_information">
                        ...
                        <!-- Nationality -->
                        <div ng-show="!InstitutionStaffController.nationalitySkipped">
                            <div class="input string" ng-show="InstitutionStaffController.canSkipNationality">
                                <label><?= __('Nationality') ?></label>
                                <input ng-model="InstitutionStaffController.selectedStaffData.nationality_name"
                                       type="string" ng-disabled="true"/>
                            </div>
                            <div ng-class="nationality_class" class="input select"
                                 ng-show="!InstitutionStaffController.canSkipNationality">
                                <!-- Nationality Type if Staff is not Found -->
                                <div class="{{InstitutionStaffController.nationalityClass}}
                                                                {{InstitutionStaffController.nationalitiesRequired}}">
                                    <label><?= __('Nationality') ?></label>
                                    {{InstitutionStaffController.nationalityClass}}
                                    <div class="input-select-wrapper">
                                        <select name="Staff[nationality_id]"
                                    ...
                                    <div
                                        ng-if="InstitutionStaffController.postResponse.error.nationalities[0].nationality_id"
                                        class="error-message">
                                        <p ng-repeat="error in InstitutionStaffController.postResponse.error.nationalities[0].nationality_id">
                                            {{ error }}</p>
                                    </div>
                                    <div ng-if="InstitutionStaffController.error.nationality_id"
                                         class="error-message">
                                        <p>{{ InstitutionStaffController.error.nationality_id }}</p>
                                    </div>
                                </div>
                        ...
                        <!-- Identity -->
                        <div ng-show="!InstitutionStaffController.identitySkipped">
                            <!-- Identity Type if Staff is Found -->
                            <div class="input string"
                                 ng-show="InstitutionStaffController.canSkipIdentity">
                                <label><?= __('Identity Type') ?></label>
                                <input ng-model="InstitutionStaffController.selectedStaffData.identity_type_name"
                                       type="string" ng-disabled="true">
                            </div>
                            <div class="input string"
                                 ng-show="InstitutionStaffController.canSkipIdentity">
                                <label><?= __('Identity Number') ?></label>
                                <input ng-model="InstitutionStaffController.selectedStaffData.identity_number"
                                       type="string"
                                       ng-disabled="InstitutionStaffController.canSkipIdentity">
                            </div>

                            <!-- Identity Type if Staff is not Found -->
                            <div class="{{InstitutionStaffController.identityTypeClass}}
                                        {{InstitutionStaffController.identitiesRequired}}"
                                 ng-show="!InstitutionStaffController.canSkipIdentity">

                                <div class="input select">
                                    <label><?= __('Identity Type') ?></label>
                                    <div class="input-select-wrapper">
                                        <select name="Staff[identities_type_id]"
                                    ...
                                    <div
                                        ng-if="InstitutionStaffController.postResponse.error.identities[0].identity_type_id"
                                        class="error-message">
                                        <p ng-repeat="error in InstitutionStaffController.postResponse.error.identities[0].identity_type_id">
                                            {{ error }}</p>
                                    </div>
                                    <div ng-if="InstitutionStaffController.error.identity_type_id"
                                         class="error-message">
                                        <p>{{ InstitutionStaffController.error.identity_type_id }}</p>
                                    </div>
                                </div>
                                <div class="input string {{InstitutionStaffController.identitiesRequired}}">
                                    <label><?= __('Identity Number') ?></label>
                                    <input ng-model="InstitutionStaffController.selectedStaffData.identity_number"
                                           type="string"
                                           ng-disabled="InstitutionStaffController.canSkipIdentity">
                                    <div ng-if="InstitutionStaffController.error.identity_number"
                                         class="error-message">
                                        <p>{{ InstitutionStaffController.error.identity_number }}</p>
                                    </div>
                                </div>
                        ...
                        <!-- Contact -->
                        <div ng-show="!InstitutionStaffController.contactSkipped">
                            <div class="{{InstitutionStaffController.contactTypeClass}}
                                {{InstitutionStaffController.contactsRequired}}">
                                <label><?= __('Contact Type') ?></label>
                                <div class="input-select-wrapper">
                                    <select name="Staff[contact_type_id]" id="student-contact_type_id"
                                            ng-options="option.id as option.name
                                            for option in InstitutionStaffController.contactTypeOptions"
                                            ng-model="InstitutionStaffController.selectedStaffData.contact_type_id"
                                            ng-change="InstitutionStaffController.changeContactType()">
                                        <option value="">-- <?= __('Select') ?> --</option>
                                    </select>
                                </div>
                                <div ng-if="InstitutionStaffController.error.contact_type_id" class="error-message">
                                    <p>{{ InstitutionStaffController.error.contact_type_id }}</p>
                                </div>
                            </div>
                            <div class="input string {{InstitutionStaffController.contactsRequired}}">
                                <label><?= __('Contact Value') ?></label>
                                <input ng-model="InstitutionStaffController.selectedStaffData.contact_value"
                                       type="string">
                                <div ng-if="InstitutionStaffController.error.contact_value" class="error-message">
                                    <p>{{ InstitutionStaffController.error.contact_value }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="step-pane sample-pane" ng-show="InstitutionStaffController.step === 'add_staff'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <!-- POCOR-7871:start -->
                    <div class="input string required" ng-hide="InstitutionStaffController.disableFields.username">
                    ...
                    <!--POCOR-8108 added changePositionGrade ng-change func-->
                    <div class="input select required error">
                        ...
                        <select name="Staff[institution_position_id]" id="staff-institution-position-id"
                            ...
                            ng-change="InstitutionStaffController.changePositionGrade()"
                        ...
                        <div class="wrapper-child">
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="input string">
                                        <label><?= __('Is Homeroom') ?></label>
                                        <input type="string" ng-if="InstitutionStaffController.selectedStaffData.is_homeroom == 1" ng-value="'Yes'" ng-disabled="true">
                                        <input type="string" ng-if="!InstitutionStaffController.selectedStaffData.is_homeroom || InstitutionStaffController.selectedStaffData.is_homeroom == 0" ng-value="'No'" ng-disabled="true">
                                    </div>
                                    <!-- POCOR-7870:end -->
                                        <div class="input string">
