            ...
            <div class="step-pane sample-pane" ng-show="InstitutionStaffController.step === 'confirmation'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div id="additional_information">
                        ...
                        <!-- Nationality if Staff is Found -->
                        <div class="input"
                             ng-show="!InstitutionStaffController.isSearchResultEmpty">
                            <label><?= __('Nationality') ?></label>
                    ...
                    <div class="input select">
                        ...
                        <div class="input-select-wrapper">
                            <select name="Staff[contact_type_id]" id="staff-contact_type_id"
                                    ng-options="option.id as option.name for option in InstitutionStaffController.contactTypeOptions"
                    ...
                    <div class="input string">
                        ...
                        <input ng-model="InstitutionStaffController.selectedStaffData.contact_value" type="string">
                    </div>
                    <div class="input string" ng-show="InstitutionStaffController.canSkipNationality">
                        ...
                        <div class="{{InstitutionStaffController.nationalityClass}}
                             ...
                             ng-show="!InstitutionStaffController.nationalitiesSkipped
                                && InstitutionStaffController.isSearchResultEmpty ">
                    <div ng-class="nationality_class" class="input select"
                        ...
                        <div class="{{InstitutionStaffController.identityTypeClass}}
                             ...
                             ng-show="!InstitutionStaffController.identitiesSkipped
                                && InstitutionStaffController.isSearchResultEmpty ">
                    <div class="input string"
                    ...
                    <div class="input string">
                            ...
                            <input ng-model="InstitutionStaffController.selectedStaffData.identity_number"
                                   type="string"
                                   ng-disabled="!InstitutionStaffController.isSearchResultEmpty">
                        <input ng-model="InstitutionStaffController.selectedStaffData.identity_number" type="string"
                        ...
                        <div class="{{InstitutionStaffController.contactTypeClass}}
                             ...
                             ng-show="!InstitutionStaffController.contactsSkipped
                             && InstitutionStaffController.isSearchResultEmpty ">
                            <label><?= __('Contact Type') ?></label>
                            <div class="input-select-wrapper">
                                <select name="Staff[contact_type_id]" id="staff-contact_type_id"
                                        ng-options="option.id as option.full_contact_type_name for option in InstitutionStaffController.contactTypeOptions"
                                        ng-model="InstitutionStaffController.selectedStaffData.contact_type_id"
                                        ng-change="InstitutionStaffController.changeContactType()">
                                    <option value="">-- <?= __('Select') ?> --</option>
                                </select>
