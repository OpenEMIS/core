    ...
    <div class="stepper-content-wrapper">
        ...
        <div class="actions top">
            ...
            <button
                ...
                type="button" class="btn btn-default" ng-click="InstitutionStaffController.saveStaffDetails()">Confirm</button>
            <button
                ...
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input date required">
                        ...
                        <div class="input-group date" id="Staff_start_date" style="" datepicker="" ng-model="InstitutionStaffController.selectedStaffData.startDate" ng-click="[isStartDatepickerOpen = !isStartDatepickerOpen, InstitutionStaffController.postResponse.error.startDate = '']">
                            <input type="text" class="form-control " ng-model="InstitutionStaffController.selectedStaffData.startDate" uib-datepicker-popup="dd/MM/yyyy" is-open="isStartDatepickerOpen" datepicker-options="InstitutionStaffController.datepickerOptions" close-text="Close" alt-input-formats="altInputFormats" style="width: calc(100% - 52px) !important" />
                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                        </div>
                    ...
                    <div class="input date">
                        ...
                        <div class="input-group date" id="Staff_end_date" style="" datepicker="" ng-model="InstitutionStaffController.selectedStaffData.endDate" ng-click="[isEndDatepickerOpen = !isEndDatepickerOpen, InstitutionStaffController.postResponse.error.end_date = '']">
                            <input type="text" class="form-control " ng-model="InstitutionStaffController.selectedStaffData.endDate" uib-datepicker-popup="dd/MM/yyyy" is-open="isEndDatepickerOpen" datepicker-options="InstitutionStaffController.datepickerOptions" close-text="Close" alt-input-formats="altInputFormats" style="width: calc(100% - 52px) !important" />
                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                        </div>
                    </div>
                    <div class="input select required error">
