...
<div class="pd-10">
    ...
    <div class="stepper-content-wrapper">
        ...
        <div class="actions top">
           ...
           <button ng-disabled="InstitutionStaffController.isIdentityUserExist &&  InstitutionStaffController.step === 'internal_search'" type="button" class="btn btn-default btn-next"
        ...
        <div class="step-content">
            <div class="step-pane sample-pane" ng-show="InstitutionStaffController.step === 'user_details'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div ng-class="InstitutionStaffController.Staff.identity_type_class" class="input select required">
                    ...
                    <div ng-class="InstitutionStaffController.identity_class" class="input select required">
