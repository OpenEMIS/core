    ...
    <div class="stepper-content-wrapper">
        <div class="steps-container">
            <ul class="steps" style="margin-left: 0">
                ...
                <li ng-class="{'active': InstitutionStaffController.step === 'transfer_staff'}" ng-if="InstitutionStaffController.staffData.is_diff_school > 0">
                    <div class="stepper-steps-wrapper">
                        Staff Transfer
                        <span class="chevron"></span>
                    </div>
        ...
        <div class="actions top">
            ...
            <button
                ...
                type="button" class="btn btn-default" ng-click="InstitutionStaffController.validateDetails()">Confirm</button>
            <button
                ng-if="(InstitutionStaffController.step=='summary')"
                type="button" class="btn close-btn" ng-click="InstitutionStaffController.cancelProcess()">Close</button>
            <button type="button" class="btn btn-default btn-next"
                ng-if="InstitutionStaffController.step!=='add_staff' && InstitutionStaffController.step!=='summary' && InstitutionStaffController.step!=='transfer_staff'" ng-click="InstitutionStaffController.goToNextStep()">Next</button>
            <button type="button" class="btn btn-default btn-next"
                ng-if="InstitutionStaffController.step === 'transfer_staff'" ng-click="InstitutionStaffController.saveStaffDetails()">Save</button>
        </div>
            ...
            <div class="step-pane sample-pane" ng-if="InstitutionStaffController.step === 'user_details'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input date required">
                        ...
                        <div class="input-group date" id="Staff_date_of_birth" style="" datepicker="" ng-model="InstitutionStaffController.selectedStaffData.date_of_birth" ng-click="[isDatepickerOpen = !isDatepickerOpen, InstitutionStaffController.postResponse.error.date_of_birth = '']">
                            <input type="text" class="form-control " ng-model="InstitutionStaffController.selectedStaffData.date_of_birth" uib-datepicker-popup="yyyy/MM/dd" is-open="isDatepickerOpen" datepicker-options="InstitutionStaffController.dobDatepickerOptions" close-text="Close" alt-input-formats="altInputFormats" style="width: calc(100% - 52px) !important" />
            ...
            <div class="step-pane sample-pane" ng-if="InstitutionStaffController.step === 'add_staff'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input select">
                        <label><?= __('Gender') ?></label>
                        <input ng-model="InstitutionStaffController.selectedStaffData.gender.name ? InstitutionStaffController.selectedStaffData.gender.name : InstitutionStaffController.staffData.gender" ng-disabled="true" />
                    </div>
                    <div class="input string required">
                    ...
                    <div class="input date required">
                        ...
                        <div class="input-group date" id="Staff_start_date" style="" datepicker="" ng-model="InstitutionStaffController.selectedStaffData.startDate" ng-click="[isStartDatepickerOpen = !isStartDatepickerOpen, InstitutionStaffController.postResponse.error.startDate = '']">
                            <input type="text" class="form-control " ng-model="InstitutionStaffController.selectedStaffData.startDate" uib-datepicker-popup="yyyy/MM/dd" is-open="isStartDatepickerOpen" datepicker-options="InstitutionStaffController.datepickerOptions" close-text="Close" alt-input-formats="altInputFormats" style="width: calc(100% - 52px) !important" />
                            <span class="input-group-addon" style="background-color: #6699CC; color: #FFF;"><i class="glyphicon glyphicon-calendar"></i></span>
                        </div>
                    ...
                    <div class="input date">
                        ...
                        <div class="input-group date" id="Staff_end_date" style="" datepicker="" ng-model="InstitutionStaffController.selectedStaffData.endDate" ng-click="[isEndDatepickerOpen = !isEndDatepickerOpen, InstitutionStaffController.postResponse.error.end_date = '']">
                            <input type="text" class="form-control " ng-model="InstitutionStaffController.selectedStaffData.endDate" uib-datepicker-popup="yyyy/MM/dd" is-open="isEndDatepickerOpen" datepicker-options="InstitutionStaffController.datepickerOptions" close-text="Close" alt-input-formats="altInputFormats" style="width: calc(100% - 52px) !important" />
                            <span class="input-group-addon" style="background-color: #6699CC; color: #FFF;"><i class="glyphicon glyphicon-calendar"></i></span>
                        </div>
                    </div>
                    <div class="input select required error">
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-input">{{InstitutionStaffController.selectedStaffData.gender.name ? InstitutionStaffController.selectedStaffData.gender.name : InstitutionStaffController.staffData.gender}}</div>
                                    </div>
                                    <div class="row">
                                                ...
                                                <div class="table-wrapper">
                                                    <div class="table-in-view">
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="vertical-align-top">{{InstitutionStaffController.selectedStaffData.identity_type_name ? InstitutionStaffController.selectedStaffData.identity_type_name : InstitutionStaffController.staffData.identity_type}}</td>
                                                                    <td class="vertical-align-top">{{InstitutionStaffController.selectedStaffData.identity_number}}</td>
                                                                    <td class="vertical-align-top">{{InstitutionStaffController.selectedStaffData.nationality_name ? InstitutionStaffController.selectedStaffData.nationality_name : InstitutionStaffController.staffData.nationality}}</td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-input">{{InstitutionStaffController.selectedStaffData.postalCode ? InstitutionStaffController.selectedStaffData.postalCode : InstitutionStaffController.selectedStaffData.postal_code}}</div>
                                    </div>
                                    <div class="row section-header">Address Area</div>
                                    <div class="row">
                                        <div class="col-xs-6 col-md-3 form-label">Address Area</div>
                                        <div class="form-input">{{InstitutionStaffController.selectedStaffData.addressArea.name ? InstitutionStaffController.selectedStaffData.addressArea.name : InstitutionStaffController.staffData.area_name}}</div>
                                    </div>
                                    <div class="row section-header">Birthplace Area</div>
                                    <div class="row">
                                        <div class="col-xs-6 col-md-3 form-label">Birthplace Area</div>
                                        <div class="form-input">{{InstitutionStaffController.selectedStaffData.birthplaceArea.name ? InstitutionStaffController.selectedStaffData.birthplaceArea.name : InstitutionStaffController.staffData.birth_area_name}}</div>
                                    </div>
