            ...
            <div class="step-pane sample-pane" ng-if="InstitutionStaffController.step === 'add_staff'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input date required">
                        ...
                        <div class="input-group date" id="Staff_start_date" style="" datepicker="" ng-model="InstitutionStaffController.selectedStaffData.startDate" ng-click="[isDatepickerOpen = !isDatepickerOpen, InstitutionStaffController.postResponse.error.startDate = '']">
                    ...
                    <div class="input date">
                        ...
                        <div class="input-group date" id="Staff_end_date" style="" datepicker="" ng-model="InstitutionStaffController.selectedStaffData.endDate" ng-click="[isDatepickerOpen = !isDatepickerOpen, InstitutionStaffController.postResponse.error.end_date = '']">
