...
<form accept-charset="utf-8" id="content-main-form" class="form-horizontal ng-pristine ng-valid" novalidate="novalidate" ng-controller="InstitutionAssociationsCtrl as InstitutionAssociationsController">
    ...
    <div class="input string required">
        ...
        <input ng-model="InstitutionAssociationsController.academicPeriodName" type="text">
    </div>
    <div class="input string required">
        <label><?= __('Name') ?></label>
        <input ng-model="InstitutionAssociationsController.className" type="string" ng-init="InstitutionAssociationsController.className='';">
