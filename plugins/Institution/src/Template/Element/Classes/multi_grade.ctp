			...
			<table class="table table-checkable">
				...
				<tbody>
					...
					<tr>
						...
						<input type="checkbox" class="icheck-input" name="<?php echo sprintf($attr['model'].'[institution_section_grades][%d][education_grade_id]', $i) ?>" value="<?php echo $obj->education_grade_id?>" <?php echo ($selected) ? 'checked' : '';?> />
						</td>
