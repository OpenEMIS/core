        ...
        if ($subjectId != 0) {
            $query
                ...
                ->where([
                    ...
                    $InstitutionStudents->aliasField('student_status_id IN') => [$statuses['CURRENT'], $statuses['TRANSFERRED'],$statuses['WITHDRAWN'], $statuses['GRADUATED'], $statuses['PROMOTED'], $statuses['REPEATED']],
