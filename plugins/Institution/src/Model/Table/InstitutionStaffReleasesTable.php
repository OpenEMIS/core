...
class InstitutionStaffReleasesTable extends ControllerActionTable
{
    ...
    {
        foreach (['previous_start_date', 'previous_end_date', 'new_start_date', 'new_end_date'] as $field) {
            ...
            try {
                ...
                Log::warning("InstitutionStaffReleasesTable: Invalid date '{$rawValue}' for field '{$field}' with format '{$systemDateFormat}'");
            }
        }
    }
