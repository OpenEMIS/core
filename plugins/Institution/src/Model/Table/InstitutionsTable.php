...
class InstitutionsTable extends ControllerActionTable
{
    ...
    public function beforeAction(Event $event, ArrayObject $extra)
    {
        ...
        $this->field('area_administrative_id', ['type' => 'area_tree', 'source_model' => 'Area.AreaAdministratives', 'displayCountry' => false]);
        $this->field('area_id', ['type' => 'area_tree', 'source_model' => 'Area.Areas', 'displayCountry' => true]);
