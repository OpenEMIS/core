...
class InstitutionStaffTransfersTable extends ControllerActionTable
{
    ...
    {
        foreach (['new_start_date', 'new_end_date', 'previous_end_date', 'previous_effective_date'] as $field) {
            ...
            try {
                ...
                Log::warning("InstitutionStaffTransfersTable: Invalid date '{$rawValue}' for field '{$field}' with format '{$systemDateFormat}'");
            }
        }
    }
