...
class StudentUserTable extends ControllerActionTable
{
    ...
    private function isSyncEligibleUser($securityUserId): bool
    {
        ...
        $UserIdentities = \Cake\ORM\TableRegistry::getTableLocator()->get('User.Identities');
    ...
    private function getActiveExternalSourceIdentityTypeId()
    {
        ...
        $ExternalAttrs = \Cake\ORM\TableRegistry::getTableLocator()->get('Configuration.ExternalDataSourceAttributes');
