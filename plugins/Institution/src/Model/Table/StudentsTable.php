...
class StudentsTable extends ControllerActionTable
{
    ...
    public function onExcelBeforeQuery(Event $event, ArrayObject $settings, Query $query)
    {
        ...
        //options that can be used in row map
        ...
        $query = $this->addStudentGuardiansField($query);

        $query = $this->addStudentContactsField($query);

        $query = $this->addStudentCustomFields($query);

        $query->orderAsc('Users.first_name');

//        $query->limit(5);
        return $query;
//        $query->contain('Institutions')->select(
//            [
...
//        );
//
//        $query->formatResults(function (\Cake\Collection\CollectionInterface $results) use
//        ($periodId, $institutionId, $Classes, $ClassStudents) {
...
//        });
    ...
    private function addStudentGuardiansField(Query $query)
    {
    ...
    private function addStudentContactsField(Query $query)
    {
