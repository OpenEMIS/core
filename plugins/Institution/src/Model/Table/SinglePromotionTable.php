...
class SinglePromotionTable extends ControllerActionTable
{
    ...
    public function addAfterAction(Event $event, Entity $entity, ArrayObject $extra)
    {
        ...
        $this->field('from_academic_period_id', ['type' => 'readonly']);
        $this->field('education_grade_id', ['type' => 'readonly']);
        $this->field('next_academic_period_id');
        $this->field('grade_to_promote');
        $this->field('student_status_id');

        $this->setFieldOrder([
            'student_id',
            'existing_information_header', 'from_academic_period_id', 'education_grade_id',
            'new_information_header', 'next_academic_period_id', 'grade_to_promote', 'student_status_id']);
    }
    ...
    //     $statuses = $this->statuses;
    //     if (!in_array($studentStatusId, [$statuses['REPEATED']]) && !empty($studentStatusId)) {
    //         $educationGradeId = $request->query('grade_to_promote');
    //         $institutionId = $this->institutionId;
