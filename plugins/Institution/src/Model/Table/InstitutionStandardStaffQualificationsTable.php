...
class InstitutionStandardStaffQualificationsTable extends AppTable
{
    ...
    public function onExcelBeforeQuery(EventInterface $event, ArrayObject $settings, Query $query)
    {
        ...
        $qualificationTitles   = TableRegistry::getTableLocator()->get('QualificationTitles');
        $qualificationLevel    = TableRegistry::getTableLocator()->get('QualificationLevels');
        $institutionStaff      = TableRegistry::getTableLocator()->get('institution_staff');
        $Institutions          = TableRegistry::getTableLocator()->get('Institution.Institutions');
        $fieldOfStudy          = TableRegistry::getTableLocator()->get('education_field_of_studies');
