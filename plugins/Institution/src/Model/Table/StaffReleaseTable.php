...
class StaffReleaseTable extends InstitutionStaffReleasesTable
{
    ...
    {
        foreach (['previous_start_date', 'previous_end_date', 'new_start_date', 'new_end_date', 'position_start_date'] as $field) {
            ...
            try {
                ...
                \Cake\Log\Log::warning("StaffReleaseTable: Invalid date '{$rawValue}' for field '{$field}' with format '{$systemDateFormat}'");
            }
        }
