...
class SalariesTable extends ControllerActionTable
{
    public function beforeMarshal(EventInterface $event, ArrayObject $data, ArrayObject $options)
    {
        foreach (['salary_date'] as $field) {
            ...
            try {
                ...
                Log::warning("Institution.SalariesTable: Invalid date '{$rawValue}' for field '{$field}' with format '{$systemDateFormat}'");
            }
        }
    }
    ...
    public function beforeSave(EventInterface $event, Entity $entity, ArrayObject $options)
    {
        ...
        $SalaryAdditions = TableRegistry::getTableLocator()->get('Staff.StaffSalaryTransactions');
        $present = [];
        ...
        $SalaryDeductions = TableRegistry::getTableLocator()->get('Staff.StaffSalaryTransactions');
        $present = [];
