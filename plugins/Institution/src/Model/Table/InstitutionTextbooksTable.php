        ...
        $tableHeaders = [
            __('Textbook ID') . "
                <div class='tooltip-desc' style='display: inline-block;'>
                    ...
                    <i class='fa fa-info-circle fa-lg table-tooltip icon-blue' tooltip-placement='bottom' uib-tooltip-html='" . 
                    __('Textbook ID is unique number assigned to each book within the school, <br /> Leave it empty for autogenerated Code.') . 
