...
class StudentUserExportTable extends ControllerActionTable
{
    ...
    public function onUpdateFieldIdentityNumber(Event $event, array $attr, $action, ServerRequest $request)
    {
        if ($action == 'add') {
    ...
    public function onExcelGetIdentityNumber(Event $event, Entity $entity)
    {
        ...
        $users = TableRegistry::get('User.UserIdentities');
