...
class UndoTransferredBehavior extends UndoBehavior {
    ...
    public function onGetTransferredStudents(EventInterface $event, $data) {
    ...
    public function processSaveTransferredStudents(EventInterface $event, Entity $entity, ArrayObject $data) 
    {
