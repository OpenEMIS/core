    ...
    <div class="stepper-content-wrapper">
        <div class="steps-container">
            <ul class="steps" style="margin-left: 0">
                ...
                <li ng-if="InstitutionStaffController.isExternalSearchEnable" ng-class="{'active': InstitutionStaffController.step === 'external_search'}">
                    <div class="stepper-steps-wrapper">
                        External Search
                        <span class="chevron"></span>
                    </div>
        ...
        <div class="actions top">
           ...
           <button ng-disabled="InstitutionStaffController.isNextButtonShouldDisable()" type="button" class="btn btn-default btn-next"
        ...
        <div class="step-content">
            <div class="step-pane sample-pane" ng-show="InstitutionStaffController.step === 'user_details'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div ng-class="nationality_class" class="input select">
                        ...
                        <div ng-if="InstitutionStaffController.error.nationality_id" class="error-message">
                            <p>{{ InstitutionStaffController.error.nationality_id }}</p>
                        </div>
                    </div>
                    <div ng-class="InstitutionStaffController.Staff.identity_type_class" class="input select">
                        <label><?= __('Identity Type') ?></label>
                        <div class="input-select-wrapper">
                            <select name="Staff[identities_type_id]" id="staff-identities_type_id"
                                ng-options="option.id as option.name for option in InstitutionStaffController.identityTypeOptions | orderBy : 'order'"
                        ...
                        <div ng-if="InstitutionStaffController.error.identity_type_id" class="error-message">
                            <p>{{ InstitutionStaffController.error.identity_type_id }}</p>
                        </div>
                    </div>
                    <!-- Always show Identity Number POCOR-7245 -->
                    <div ng-class="InstitutionStaffController.identity_class" class="input select">
                        <label><?= __('{{InstitutionStaffController.selectedStaffData.identity_type_name ? InstitutionStaffController.selectedStaffData.identity_type_name :"Identity Number"}}') ?></label>
                        ...
                        <div ng-if="InstitutionStaffController.error.identity_number" class="error-message">
                            <p>{{ InstitutionStaffController.error.identity_number }}</p>
                        </div>
                    </div>
                   <!--  <div ng-class="InstitutionStaffController.identity_class" ng-if="InstitutionStaffController.selectedStaffData.identity_type_id" class="input select required">
            ...
            <div class="step-pane sample-pane" ng-show="InstitutionStaffController.step === 'confirmation'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input string">
                        <label><?= __('Middle Name') ?></label>
                        <input ng-model="InstitutionStaffController.selectedStaffData.middle_name" type="string" ng-disabled="false">
                    </div>
                    <div class="input string">
                        <label><?= __('Third Name') ?></label>
                        <input ng-model="InstitutionStaffController.selectedStaffData.third_name" type="string" ng-disabled="false">
                    </div>
                    <div class="input string required">
                        <label><?= __('Last Name') ?></label>
                    ...
                    <div class="input string" ng-show="!InstitutionStaffController.isSearchResultEmpty" > 
                    ...
                    <div ng-class="nationality_class" class="input select"  ng-show="InstitutionStaffController.isSearchResultEmpty" >
                        <label><?= __('Nationality') ?></label>
                        <div class="input-select-wrapper">
                            <select name="Staff[nationality_id]" id="staff-nationality_id"
                                ng-options="option.id as option.name for option in InstitutionStaffController.nationalitiesOptions"
                    ...
                    <div ng-class="InstitutionStaffController.Staff.identity_type_class" class="input select" ng-show="InstitutionStaffController.isSearchResultEmpty">
                        <label><?= __('Identity Type') ?></label>
                        <div class="input-select-wrapper">
                            <select name="Staff[identities_type_id]" id="staff-identities_type_id"
                    ...
                    <div class="input string">
                        <<!-- <label><?= __('Identity Number') ?></label>
                         input ng-if="InstitutionStaffController.selectedStaffData.identity_number!=''" ng-model="InstitutionStaffController.selectedStaffData.identity_number" type="string" ng-disabled="!InstitutionStaffController.isSearchResultEmpty">
                        <input ng-if="InstitutionStaffController.selectedStaffData.identity_number==''" ng-model="InstitutionStaffController.user_identity_number" type="string" ng-disabled="!InstitutionStaffController.isSearchResultEmpty">
                        <div ng-if="InstitutionStaffController.error.identity_number" class="error-message">
                            <p>{{ InstitutionStaffController.error.identity_number }}</p>
                        </div> -->
                        <label><?= __('Identity Number') ?></label>
                        <input ng-model="InstitutionStaffController.selectedStaffData.identity_number" type="string" ng-disabled="!InstitutionStaffController.isSearchResultEmpty">
                        <div ng-if="InstitutionStaffController.error.identity_number" class="error-message">
                            <p>{{ InstitutionStaffController.error.identity_number }}</p>
                        </div>
                    </div>
            ...
            <div class="step-pane sample-pane" ng-show="InstitutionStaffController.step === 'add_staff'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input string required">
                        ...
                        <input ng-model="InstitutionStaffController.selectedStaffData.username" ng-disabled="InstitutionStaffController.disableFields.username" />
                    </div>
                    <div class="input string required" ng-if="!InstitutionStaffController.isInternalSearchSelected">
                        <label><?= __('Password') ?></label>
                        <input ng-model="InstitutionStaffController.selectedStaffData.password" ng-disabled="InstitutionStaffController.disableFields.password" />
                    </div>
                    <div class="input string required">
                    ...
                    <div class="input select required error">
                        ...
                        <div class="input-select-wrapper">
                            <select name="Staff[is_homeroom]" id="staff-is_homeroom" ng-model="InstitutionStaffController.selectedStaffData.is_homeroom">
                                <option value="" >-- <?= __('Select') ?> --</option>
                                <option value="0" ><?= __('No') ?></option>
                                <option value="1" > <?= __('Yes') ?></option>
                            </select>
                        </div>
                        <div ng-if="InstitutionStaffController.error.is_homeroom" class="error-message">
                            <p>{{ InstitutionStaffController.error.is_homeroom }}</p>
                        </div>
                    </div>
                    <!--POCOR-5070-->
                    ...
                    <div class="input select required error">
                        ...
                        <div class="input-select-wrapper">
                            <select name="Staff[staff_position_grade_id]" id="staff-staff_position_grade_id"
                                ng-options="option.id as option.name for option in InstitutionStaffController.staffGradePositionOptions"
                                ng-model="InstitutionStaffController.selectedStaffData.staff_position_grade_id"
                                ng-change="InstitutionStaffController.changeStaffGradePosition()">
                                <option value="" >-- <?= __('Select') ?> --</option>
                            </select>
                        </div>
                        <div ng-if="InstitutionStaffController.error.staff_position_grade_id" class="error-message">
                            <p>{{ InstitutionStaffController.error.staff_position_grade_id }}</p>
                        </div>
                    </div><!--POCOR-5069 ends-->
                    <div class="input select required error">
