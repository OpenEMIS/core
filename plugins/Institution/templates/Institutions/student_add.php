    ...
    <div class="stepper-content-wrapper">
        ...
        <div class="actions top">
            ...
            <button
                ...
                type="button" class="btn btn-prev close-btn" ng-click="InstitutionStudentController.goToPrevStep()" style="font-size: 12px;">Back</button>
            <button
                ng-if="(InstitutionStudentController.step=='add_student'
                && InstitutionStudentController.step!=='summary')"
                type="button" class="btn btn-default" ng-click="InstitutionStudentController.confirmUser()" style="font-size: 12px;">Confirm</button>
            <button
            ...
            ng-if="InstitutionStudentController.step==='summary'
             && InstitutionStudentController.isDiffSchool"
                    ...
                    style="font-size: 12px;">Transfer Student</button>
            <button type="button" class="btn btn-default btn-next"
            ...
            <button type="button" class="btn btn-default btn-next"
                ...
                && InstitutionStudentController.redirectToGuardian"
                    ng-click="InstitutionStudentController.addGuardian()" style="font-size: 12px;">Add Guardian</button>
        </div>
        <div class="step-content">
            ...
            <div class="step-pane sample-pane" ng-show="InstitutionStudentController.step === 'confirmation'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input string">
                        <label><?= __('Middle Name') ?></label>
                        <input ng-model="InstitutionStudentController.selectedStudentData.middle_name" type="string" ng-disabled="false">
                    </div>
                    <div class="input string">
                        <label><?= __('Third Name') ?></label>
                        <input ng-model="InstitutionStudentController.selectedStudentData.third_name" type="string" ng-disabled="false">
                    </div>
                    <div class="input string required">
                        <label><?= __('Last Name') ?></label>
                    ...
                    <div class="input string" id="addressArea_textbox" style="visibility:hidden">
                        ...
                        <input ng-model="InstitutionStudentController.selectedStudentData.addressArea.name" type="string" ng-disabled="true">
                    </div>
                    ...
                    <div class="input string" id="birthplaceArea_textbox" style="visibility:hidden">
                        ...
                        <input ng-model="InstitutionStudentController.selectedStudentData.birthplaceArea.name" type="string" ng-disabled="true">
                    </div>

                    <div class="input select" id="birthplaceArea_dropdown">
                        <label>Birthplace Area</label>
                        <div
                            class="tree-form"
                            id="birthplace_area"
                            ng-controller="SgTreeCtrl as SgTree"
                    ...
                    <div class="input string" ng-show="!InstitutionStudentController.isSearchResultEmpty">
                    ...
                    <div ng-class="nationality_class" class="input select" ng-show="InstitutionStudentController.isSearchResultEmpty">
                        <label><?= __('Nationality') ?></label>
                        <div class="input-select-wrapper">
                            <select name="Staff[nationality_id]" id="staff-nationality_id"
                                ng-options="option.id as option.name for option in InstitutionStudentController.nationalitiesOptions"
                    ...
                    <div ng-class="InstitutionStudentController.Staff.identity_type_class" class="input select" ng-show="InstitutionStudentController.isSearchResultEmpty">
                        <label><?= __('Identity Type') ?></label>
                        <div class="input-select-wrapper">
                            <select name="Staff[identities_type_id]" id="staff-identities_type_id"
                    ...
                    <div class="input string">
                        ...
                        <input ng-model="InstitutionStudentController.selectedStudentData.identity_number" type="string" ng-disabled="!InstitutionStudentController.isSearchResultEmpty">
                        <div ng-if="InstitutionStudentController.error.identity_number" class="error-message">
                            <p>{{ InstitutionStudentController.error.identity_number }}</p>
                        </div>
                    </div>
            ...
            <div class="step-pane sample-pane" ng-show="InstitutionStudentController.step === 'add_student'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input string required">
                        ...
                        <input ng-model="InstitutionStudentController.selectedStudentData.password" ng-focus="InstitutionStudentController.error.password = ''" ng-disabled="InstitutionStudentController.disableFields.password" />
                    ...
                    <div class="input date required">
                        ...
                        <div class="input-group date " id="Student_start_date" style="">
                            <input type="text" class="form-control " name="Student[start_date]" ng-model="InstitutionStudentController.selectedStudentData.startDate">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                        </div>
            ...
            <div class="step-pane sample-pane" ng-show="InstitutionStudentController.isDiffSchool > 0 && InstitutionStudentController.step === 'transfer_student'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input string">
                        ...
                        <input ng-model="InstitutionStudentController.selectedStudentData.currentlyAllocatedTo" type="string" ng-disabled="true">
                    </div>
                    <div class="input select required error">
                        <label><?= __('Academic Period') ?></label>
                    ...
                    <div class="input date required">
                        ...
                        <div class="input-group date " id="Student_transfer_start_date" style="">
                            <input type="text" class="form-control " name="Student[transfer_start_date]" ng-model="InstitutionStudentController.selectedStudentData.transferStartDate">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                        </div>
                    ...
                    <div class="input string">
                        ...
                        <textarea type="text" class="form-control " name="Student[transfer_comment]" ng-model="InstitutionStudentController.selectedStudentData.transferComment"></textarea>
                    </div>
                </form>
            </div>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-input" ng-if="InstitutionStudentController.selectedStudentData.identity_type_name || InstitutionStudentController.selectedStudentData.identity_number || InstitutionStudentController.selectedStudentData.nationality_name">
                                                ...
                                                <div class="table-wrapper">
                                                    <div class="table-in-view">
                                                        <table class="table" style="margin-bottom: 0px !important;">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="vertical-align-top">{{InstitutionStudentController.selectedStudentData.identity_type_name}}</td>
                                                                    <td class="vertical-align-top">{{InstitutionStudentController.selectedStudentData.identity_number}}</td>
                                                                    <td class="vertical-align-top">{{InstitutionStudentController.selectedStudentData.nationality_name}}</td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-input">{{InstitutionStudentController.selectedStudentData.addressArea.name}}</div>
                                    </div>
                                    <div class="row section-header">Birthplace Area</div>
                                    <div class="row">
                                        <div class="col-xs-6 col-md-3 form-label">Birthplace Area</div>
                                        <div class="form-input">{{InstitutionStudentController.selectedStudentData.birthplaceArea.name}}</div>
                                    </div>
...
<script>
$(function () {
var datepicker0 = $('#Student_start_date').datepicker({"format":"dd-mm-yyyy","todayBtn":"linked","orientation":"auto","autoclose":true, language: '<?php echo $dateLanguage; ?>'});
var datepicker1 = $('#Student_date_of_birth').datepicker({"format":"dd-mm-yyyy","todayBtn":"linked","orientation":"auto","autoclose":true, language: '<?php echo $dateLanguage; ?>'});
var datepicker2 = $('#Student_transfer_start_date').datepicker({"format":"dd-mm-yyyy","todayBtn":"linked","orientation":"auto","autoclose":true, language: '<?php echo $dateLanguage; ?>'});
