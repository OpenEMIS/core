            ...
            <div class="step-content">
                <div class="step-pane sample-pane" ng-show="step === 'user_details'">
                    <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                        <div class="input string">
                            ...
                            <div ng-if="error.openemis_no" class="error-message">
                                <p>{{ error.openemis_no }}</p>
                            </div>
                        </div>
                        ...
                        <div class="input string required">
                            ...
                            <input ng-model="selectedUserData.first_name"
                                   ng-change="setName()"
                                   type="string" ng-focus="error.first_name = ''">
                        ...
                        <div class="input string required">
                            ...
                            <input ng-model="selectedUserData.last_name"
                                   ng-change="setName()" type="string" ng-focus="error.last_name = ''">
                        ...
                        <div class="input date required">
                            ...
                            <div class="input-group date" id="Student_date_of_birth">
                                <input type="text" class="form-control" name="Student[date_of_birth]" ng-model="selectedUserData.date_of_birth" ng-init="selectedUserData.date_of_birth = ''"
                ...
                <div class="step-pane sample-pane" ng-show="step === 'confirmation'">
                    <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                        ...
                        <div class="input string">
                            <label><?= __('Middle Name') ?></label>
                            <input ng-model="selectedUserData.middle_name" type="string" ng-disabled="false">
                        </div>
                        <div class="input string">
                            <label><?= __('Third Name') ?></label>
                            <input ng-model="selectedUserData.third_name" type="string" ng-disabled="false">
                        </div>
                        <div class="input string required">
                            <label><?= __('Last Name') ?></label>
                        ...
                        <div id="additional_information">
                            ...
                            <!-- Nationality -->
                            <div ng-show="!nationalitySkipped">
                                ...
                                <div ng-class="nationality_class" class="input select" ng-show="!canSkipNationality">
                                    ...
                                    <div class="{{nationalityClass}} {{nationalitiesRequired}}">
                                        <label><?= __('Nationality') ?></label>
                                        <div class="input-select-wrapper">
                            ...
                            <div ng-show="!identitySkipped">
                                ...
                                <div class="{{identityTypeClass}} {{identitiesRequired}}"
                                     ng-show="!canSkipIdentity">
                                    ...
                                    <div class="input string {{identitiesRequired}}">
                                        <label><?= __('Identity Number') ?></label>
                            ...
                            <!-- Contact -->
                            <div ng-show="!contactSkipped">
                                <div class="{{contactTypeClass}} {{contactsRequired}}">
                                    <label><?= __('Contact Type') ?>{{selectedUserData.contact_type_id}}</label>
                                    <div class="input-select-wrapper">
                                    ...
                                    <div ng-if="error.contact_type_id" class="error-message">
                                        <p>{{ error.contact_type_id }}</p>
                                    </div>
                                </div>
                                <div class="input string {{contactsRequired}}">
                                    <label><?= __('Contact Value') ?></label>
                                    <input ng-model="selectedUserData.contact_value" type="string">
                                    <div ng-if="error.contact_value" class="error-message">
                                        <p>{{ error.contact_value }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="step-pane sample-pane" ng-show="step === 'add_student'">
                    <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                        ...
                        <div class="input string required">
                            ...
                            <input ng-model="selectedUserData.username" ng-focus="error.username = ''" ng-disabled="disableFields.username">
                            <div ng-if="error.username" class="error-message">
                                <p>{{ error.username }}</p>
                            </div>
                        </div>
                        <div class="input string required" ng-show="!disableFields.password">
                            <label><?= __('Password') ?></label>
                            <input ng-model="selectedUserData.password" ng-focus="error.password = ''" ng-disabled="disableFields.password">
                        ...
                        <div class="input date required">
                            ...
                            <div class="input-group date" id="Student_start_date">
                                <input type="text" class="form-control" name="Student[start_date]" ng-model="selectedUserData.startDate">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                            </div>
                    ...
                    <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                        ...
                        <div class="input date required">
                            ...
                            <div class="input-group date" id="Student_transfer_start_date">
                                <input type="text" class="form-control" name="Student[transfer_start_date]" ng-model="selectedUserData.transferStartDate">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                            </div>
