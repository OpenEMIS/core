...
?>
        ...
        <div class="stepper-content-wrapper">
            <div class="steps-container">
                <ul class="steps" style="margin-left: 0">
                    ...
                    <li ng-if="InstitutionStudentController.isExternalSearchEnable" ng-class="{'active': InstitutionStudentController.step === 'external_search'}">
                        <div class="stepper-steps-wrapper">
                            <?= __('External Search') ?>
                            <span class="chevron"></span>
                        </div>
                    ...
                    <li ng-class="{'active': InstitutionStudentController.step === 'transfer_student'}" ng-if="InstitutionStudentController.isDiffSchool">
                        <div class="stepper-steps-wrapper">
                            <?= __('Transfer Student') ?>
                            <span class="chevron"></span>
                        </div>
            ...
            <div class="actions top">
                <button
                    ...
                    type="button"
                    class="btn close-btn"
                    ng-click="InstitutionStudentController.cancelProcess()"
                    style="font-size: 12px;">
                    <?= __('Cancel') ?>
                </button>
                <button
                    ng-if="InstitutionStudentController.step!=='user_details' && InstitutionStudentController.step!=='summary' && InstitutionStudentController.step!=='transfer_student'"
                    type="button" class="btn btn-prev close-btn" ng-click="InstitutionStudentController.goToPrevStep()" style="font-size: 12px;">
                    <?= __('Back') ?>
                </button>
                <button
                    ng-if="InstitutionStudentController.step=='add_student' && InstitutionStudentController.step!=='summary'"
                    type="button" class="btn btn-default" ng-click="InstitutionStudentController.confirmUser()" style="font-size: 12px;">
                    <?= __('Confirm') ?>
                </button>
                <button
                    ng-if="InstitutionStudentController.step=='summary' && InstitutionStudentController.step==='transfer_student'"
                    type="button" class="btn close-btn"
                    ng-click="InstitutionStudentController.cancelProcess()"
                    style="font-size: 12px;">
                    <?= __('Close') ?>
                </button>
                <button ng-disabled="InstitutionStudentController.isNextButtonShouldDisable()"
                        type="button" class="btn btn-default btn-next"
                        ng-if="InstitutionStudentController.step!=='add_student' && InstitutionStudentController.step!=='summary' && InstitutionStudentController.step!=='transfer_student'"
                        ng-click="InstitutionStudentController.goToNextStep()"
                        style="font-size: 12px;">
                    <?= __('Next') ?>
                </button>
                <button type="button" class="btn btn-default btn-next"
                        ng-if="InstitutionStudentController.step==='summary' && InstitutionStudentController.isDiffSchool"
                        ng-click="InstitutionStudentController.transferStudentNextStep()"
                        style="font-size: 12px;">
                    <?= __('Transfer Student') ?>
                </button>
                <button type="button" class="btn btn-default btn-next"
                        ng-if="InstitutionStudentController.step==='transfer_student'"
                        ng-click="InstitutionStudentController.transferStudent()"
                        style="font-size: 12px;">
                    <?= __('Save') ?>
                </button>
                <button type="button" class="btn btn-default btn-next"
                        ng-if="InstitutionStudentController.step==='summary' && InstitutionStudentController.redirectToGuardian"
                        ng-click="InstitutionStudentController.addGuardian()" style="font-size: 12px;">
                    <?= __('Add Guardian') ?>
                </button>
            </div>
            <div class="step-content">
                <div class="step-pane sample-pane" ng-show="InstitutionStudentController.step === 'user_details'">
                    <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                        ...
                        <div ng-class="nationality_class" class="input select ">
                            ...
                            <div class="input-select-wrapper">
                                <select name="Staff[nationality_id]" id="staff-nationality_id"
                                        ...
                                        ng-model="InstitutionStudentController.selectedUserData.nationality_id"
                        ...
                        <div ng-class="InstitutionStudentController.Staff.identity_type_class" class="input select ">
                            ...
                            <div class="input-select-wrapper">
                                <select name="Staff[identities_type_id]" id="staff-identities_type_id"
                                        ...
                                        ng-model="InstitutionStudentController.selectedUserData.identity_type_id"
                        ...
                        <div ng-class="InstitutionStudentController.identity_class" class="input select ">
                            ...
                            <input ng-model="InstitutionStudentController.selectedUserData.identity_number" type="string">
                        ...
                        <div class="input string">
                            ...
                            <input ng-model="InstitutionStudentController.selectedUserData.openemis_no" type="string">
                        ...
                        <div class="input string required">
                            ...
                            <input ng-model="InstitutionStudentController.selectedUserData.first_name" ng-change="InstitutionStudentController.setStudentName()" type="string" ng-focus="InstitutionStudentController.error.first_name = ''">
                        ...
                        <div class="input string">
                            ...
                            <input ng-model="InstitutionStudentController.selectedUserData.middle_name" ng-change="InstitutionStudentController.setStudentName()" type="string">
                        </div>
                        <div class="input string">
                            <label><?= __('Third Name') ?></label>
                            <input ng-model="InstitutionStudentController.selectedUserData.third_name" ng-change="InstitutionStudentController.setStudentName()" type="string">
                        </div>
                        <div class="input string required">
                            <label><?= __('Last Name') ?></label>
                            <input ng-model="InstitutionStudentController.selectedUserData.last_name" ng-change="InstitutionStudentController.setStudentName()" type="string" ng-focus="InstitutionStudentController.error.last_name = ''">
                        ...
                        <div class="input string">
                            ...
                            <input ng-model="InstitutionStudentController.selectedUserData.preferred_name" type="string">
                        </div>
                        <div class="input select error required">
                            ...
                            <div class="input-select-wrapper">
                                <select name="Staff[gender_id]" id="staff-gender_id"
                                        ...
                                        ng-model="InstitutionStudentController.selectedUserData.gender_id"
                        ...
                        <div class="input date required">
                            ...
                            <div class="input-group date" id="Student_date_of_birth">
                                <input type="text" class="form-control" name="Student[date_of_birth]" ng-model="InstitutionStudentController.selectedUserData.date_of_birth" ng-init="InstitutionStudentController.selectedUserData.date_of_birth = ''"
                ...
                <div class="step-pane sample-pane" ng-show="InstitutionStudentController.step === 'confirmation'">
                    <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                        ...
                        <div class="input string required">
                            <label><?= __('OpenEMIS ID') ?></label>
                            <input ng-model="InstitutionStudentController.selectedUserData.openemis_no" type="string" ng-disabled="true">
                        </div>
                        <div class="input string required">
                            <label><?= __('First Name') ?></label>
                            <input ng-model="InstitutionStudentController.selectedUserData.first_name" type="string" ng-disabled="true">
                        </div>
                        <div class="input string">
                            <label><?= __('Middle Name') ?></label>
                            <input ng-model="InstitutionStudentController.selectedUserData.middle_name" type="string" ng-disabled="false">
                        </div>
                        <div class="input string">
                            <label><?= __('Third Name') ?></label>
                            <input ng-model="InstitutionStudentController.selectedUserData.third_name" type="string" ng-disabled="false">
                        </div>
                        <div class="input string required">
                            <label><?= __('Last Name') ?></label>
                            <input ng-model="InstitutionStudentController.selectedUserData.last_name" type="string" ng-disabled="true">
                        </div>
                        <div class="input string">
                            <label><?= __('Preferred Name') ?></label>
                            <input ng-model="InstitutionStudentController.selectedUserData.preferred_name" type="string" ng-disabled="true">
                        </div>
                        <div class="input select required">
                            <label><?= __('Gender') ?></label>
                            <input ng-model="InstitutionStudentController.selectedUserData.gender.name" ng-disabled="true">
                        </div>
                        <div class="input date required">
                            <label for="Student_date_of_birth"><?= __('Date Of Birth') ?></label>
                            <div class="input-group date" id="Student_date_of_birth">
                                <input type="text" class="form-control" name="Student[date_of_birth]" ng-model="InstitutionStudentController.selectedUserData.date_of_birth" ng-disabled="true">
                            </div>
                        </div>
                        <div class="row section-header header-space-lg"><?= __('Location') ?></div>
                        <div class="input string">
                            <label><?= __('Address') ?></label>
                            <textarea ng-model="InstitutionStudentController.selectedUserData.address" type="string"></textarea>
                        </div>
                        <div class="input string">
                            <label><?= __('Postal Code') ?></label>
                            <input ng-model="InstitutionStudentController.selectedUserData.postalCode" type="string">
                        </div>
                        ...
                        <div class="input string" id="addressArea_textbox" style="visibility:hidden">
                            ...
                            <input ng-model="InstitutionStudentController.selectedUserData.addressArea.name" type="string" ng-disabled="true">
                        </div>

                        <div class="input select" id="addressArea_dropdown">
                            <label><?= __('Address Area') ?></label>
                            <div class="tree-form" id="address_area_id" ng-controller="SgTreeCtrl as SgTree" ng-init="SgTree.model='Area.AreaAdministratives'; SgTree.outputValue=null; SgTree.userId=2; SgTree.displayCountry=0; SgTree.triggerOnChange=false;">
                        ...
                        <div class="input string" id="birthplaceArea_textbox" style="visibility:hidden">
                            ...
                            <input ng-model="InstitutionStudentController.selectedUserData.birthplaceArea.name" type="string" ng-disabled="true">
                        </div>

                        <div class="input select" id="birthplaceArea_dropdown">
                            <label><?= __('Birthplace Area') ?></label>
                            <div class="tree-form" id="birthplace_area" ng-controller="SgTreeCtrl as SgTree" ng-init="SgTree.model='Area.AreaAdministratives'; SgTree.outputValue=null; SgTree.userId=2; SgTree.displayCountry=0; SgTree.triggerOnChange=false;">
                        ...
                        <div id="additional_information">
                            ...
                            <div ng-show="!InstitutionStudentController.nationalitySkipped">
                                <div class="input string" ng-show="InstitutionStudentController.canSkipNationality">
                                    <label><?= __('Nationality') ?></label>
                                    <input ng-model="InstitutionStudentController.selectedUserData.nationality_name" type="string" ng-disabled="true">
                                </div>
                                <div ng-class="nationality_class" class="input select" ng-show="!InstitutionStudentController.canSkipNationality">
                                    <!-- Nationality Type if Student is not Found -->
                                    <div class="{{InstitutionStudentController.nationalityClass}} {{InstitutionStudentController.nationalitiesRequired}}">
                                        <label><?= __('Nationality') ?></label>
                                        <div class="input-select-wrapper">
                                            <select name="Staff[nationality_id]" id="staff-nationality_id"
                                                    ng-options="option.id as option.name for option in InstitutionStudentController.nationalitiesOptions"
                            ...
                            <div ng-show="!InstitutionStudentController.identitySkipped">
                                <div class="input string" ng-show="InstitutionStudentController.canSkipIdentity">
                                    <label><?= __('Identity Type') ?></label>
                                    <input ng-model="InstitutionStudentController.selectedUserData.identity_type_name" type="string" ng-disabled="true">
                                </div>
                                <div class="input string" ng-show="InstitutionStudentController.canSkipIdentity">
                                    <label><?= __('Identity Number') ?></label>
                                    <input ng-model="InstitutionStudentController.selectedUserData.identity_number" type="string" ng-disabled="true">
                                </div>

                                <div class="{{InstitutionStudentController.identityTypeClass}} {{InstitutionStudentController.identitiesRequired}}" ng-show="!InstitutionStudentController.canSkipIdentity">
                            ...
                            <div ng-show="!InstitutionStudentController.contactSkipped">
                                <div class="{{InstitutionStudentController.contactTypeClass}} {{InstitutionStudentController.contactsRequired}}">
                                    <label><?= __('Contact Type') ?>{{InstitutionStudentController.selectedUserData.contact_type_id}}</label>
                                    <div class="input-select-wrapper">
                                        <select name="Student[contact_type_id]" id="student-contact_type_id"
                                                ng-options="option.id as option.name for option in InstitutionStudentController.contactTypeOptions"
                                                ng-model="InstitutionStudentController.selectedUserData.contact_type_id"
                                ...
                                <div class="input string {{InstitutionStudentController.contactsRequired}}">
                                    <label><?= __('Contact Value') ?>{{InstitutionStudentController.selectedUserData.contact_value}}</label>
                                    <input ng-model="InstitutionStudentController.selectedUserData.contact_value" type="string">
                ...
                <div class="step-pane sample-pane" ng-show="InstitutionStudentController.step === 'add_student'">
                    <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                        ...
                        <div class="input string">
                            ...
                            <input ng-model="InstitutionStudentController.selectedUserData.name" type="string" ng-disabled="true">
                        </div>
                        <div class="input string">
                            <label><?= __('Identity Number') ?></label>
                            <input ng-model="InstitutionStudentController.selectedUserData.identity_number" type="string" ng-disabled="true">
                        ...
                        <div class="input string required">
                            ...
                            <input ng-model="InstitutionStudentController.selectedUserData.username" ng-focus="InstitutionStudentController.error.username = ''" ng-disabled="InstitutionStudentController.disableFields.username">
                            <div ng-if="InstitutionStudentController.error.username" class="error-message">
                                <p>{{ InstitutionStudentController.error.username }}</p>
                            </div>
                        </div>
                        <div class="input string required" ng-show="!InstitutionStudentController.disableFields.password">
                            <label><?= __('Password') ?></label>
                            <input ng-model="InstitutionStudentController.selectedUserData.password" ng-focus="InstitutionStudentController.error.password = ''" ng-disabled="InstitutionStudentController.disableFields.password">
                        ...
                        <div class="input select required error">
                            ...
                            <div class="input-select-wrapper">
                                <select name="Student[academic_period_id]" id="student-academic_period_id"
                                        ...
                                        ng-model="InstitutionStudentController.selectedUserData.academic_period_id"
                        ...
                        <div class="input select required error">
                            ...
                            <div class="input-select-wrapper">
                                <select name="Student[education_grade_id]" id="student-education_grade_id"
                                        ...
                                        ng-model="InstitutionStudentController.selectedUserData.education_grade_id"
                                        ng-change="InstitutionStudentController.changeEducationGrade()">
                                    <option value="" >-- <?= __('Select') ?> --</option>
                                </select>
                            </div>
                        ...
                        <div class="input select">
                            ...
                            <div class="input-select-wrapper">
                                <select name="Student[class_id]" id="student-class_id"
                                        ...
                                        ng-model="InstitutionStudentController.selectedUserData.class_id"
                        ...
                        <div class="input date required">
                            ...
                            <div class="input-group date" id="Student_start_date">
                                <input type="text" class="form-control" name="Student[start_date]" ng-model="InstitutionStudentController.selectedUserData.startDate">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                            </div>
                        ...
                        <div class="input date required">
                            ...
                            <div class="input-group date" id="Students_end_date">
                                <input type="text" class="form-control" name="Student[endDate]" ng-model="InstitutionStudentController.selectedUserData.endDate" ng-disabled="true">
                            </div>
                        </div>
                        <div ng-repeat="customField in InstitutionStudentController.customFieldsArray">
                            ...
                            <div ng-repeat="field in customField.data">
                                <div class="input string" ng-class="{'required': field.is_mandatory !== 0}" ng-if="field.field_type === 'TEXT' || field.field_type === 'TEXTAREA' || field.field_type === 'NOTE' || field.field_type === 'NUMBER' || field.field_type === 'DECIMAL'">
                                    ...
                                    <input ng-if="field.field_type === 'DECIMAL'" ng-model="field.answer" type="number" step="0.01" onKeyPress="if(this.value.length === 10) return false;" ng-change="InstitutionStudentController.onDecimalNumberChange(field)" ng-required="field.is_mandatory !== 0">
                                ...
                                <div class="input select" ng-class="{'required': field.is_mandatory !== 0}" ng-if="field.field_type === 'DROPDOWN'">
                                    ...
                                    <div class="input-select-wrapper">
                                        <select name="Student[option_id]" id={{field.student_custom_field_id}}
                                                ...
                                                ng-change="InstitutionStudentController.changeOption(field,field.answer)" ng-required="field.is_mandatory !== 0">
                                            <option value="" >-- <?= __('Select') ?> --</option>
                                        </select>
                                    </div>
                                    <div ng-if="field.errorMessage" class="error-message">
                                ...
                                <div class="input date" ng-class="{'required': field.is_mandatory !== 0}" ng-if="field.field_type === 'CHECKBOX'">
                                    ...
                                    <div class="input-group check_box">
                                        <div ng-repeat="option in field.option">
                                            <input type="checkbox" id={{option.option_id}} name={{option.option_name}} value={{option.option_id}} ng-model="option.selected" ng-change="InstitutionStudentController.selectOption(field)" ng-required="field.is_mandatory !== 0">
                ...
                <div class="step-pane sample-pane" ng-show="InstitutionStudentController.isDiffSchool > 0 && InstitutionStudentController.step === 'transfer_student'">
                    <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                        <div class="input string">
                            <label><?= __('OpenEMIS ID') ?></label>
                            <input ng-model="InstitutionStudentController.selectedUserData.openemis_no" type="string" ng-disabled="true">
                        ...
                        <div class="input string">
                            ...
                            <input ng-model="InstitutionStudentController.selectedUserData.currentlyAllocatedTo" type="string" ng-disabled="true">
                        </div>
                        <div class="input select required error">
                            <label><?= __('Academic Period') ?></label>
                            <input ng-model="InstitutionStudentController.currentYear" type="string" ng-disabled="true">
                        </div>
                        <div class="input select required error">
                            <label><?= __('Education Grade') ?></label>
                            <div class="input-select-wrapper">
                        ...
                        <div class="input date required">
                            ...
                            <div class="input-group date" id="Student_transfer_start_date">
                                <input type="text" class="form-control" name="Student[transfer_start_date]" ng-model="InstitutionStudentController.selectedUserData.transferStartDate">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                            </div>
                        ...
                        <div class="input select required error">
                            ...
                            <div class="input-select-wrapper">
                                <select name="Student[transfer_reason_id]" id="student-transfer_reason_id"
                                        ...
                                        ng-model="InstitutionStudentController.selectedUserData.transfer_reason_id"
                        ...
                        <div class="input string">
                            ...
                            <textarea type="text" class="form-control" name="Student[transfer_comment]" ng-model="InstitutionStudentController.selectedUserData.transferComment"></textarea>
                        </div>
                    </form>
                </div>
                                ...
                                <div class="panel">
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-input">{{InstitutionStudentController.selectedUserData.openemis_no}}</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-6 col-md-3 form-label"><?= __('First Name') ?></div>
                                            <div class="form-input">{{InstitutionStudentController.selectedUserData.first_name}}</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-6 col-md-3 form-label"><?= __('Middle Name') ?></div>
                                            <div class="form-input">{{InstitutionStudentController.selectedUserData.middle_name}}</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-6 col-md-3 form-label"><?= __('Third Name') ?></div>
                                            <div class="form-input">{{InstitutionStudentController.selectedUserData.third_name}}</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-6 col-md-3 form-label"><?= __('Last Name') ?></div>
                                            <div class="form-input">{{InstitutionStudentController.selectedUserData.last_name}}</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-6 col-md-3 form-label"><?= __('Preferred Name') ?></div>
                                            <div class="form-input">{{InstitutionStudentController.selectedUserData.preferred_name}}</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-6 col-md-3 form-label"><?= __('Gender') ?></div>
                                            <div class="form-input">{{InstitutionStudentController.selectedUserData.gender.name}}</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-6 col-md-3 form-label"><?= __('Date of Birth') ?></div>
                                            <div class="form-input">{{InstitutionStudentController.selectedUserData.date_of_birth}}</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-6 col-md-3 form-label"><?= __('Email') ?></div>
                                            <div class="form-input">{{InstitutionStudentController.selectedUserData.email}}</div>
                                        </div>
                                        <div class="row section-header"><?= __('Identities / Nationalities') ?></div>
                                        <div class="row">
                                            <div class="col-xs-6 col-md-3 form-label"><?= __('Details') ?></div>
                                            <div class="form-input" ng-if="InstitutionStudentController.selectedUserData.identity_type_name || InstitutionStudentController.selectedUserData.identity_number || InstitutionStudentController.selectedUserData.nationality_name">
                                                    ...
                                                    <div class="table-wrapper">
                                                        <div class="table-in-view">
                                                            <table class="table" style="margin-bottom: 0px !important;">
                                                                ...
                                                                <tbody>
                                                                <tr>
                                                                    <td class="vertical-align-top">{{InstitutionStudentController.selectedUserData.identity_type_name}}</td>
                                                                    <td class="vertical-align-top">{{InstitutionStudentController.selectedUserData.identity_number}}</td>
                                                                    <td class="vertical-align-top">{{InstitutionStudentController.selectedUserData.nationality_name}}</td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-input">{{InstitutionStudentController.selectedUserData.address}}</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-6 col-md-3 form-label"><?= __('Postal Code') ?></div>
                                            <div class="form-input">{{InstitutionStudentController.selectedUserData.postalCode}}</div>
                                        </div>
                                        <div class="row section-header"><?= __('Address Area') ?></div>
                                        <div class="row">
                                            <div class="col-xs-6 col-md-3 form-label"><?= __('Address Area') ?></div>
                                            <div class="form-input">{{InstitutionStudentController.selectedUserData.addressArea.name}}</div>
                                        </div>
                                        <div class="row section-header"><?= __('Birthplace Area') ?></div>
                                        <div class="row">
                                            <div class="col-xs-6 col-md-3 form-label"><?= __('Birthplace Area') ?></div>
                                            <div class="form-input">{{InstitutionStudentController.selectedUserData.birthplaceArea.name}}</div>
                                        </div>
    ...
    <script>
        $(function () {
            ...
            var datepicker1 = $('#Student_date_of_birth').datepicker({"format":"dd-mm-yyyy","todayBtn":"linked","orientation":"auto","autoclose":true, language: '<?= $dateLanguage ?>'});
