...
?>
            ...
            <div class="step-content">
                ...
                <div class="step-pane sample-pane" ng-show="step === 'add_student'">
                    <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                        ...
                        <div class="input string">
                            ...
                            <input ng-model="selectedUserData.openemis_no" id="student-add-openemis_no" type="string" ng-disabled="true">
                        </div>
                        <div class="input string">
                            <label><?= __('Student') ?></label>
                            <input ng-model="selectedUserData.name" id="student-add-name" type="string" ng-disabled="true">
                        </div>
                        <div class="input string">
                            <label><?= __('Identity Number') ?></label>
                            <input ng-model="selectedUserData.identity_number" id="student-add-identity_number" type="string" ng-disabled="true">
                        </div>
                        <div class="input date">
                            <label for="Student_date_of_birth"><?= __('Date Of Birth') ?></label>
                            <div class="input-group date" id="Student_date_of_birth">
                                <input type="text" class="form-control" name="Student[date_of_birth]" id="student-add-date_of_birth" ng-model="selectedUserData.date_of_birth" ng-disabled="true">
                            </div>
                        ...
                        <div class="input select">
                            ...
                            <input ng-model="selectedUserData.gender.name" id="student-add-gender_name" ng-disabled="true">
                        </div>
                        <?= $this->element('Directory.confirmation_username_password') ?>
                        <!-- POCOR-8434 starts -->
                        <div class="input string">
                            <label><?= __('Student Admission Status') ?></label>
                            <input ng-model="studentAdmissionStatus" id="student-add-admission_status" type="string" ng-disabled="true">
                        </div>
                        <!-- POCOR-8434 ends -->
                        ...
                        <div class="input date required">
                            ...
                            <div class="input-group date" id="Student_start_date">
                                <input type="text" class="form-control"
                                       ...
                                       id="student-start_date"
                                       ng-model="selectedUserData.startDate"
                                       ng-change="changeStartDate()"
                                ><!-- POCOR-9385: stable id for automation/testing -->
                        ...
                        <div class="input date required">
                            ...
                            <div class="input-group date" id="Students_end_date">
                                <input type="text" class="form-control" name="Student[endDate]"
                                       id="student-add-end_date"
                                       ng-model="selectedUserData.endDate" ng-disabled="true">
                            </div>
                        </div>
                        <div ng-repeat="customField in customFieldsArray">
                            ...
                            <div ng-repeat="field in customField.data">
                                <div class="input string" ng-class="{'required': field.is_mandatory !== 0}" ng-if="field.field_type === 'TEXT' || field.field_type === 'TEXTAREA' || field.field_type === 'NOTE' || field.field_type === 'NUMBER' || field.field_type === 'DECIMAL'">
                                    ...
                                    <input ng-if="field.field_type === 'TEXT'" ng-attr-id="{{field.student_custom_field_id}}" ng-model="field.answer" type="text" ng-required="field.is_mandatory !== 0">
                                    <textarea ng-if="field.field_type === 'TEXTAREA' || field.field_type === 'NOTE'" ng-attr-id="{{field.student_custom_field_id}}" ng-model="field.answer" type="text" ng-required="field.is_mandatory !== 0"></textarea>
                                    <input ng-if="field.field_type === 'NUMBER'" ng-attr-id="{{field.student_custom_field_id}}" ng-model="field.answer" type="number" ng-required="field.is_mandatory !== 0">
                                    <input ng-if="field.field_type === 'DECIMAL'" ng-attr-id="{{field.student_custom_field_id}}" ng-model="field.answer" type="number" step="0.01" onKeyPress="if(this.value.length === 10) return false;"
                                ...
                                <div class="input date" ng-class="{'required': field.is_mandatory !== 0}" ng-if="field.field_type === 'DATE'">
                                    ...
                                    <div class="input-group date">
                                        <input type="text"
                                               class="form-control js-add-student-custom-date"
                ...
                <div class="step-pane sample-pane" ng-show="isDiffSchool > 0 && step === 'transfer_student'">
                    <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                        <div class="input string">
                            <label><?= $dynamicOpenemisNoHeader ?></label>
                            <input ng-model="selectedUserData.openemis_no" id="student-transfer-openemis_no" type="string" ng-disabled="true">
                        </div>
                        <div class="input string">
                            <label><?= __('Student') ?></label>
                            <input ng-model="selectedUserData.name" id="student-transfer-name" type="string" ng-disabled="true">
                        </div>
                        <div class="input string">
                            <label><?= __('Currently Allocated To') ?></label>
                            <input ng-model="selectedUserData.currentlyAllocatedTo" id="student-transfer-currently_allocated" type="string" ng-disabled="true">
                        </div>
                        <div class="input select required error">
                            <label><?= __('Academic Period') ?></label>
                            <input ng-model="currentYear" id="student-transfer-academic_period" type="string" ng-disabled="true">
                        </div>
                        <div class="input select required error">
                            <label><?= __('Education Grade') ?></label>
                            <div class="input-select-wrapper">
                        ...
                        <div class="input string">
                            ...
                            <input ng-model="studentStatus" id="student-transfer-status" type="string" ng-disabled="true">
                        </div>
                        <div class="input date required">
                            ...
                            <div class="input-group date" id="Student_transfer_start_date">
                                <input type="text" class="form-control" name="Student[transfer_start_date]"
                                       id="student-transfer_start_date"
                        ...
                        <div class="input date required">
                            <label for="Students_end_date"><?= __('End Date') ?></label>
                            <div class="input-group date" id="Students_end_date">
                                <input type="text" class="form-control" name="Student[endDate]" id="student-transfer-end_date" ng-model="selectedUserData.endDate" ng-disabled="true">
                            </div>
                        </div>
                        <div class="input select required error">
                        ...
                        <div class="input string">
                            ...
                            <textarea type="text" class="form-control" name="Student[transfer_comment]" id="student-transfer_comment" ng-model="selectedUserData.transferComment"></textarea>
                        </div>
                    </form>
                </div>
    ...
    <script>
        $(function () {
            var datepicker0 = $('#Student_start_date')
                .datepicker({"format":'<?= $datepickerFormat ?>',"todayBtn":"linked","orientation":"auto","autoclose":true, language: '<?= $dateLanguage ?>'});
            var datepicker1 = $('#student-date_of_birth')
                .datepicker({"format":'<?= $datepickerFormat ?>',"todayBtn":"linked","orientation":"auto","autoclose":true, language: '<?= $dateLanguage ?>'});// POCOR-8434 change datepicker id #User_date_of_birth to #student-date_of_birth
            ...
            var datepicker2 = $('#Student_transfer_start_date')
                .datepicker({"format":'<?= $datepickerFormat ?>',"todayBtn":"linked","orientation":"auto","autoclose":true, language: '<?= $dateLanguage ?>'});
        ...
        $(document).on('focus', '.js-add-student-custom-date', function () {
            initCustomDatepicker($(this));
        });
        $(document).on('click', '.js-add-student-custom-date + .input-group-addon', function () {
            var $input = $(this).siblings('.js-add-student-custom-date');
            initCustomDatepicker($input).datepicker('show');
        });
    </script>
