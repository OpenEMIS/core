...
<script>
    ...
    <?php if ($_edit) : ?>
        ...
        <!-- POCOR-6800: added ng-show="action == 'view' && checkaction == 1" || initial value ng-show="action == 'view'" -->
         <button class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="bottom" data-container="body" title="<?= __('Edit');?>" ng-show="action == 'view' && (checkEditAction == 1 || checkPrincipalEditAction == 1 || checkHomeroomTeacherEditAction == 1 || checkMyTeacherEditAction == 1|| isHomeRoomClass == 1)" ng-click="InstitutionCommentsController.onEditClick()">
