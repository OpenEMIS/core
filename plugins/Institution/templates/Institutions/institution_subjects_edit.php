...
<form accept-charset="utf-8" id="content-main-form" class="form-horizontal ng-pristine ng-valid" novalidate="novalidate"
      ng-controller="InstitutionSubjectStudentsCtrl as InstitutionSubjectStudentsController">
    <div class="alert {{InstitutionSubjectStudentsController.class}}"
         ng-hide="InstitutionSubjectStudentsController.message == null">
        <a class="close" aria-hidden="true" href="#"
           data-dismiss="alert">×</a>{{InstitutionSubjectStudentsController.message}}
    </div>
    ...
    <div class="input select">
        ...
        <select chosen
                ng-disabled="InstitutionSubjectStudentsController.disableRooms"
                multiple="multiple"
    ...
    <div class="input select">
        ...
        <div class="input-form-wrapper"
             ng-init="InstitutionSubjectStudentsController.institutionSubjectId=<?= $institutionSubjectId ?>; InstitutionSubjectStudentsController.redirectUrl='<?= $this->Url->build($viewUrl) ?>'; InstitutionSubjectStudentsController.alertUrl='<?= $this->Url->build($alertUrl) ?>';">
            <kd-multi-select ng-if="InstitutionSubjectStudentsController.dataReady"
                             ng-disabled="InstitutionSubjectStudentsController.disableStudents"
                             grid-options-top="InstitutionSubjectStudentsController.gridOptionsTop"
                             grid-options-bottom="InstitutionSubjectStudentsController.gridOptionsBottom"></kd-multi-select>
        </div>

        <div class="form-buttons">
            <div class="button-label"></div>
            <button class="btn btn-default btn-save" type="button"
                    ng-disabled="InstitutionSubjectStudentsController.disableSave"
                    ng-click="InstitutionSubjectStudentsController.postForm();">
