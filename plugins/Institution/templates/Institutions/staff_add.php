...
<script>
$(function () {
var datepicker0 = $('#Staff_start_date')
    .datepicker({"format":'<?= $datepickerFormat ?>',"todayBtn":"linked","orientation":"auto","autoclose":true, language: '<?php echo $dateLanguage; ?>'});
var datepicker1 = $('#Staff_end_date')
    .datepicker({"format":'<?= $datepickerFormat ?>',"todayBtn":"linked","orientation":"auto","autoclose":true, language: '<?php echo $dateLanguage; ?>'});
