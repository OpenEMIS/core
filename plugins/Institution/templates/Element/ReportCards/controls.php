<?php
//POCOR-8898: always render all three filters; placeholder shown when no archived data available
?>
<div class="toolbar-responsive panel-toolbar">
    <div class="toolbar-wrapper">
        ...
        <?php if (!empty($academicPeriodOptions)) { ?>
            <?php echo $this->Form->input('academic_period_id', [
                'type' => 'select',
                'class' => 'form-control',
                'label' => false,
        ...
        <?php if (!empty($reportCardOptions)) { ?>
            <?php echo $this->Form->input('report_card_id', [
                'type' => 'select',
                'class' => 'form-control',
                'label' => false,
        ...
        <?php if (!empty($classOptions)) { ?>
            <?php echo $this->Form->input('_class_id', [
                'type' => 'select',
                'class' => 'form-control',
                'label' => false,
