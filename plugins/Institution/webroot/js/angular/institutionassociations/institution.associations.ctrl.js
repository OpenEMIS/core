...
function InstitutionAssociationsController($scope, $q, $window, $http, UtilsSvc, AlertSvc, AggridLocaleSvc, InstitutionAssociationsSvc) {
    ...
    angular.element(document).ready(function() {
        ...
        if (Controller.classId != null) {
            InstitutionAssociationsSvc.getClassDetails(Controller.classId)
                .then(function(response) {
                    ...
                    promises[1] = InstitutionAssociationsSvc.getInstitutionShifts(response.institution_id, response.academic_period_id);
    ...
    function postForm() {
        ...
        if (postData.capacity > Controller.maxStudentsPerClass) {
            ...
            InstitutionAssociationsSvc.saveClass(postData)
                .then(function(response) {
