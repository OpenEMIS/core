angular
    .module('institution.staff.attendances.archive.svc', ['kd.data.svc', 'alert.svc'])
    .service('InstitutionStaffAttendancesArchiveSvc', InstitutionStaffAttendancesArchiveSvc);

InstitutionStaffAttendancesArchiveSvc.$inject = ['$http', '$q', '$filter', 'KdDataSvc', 'AlertSvc', 'UtilsSvc'];

function InstitutionStaffAttendancesArchiveSvc($http, $q, $filter, KdDataSvc, AlertSvc, UtilsSvc) {
   var models = {
    ...
    function getAcademicPeriodOptions(institutionId) {
        ...
        return AcademicPeriods
            .find('SchoolAcademicPeriodArchive')
