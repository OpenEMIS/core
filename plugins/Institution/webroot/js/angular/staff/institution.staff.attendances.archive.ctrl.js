angular.module('institution.staff.attendances.archive.ctrl', ['utils.svc', 'alert.svc', 'aggrid.locale.svc', 'institution.staff.attendances.archive.svc'])
    .controller('InstitutionStaffAttendancesArchiveCtrl', InstitutionStaffAttendancesArchiveController);

InstitutionStaffAttendancesArchiveController.$inject = ['$scope', '$q', '$window', '$http', 'UtilsSvc', 'AlertSvc', 'AggridLocaleSvc', 'InstitutionStaffAttendancesArchiveSvc'];

function InstitutionStaffAttendancesArchiveController($scope, $q, $window, $http, UtilsSvc, AlertSvc, AggridLocaleSvc, InstitutionStaffAttendancesSvc) {
    var vm = this;
