angular
    .module('institutions.results.archived.svc', ['kd.data.svc', 'kd.session.svc', 'kd.access.svc', 'alert.svc'])
    .service('InstitutionsResultsArchivedSvc', InstitutionsResultsArchivedSvc);

InstitutionsResultsArchivedSvc.$inject = ['$http', '$q', '$filter', 'KdDataSvc', 'KdSessionSvc', 'KdAccessSvc', 'AlertSvc'];

function InstitutionsResultsArchivedSvc($http, $q, $filter, KdDataSvc, KdSessionSvc, KdAccessSvc, AlertSvc) {
    ...
    var models = {
        ...
        AssessmentItemResultsArchived: 'Institution.AssessmentItemResultsArchived',
                    ...
                    if (angular.isObject(subjectStudents) && subjectStudents.length > 0) {
                        ...
                        angular.forEach(oneStudents, function (subjectStudent, key) {
                            ...
                            if (studentId != currentStudentId) {
                                ...
                                studentResults = {
                                    openemis_id: subjectStudent._matchingData.Users.openemis_no,
                                    name: subjectStudent._matchingData.Users.first_name + subjectStudent._matchingData.Users.last_name,
