...
function InstitutionsResultsController($q, $scope, $filter, UtilsSvc, AlertSvc, AggridLocaleSvc, InstitutionsAssessmentArchiveSvc) {
    ...
    $scope.onChangeSubject = function(subject = undefined, editable) {
        ...
        .then(function(response) {
            if (response) {
                //return InstitutionsAssessmentArchiveSvc.getRowData($scope.gradingTypes, $scope.periods, $scope.institution_id, $scope.class_id, $scope.assessment_id, $scope.academic_period_id, $scope.subject.education_subject_id, $scope.education_grade_id);
