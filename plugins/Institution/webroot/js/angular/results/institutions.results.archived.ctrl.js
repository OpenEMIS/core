angular
    .module('institutions.results.archived.ctrl', ['utils.svc', 'alert.svc', 'aggrid.locale.svc', 'institutions.results.archived.svc'])
    .controller('InstitutionsResultsArchivedCtrl', InstitutionsResultsArchivedController);

InstitutionsResultsArchivedController.$inject = ['$q', '$scope', '$filter', 'UtilsSvc', 'AlertSvc', 'AggridLocaleSvc', 'InstitutionsResultsArchivedSvc'];

function InstitutionsResultsArchivedController($q,
                                       $scope,
                                       $filter,
                                       UtilsSvc,
                                       AlertSvc,
                                       AggridLocaleSvc,
                                       InstitutionsResultsArchivedSvc) {
    ...
    angular.element(document).ready(function () {
        // init
        InstitutionsResultsArchivedSvc.init(angular.baseUrl);
        appendLoader();
        // getAssessment
        InstitutionsResultsArchivedSvc.getAssessment($scope.assessment_id)
            .then(
        ...
        function getAssessmentTerms() {
            ...
            // console.log(JSON.stringify(result));
            var promise;
            promise = InstitutionsResultsArchivedSvc.getAssessmentTerms($scope.assessment_id);
        ...
        function handleSuccessGetAssessmentTerms(result) {
            ...
            //promises[0] = InstitutionsResultsArchivedSvc.getSubjects($scope.roles, $scope.assessment_id, $scope.class_id);
            promise = InstitutionsResultsArchivedSvc.getAcademicPeriod();
        ...
        function handleSuccessGetAcademicPeriod(result) {
            ...
            promise = InstitutionsResultsArchivedSvc.getDataSubjects($scope.roles,
                $scope.assessment_id,
                $scope.class_id,
        ...
        function handleSuccessGetDataSubjects(result) {
            ...
            promise = InstitutionsResultsArchivedSvc.getStudentStatusId("CURRENT");
            return promise.then(function (result) {
                return result;
            });
        }
    ...
    $scope.initGrid = function (subject) {
        ...
        function onAggridCellValueChanged(params) {
            ...
            params.data.total_mark = InstitutionsResultsArchivedSvc.calculateTotal(params.data);
            ...
            InstitutionsResultsArchivedSvc.saveSingleRecordData(params, extra)
    ...
    $scope.resetColumnDefs = function (action, subject, periods, gradingTypes) {
        var response = InstitutionsResultsArchivedSvc.getColumnDefs(action, subject, periods, gradingTypes, $scope.results, $scope.enrolledStatus);
        ...
        if (angular.isDefined(response.error)) {
            ...
            if ($scope.gridOptions != null) {
                ...
                InstitutionsResultsArchivedSvc.translate(textToTranslate)
                    .then(function (res) {
    ...
    $scope.onChangeSubject = function (subject = undefined, editable = undefined) {
        ...
        appendLoader();
        // getPeriods
        InstitutionsResultsArchivedSvc.getPermissions()
        ...
        function handleResetColumnDefs(result) {
            ...
            // console.log(JSON.stringify(result));
            var promise;
//                return InstitutionsResultsArchivedSvc.getRowData($scope.gradingTypes, $scope.periods, $scope.institution_id, $scope.class_id, $scope.assessment_id, $scope.academic_period_id, $scope.subject.education_subject_id, $scope.education_grade_id);
            var options = {
                ...
                assessment_id: $scope.assessment_id,
                academic_period_id: $scope.academic_period_id,
                // institution_subjects.id (not education_subject_id) — matches InstitutionSubjectStudents.institution_subject_id
                institution_subject_id: $scope.subject ? $scope.subject.id : $scope.education_subject_id,
                education_grade_id: $scope.education_grade_id
            };
            promise = InstitutionsResultsArchivedSvc.getNewRowData(
                options);
            return promise.then(function (result) {
                // console.log(result);
                return result;
        ...
        function handleGetPermissions(result) {
            ...
            promise = InstitutionsResultsArchivedSvc.getSubjectEditPermission(options);
            return promise.then(function (result) {
                return result;
            });
        }
        ...
        function handleGetSubjectEditPermissionSetPeriods(result) {
            ...
            promise = InstitutionsResultsArchivedSvc.getPeriods(
                $scope.assessment_id,
        ...
        function handleGetPeriodsSetCopyGradingTypes(result) {
            ...
            promise = InstitutionsResultsArchivedSvc.getCopyGradingTypes($scope.assessment_id,
    ...
    $scope.onEditClick = function () {
        ...
        InstitutionsResultsArchivedSvc.getSubjectEditPermission(options)
