                    ...
                    switch ($selectedRule) {
                        case 'number':
                            if (isset($data['table_number_validation']) && !empty($data['table_number_validation'])) {
                                ...
                                switch ($selectedNumberValidation) {
                                    case 'min_value':
                                        $minValue = isset($data['table_minimum_value']) ? $data['table_minimum_value']: null;
                                    ...
                                    case 'max_value':
                                        $maxValue = isset($data['table_maximum_value']) ? $data['table_maximum_value']: null;
                                    ...
                                    case 'range':
                                        $lowerLimit = isset($data['table_lower_limit']) ? $data['table_lower_limit']: null;
                                        $upperLimit = isset($data['table_upper_limit']) ? $data['table_upper_limit']: null;
                        ...
                        case 'decimal':
                            $length = isset($data['table_decimal_length']) ? $data['table_decimal_length'] : null;
                            $precision = isset($data['table_decimal_precision']) ? $data['table_decimal_precision'] : null;
