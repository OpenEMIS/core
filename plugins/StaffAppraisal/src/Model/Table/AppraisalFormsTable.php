...
class AppraisalFormsTable extends ControllerActionTable
{
    ...
    //--------------------------------------------------------------------------------------
    /*
        I think here, I'll try to make it the actual way of saving data. Right now, I think is not efficiency. 
    */
    ...
    // // When delete the whole form
    public function onBeforeDelete(Event $event, Entity $entity, ArrayObject $extra)
    {
        // $appraisalScore = $this->AppraisalCriterias->AppraisalScores;
        // $appraisalScore->dispatchEvent('Model.Appraisal.beforeDelete', [$entity], $appraisalScore);
    ...
    {
        // pr($entity);die;
        // try deleteafteraction method do and dispatch
    ...
    //                     // There do not exists a record in the appraisal_forms_criterias_scores table
    //                     if($appraisalFormsCriteriasScoresEntity->count() == 0) {
    //                         $data = [
    //                             'appraisal_form_id' => $formId,
    //                             'appraisal_criteria_id' => $criteriaId,
    //                             'final_score' => 0,
    //                             'created_user_id' => $_SESSION['Auth']['User']['id'],
    //                             'created' => date("Y-m-d H:i:s")
    //                         ];
    //                         $newEntity = $appraisalFormsCriteriasScores->newEntity($data);
    //                         $appraisalFormsCriteriasScores->save($newEntity);
    //                     }
    //                     break;
    //             }
    //         }
