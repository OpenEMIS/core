...
//        $this->hasMany('InstitutionStaff', ['className' => 'institution_staff', 'foreignKey' => 'staff_id', 'dependent' => true]);
        ...
        // 500 erro when opn $this->hasMany('InstitutionStaffAttendanceActivities', ['className' => 'User.InstitutionStaffAttendanceActivities', 'foreignKey' => 'security_user_id', 'dependent' => true]);
...
//        $this->hasMany('InstitutionStudents', ['className' => 'institution_students', 'foreignKey' => 'student_id', 'dependent' => true]);
        // Not found $this->hasMany('InstitutionStudentsReportCardsCommentsStaff', ['className' => 'institution_students_report_cards_comments', 'foreignKey' => 'staff_id', 'dependent' => true]);
        //Not found $this->hasMany('InstitutionStudentsReportCardsCommentsStudent', ['className' => 'institution_students_report_cards_comments', 'foreignKey' => 'student_id', 'dependent' => true]);
