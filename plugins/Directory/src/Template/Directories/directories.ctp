            ...
            <div class="step-pane sample-pane" ng-if="step === 'user_details'">
                <form class="form-horizontal ng-pristine ng-valid" accept-charset="utf-8" method="post">
                    ...
                    <div class="input string required">
                        ...
                        <input ng-model="selectedUserData.first_name" ng-change="setStaffName()" type="string">
                    ...
                    <div class="input string required">
                        ...
                        <input ng-model="selectedUserData.last_name" ng-change="setStaffName()" type="string">
