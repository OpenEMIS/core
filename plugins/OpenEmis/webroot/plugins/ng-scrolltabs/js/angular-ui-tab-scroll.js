        ...
        return {
          ...
          template: [
            '<div class="ui-tabs-scrollable" ng-class="{\'show-drop-down\': !hideDropDown}">',
              ...
              ' tooltip-placement="{{tooltipLeftDirection}}" tooltip-append-to-body="true" uib-tooltip-html="tooltipLeftHtml"></button>',
              ...
              ' tooltip-placement="{{tooltipRightDirection}}" tooltip-append-to-body="true" uib-tooltip-html="tooltipRightHtml"></button>',
              '<div class="btn-group" uib-dropdown is-open="status.isopen" ng-hide="hideDropDown">',
          ...
          link: function($scope, $el) {
            ...
            $scope.reCalcSides = function() {
              ...
              if((FF) && bodyDir == 'rtl'){
                $scope.disableLeft = $scope.tabContainer.scrollWidth <= $scope.tabContainer.offsetWidth - $scope.tabContainer.scrollLeft;
                $scope.disableRight = $scope.tabContainer.scrollLeft >= 0;
              }

              var IE = /*@cc_on!@*/false || !!document.documentMode; // At least IE6
              
              if((IE) && bodyDir == 'rtl'){
                $scope.disableLeft = $scope.tabContainer.scrollLeft >= $scope.tabContainer.scrollWidth - $scope.tabContainer.offsetWidth;
                $scope.disableRight = $scope.tabContainer.scrollLeft <= 0;
              } 
            ...
            $scope.reCalcTooltips = function(){
              ...
              angular.forEach(allTabs, function(tab) {
                ...
                var tabText =  angular.element(tab).isolateScope().heading;
                ...
                if(rightPosition > $scope.tabContainer.offsetWidth && !ignore ) {
                  ...
                  } else if (tabText)rightTooltips.push(tabText);
                }
                ...
                if (leftPosition < 0 && !ignore ) {
                  ...
                  } else if (tabText)leftTooltips.push(tabText);
                }
            ...
            $scope.init = function() {
              ...
              // attaching event to window resize and mousemove.
              angular.element($window).on('resize', $scope.onWindowResize);
              angular.element($window).on('mousemove', $scope.onWindowResize);
            };
                ...
                if(!$scope.hideDropDown) {
                  ...
                  angular.forEach(allTabs, function (tab) {
                    ...
                    if(!ignore){
                      ...
                      tabScope.tabScrollTitle = heading ? heading : tabScope.heading;
