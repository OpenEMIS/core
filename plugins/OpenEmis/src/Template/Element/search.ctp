<div class="search">
	<div class="input-group">
		...
		<span class="input-group-btn">
			...
			<button class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="bottom" title="<?= __('Search') ?>" type="button" onclick="jsForm.submit()"><i class="fa fa-search"></i></button>
