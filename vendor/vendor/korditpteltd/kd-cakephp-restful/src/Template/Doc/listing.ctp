...
<h3 id="top">Getting a list of records</h3>
	<p>To extract a list of records, users have to provide the record model and append it on the url to use for querying.
	...
	<br/>To return the result in <b>xml</b> format, change <b>.json</b> to <b>.xml</b> on the url.</p>
<hr/>
...
<h3>Quick Links</h3>
	<ul>
		...
		<li><a href="#query-with-selected-limit">Query with a limit</a></li>
		<li><a href="#query-with-selected-page">Query with a page number</a></li>
		<li><a href="#query-with-selected-page-limit">Query with a limit and a page number</a></li>
		<li><a href="#query-with-constraints">Query with constraints</a></li>
		<li><a href="#query-with-finders">Query with finders</a></li>
		<li><a href="#query-with-finder-list">Query with the list finder</a></li>
		<li><a href="#query-with-combination">Query with a combination of parameters</a></li>
		<li><a href="#limitations">Limitations</a></li>
	</ul>
<hr/>

<h3 id="basic-query">Basic query</h3>
	<p>For example to extract a set of <b>Institution</b> records and return it as a <b>json</b> string:</p>
	<pre>
		<?= $this->Url->build([
			'plugin'=>'Restful',
			'controller'=>'Restful',
	...
	<p>The return result will be as shown below. By default, users will always receive a result of 10 records are less depending of the number of records available. The records are always sorted by their id in ascending order.</p>
	<pre>
	{
	    "data": [
		    {
...
<h3 id="query-with-selected-fields">Query with selected fields</h3>
	...
	<pre>
	{
	    "data": [
	        ...
	        {
	            "code": "55A70",
	            "name": "Badihagwa Secondary School",
	            "area_administrative_id": 1,
	            "code_name": "55A70 - Badihagwa Secondary School"
	        },
	        {
	            "code": "57B21",
	            "name": "Baibari Primary School",
	            "area_administrative_id": 1,
	            "code_name": "57B21 - Baibari Primary School"
	        },
	        {
	            "code": "58D44",
	            "name": "Cameron High School",
	            "area_administrative_id": 1,
	            "code_name": "58D44 - Cameron High School"
	        },
	        {...},
	        ...
		]
...
<h3 id="query-with-selected-limit">Query with a limit</h3>
	<p>Explanations coming soon...</p>
	<p>Example:</p>
	<pre>
		<?= $this->Url->build([
			'plugin'=>'Restful',
...
<h3 id="query-with-selected-page">Query with a page number</h3>
	<p>Explanations coming soon...</p>
	<p>Example:</p>
	<pre>
		<?= $this->Url->build([
...
<h3 id="query-with-selected-page-limit">Query with a limit and a page number</h3>
	<p>Explanations coming soon...</p>
	<p>Example:</p>
	<pre>
		<?= $this->Url->build([
...
<h3 id="query-with-constraints">Query with constraints</h3>
	<p>Explanations coming soon...</p>
	<p>Example:</p>
	<pre>
		<?= $this->Url->build([
...
<h3 id="query-with-finders">Query with finders</h3>
	<p>Coming soon...</p>
	<a href="#top">Back to top</a>
<hr/>

<h3 id="query-with-finder-list">Query with the list finder</h3>
	<p>Explanations coming soon...</p>
	<p>Example:</p>
	<pre>
		<?= $this->Url->build([
...
<h3 id="query-with-combination">Query with a combination of parameters</h3>
	<p>If you would like to extact only selected fields rather than all of them, you can append <b>_fields=field1,field2</b> as a get parameter or name-value pair string to the url where the values are the field name. Separate multiple fields with a <b>comma</b> or a url encoded representation of a comma.</p>
	<p>For example to extract a single <b>Institution</b> record with only its <b>name, code and area_administrative_id</b>:</p>
	<pre>
		<?= $this->Url->build([
