...
/**
 * Class ArchiveStudentReportCards
 * @package App\Shell
 * POCOR-8898
 * table
 * institution_students_report_cards
 */
class ArchiveStudentReportCardsShell extends Shell
{
    ...
    public function main()
    {
        ...
        $processName = "ArchiveStudentReportCards";
        ...
        $this->featureName = "Student Report Cards";
