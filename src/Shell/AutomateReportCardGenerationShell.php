...
{
    CONST SLEEP_TIME = 10; // Default 30 seconds
    CONST EXPIRY_TIME = 10; // 10 for maldives & others it would be 30 
    CONST DEFAULT_ITERATION_TO_RUN = 125;  //  125 means 1hr for maldives for others 500 , this will run for 4 hours and each fault it finds, it resets back to 4 hours.
    CONST DEBUG = TRUE;
