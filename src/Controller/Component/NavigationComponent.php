		...
		$navigation = [
			...
			'Students' => [
				...
				'items' => [
					...
					'List' => ['url' => ['plugin' => 'Institution', 'controller' => 'Institutions', 'action' => 'Students'], 'selected' => ['TransferRequests', 'StudentUser', 'StudentAccount', 'Promotion', 'StudentAdmission', 'TransferApprovals']],
