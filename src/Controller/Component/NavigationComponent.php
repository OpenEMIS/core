    ...
    public function getInstitutionNavigation()
    {
        ...
        $navigation = [
            ...
            'Institutions.Staff.index' => [
                ...
                'parent' => 'Institutions.Institutions.index',
                'params' => ['plugin' => 'Institution'],
                'selected' => ['Institutions.Staff.add', 'Institutions.StaffUser.add', 'Institutions.StaffUser.pull', 'Institutions.ImportStaff', 'Institutions.Staff', 'Institutions.StaffTransferRequests', 'Institutions.InstitutionStaffOutgoingAssignments', 'Institutions.InstitutionStaffIncomingAssignments']
            ],
