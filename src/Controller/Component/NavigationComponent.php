    ...
    public function getInstitutionNavigation()
    {
        ...
        $navigation = [
            ...
            'Institutions.InfrastructureWashSanitations.index' => [
                ...
                'parent' => 'Wash',
                'params' => ['plugin' => 'Institution'],
                'selected' => ['Institutions.InfrastructureWashSanitations.view', 'Institutions.InfrastructureWashSanitations.add', 'Institutions.InfrastructureWashSanitations.edit', 'Institutions.InfrastructureWashSanitations.delete']
            ],
            ...
            'Institutions.InfrastructureWashWastes.index' => [
                ...
                'parent' => 'Wash',
                'params' => ['plugin' => 'Institution'],
                'selected' => ['Institutions.InfrastructureWashWastes.view', 'Institutions.InfrastructureWashWastes.add', 'Institutions.InfrastructureWashWastes.edit', 'Institutions.InfrastructureWashWastes.delete']
            ],
            ...
            'Institutions.InfrastructureWashSewages.index' => [
                ...
                'parent' => 'Wash',
                'params' => ['plugin' => 'Institution'],
                'selected' => ['Institutions.InfrastructureWashSewages.view', 'Institutions.InfrastructureWashSewages.add', 'Institutions.InfrastructureWashSewages.edit', 'Institutions.InfrastructureWashSewages.delete']
            ],
    ...
    public function getProfileStaffNavigation()
    {
        $navigation = [
            ...
            'Profiles.StaffEmploymentStatuses' => [
                ...
                'params' => ['plugin' => 'Profile'],
                'selected' => ['Profiles.StaffEmploymentStatuses', 'Profiles.StaffPositions', 'Profiles.StaffClasses', 'Profiles.StaffSubjects', 'Profiles.StaffLeave','Profiles.ArchivedStaffLeave', 'Profiles.HistoricalStaffLeave','Profiles.StaffAttendances','Profiles.StaffBehaviours', 'Profiles.StaffAppraisals','Profiles.StaffDuties','Profiles.StaffAssociations','Profiles.StaffCurriculars']
            ],
    ...
    public function getDirectoryStaffNavigation()
    {
        ...
        $navigation = [
            ...
            'Directories.StaffEmploymentStatuses' => [
                ...
                'params' => ['plugin' => 'Directory'],
                'selected' => ['Directories.StaffEmploymentStatuses', 'Directories.StaffPositions', 'Directories.HistoricalStaffPositions', 'Directories.StaffClasses', 'Directories.StaffSubjects', 'Directories.StaffLeave','Directories.ArchivedStaffLeave', 'Directories.HistoricalStaffLeave', 'Directories.StaffAttendances', 'Directories.StaffBehaviours', 'Directories.StaffAppraisals','Directories.StaffDuties','Directories.StaffAssociations']
            ],
