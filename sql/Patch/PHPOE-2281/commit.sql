...
INSERT INTO `security_functions` (`id`, `name`, `controller`, `module`, `category`, `parent_id`, `_view`, `_add`, `_execute`, `order`, `visible`, `created_user_id`, `created`) VALUES (6003, 'Survey', 'Reports', 'Reports', 'Reports', -1, 'Survey.index', 'Survey.add', 'Survey.download', 6003, 1, 1, NOW());
