...
-- BACKING UP
CREATE TABLE z2760_security_role_functions LIKE security_role_functions;
INSERT INTO z2760_security_role_functions SELECT * FROM security_role_functions WHERE security_function_id = 5003;
