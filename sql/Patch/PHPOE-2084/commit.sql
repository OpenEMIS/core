...
values
('StaffAbsences', 'id', 'Record ID', '1', '0', NULL, NULL, NULL),
...
('StaffAbsences', 'institution_site_id', '(Leave blank)', '6', '2', 'Institution', 'Institutions', 'code'),
('StaffAbsences', 'staff_absence_reason_id', '', '7', '1', 'FieldOption', 'StaffAbsenceReasons', 'national_code')
;

INSERT INTO `import_mapping` (`model`, `column_name`, `description`, `order`, `foreign_key`, `lookup_plugin`, `lookup_model`, `lookup_column`) 
values
('StudentAbsences', 'id', 'Record ID', '1', '0', NULL, NULL, NULL),
...
('StudentAbsences', 'institution_site_id', '(Leave blank)', '6', '2', 'Institution', 'Institutions', 'code'),
