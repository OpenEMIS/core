...
INSERT INTO `labels` (`id`, `module`, `field`, `module_name`, `field_name`, `visible`, `created_user_id`, `created`) VALUES (uuid(), 'TransferRequests', 'previous_institution_id', 'Institutions -> Transfer Requests', 'Institution', 1, 1, NOW());
