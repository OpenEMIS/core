...
ALTER TABLE `custom_field_values` ADD `decimal_value` DECIMAL(10,2) NULL DEFAULT NULL AFTER `file`;
...
ALTER TABLE `institution_custom_field_values` ADD `decimal_value` DECIMAL(10,2) NULL DEFAULT NULL AFTER `file`;