...
VALUES (NULL, 'User.Users', 'nationality_id', 'Code', '14', '1', 'FieldOption', 'Nationalities', 'national_code');

INSERT INTO `import_mapping` (`id`, `model`, `column_name`, `description`, `order`, `foreign_key`, `lookup_plugin`, `lookup_model`, `lookup_column`) 
VALUES (NULL, 'User.Users', 'identity_type_id', 'Code', '15', '1', 'FieldOption', 'IdentityTypes', 'national_code');
