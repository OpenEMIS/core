...
-- labels
INSERT INTO `labels` (`id`, `module`, `field`, `module_name`, `field_name`, `visible`, `created_user_id`, `created`) VALUES (uuid(), 'InstitutionExaminationStudents', 'examination_centre_id', 'Institutions -> Examinations -> Students', 'Exam Centre', 1, 1, NOW());
