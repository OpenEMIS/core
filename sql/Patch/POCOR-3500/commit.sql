-- db_patches
INSERT INTO `db_patches` (`issue`, `created`) VALUES('POCOR-3500', NOW());

-- examinations
RENAME TABLE `examinations` TO `z_3500_examinations`;
...
FROM `z_3500_examinations`;

-- examination_centres
RENAME TABLE `examination_centres` TO `z_3500_examination_centres`;
...
FROM `z_3500_examination_centres`;

-- examination_centre_special_needs
RENAME TABLE `examination_centre_special_needs` TO `z_3500_examination_centre_special_needs`;
...
FROM `z_3500_examination_centre_special_needs`;

-- examination_centre_students
RENAME TABLE `examination_centre_students` TO `z_3500_examination_centre_students`;
...
FROM `z_3500_examination_centre_students`;

-- examination_centre_subjects
RENAME TABLE `examination_centre_subjects` TO `z_3500_examination_centre_subjects`;
...
FROM `z_3500_examination_centre_subjects`;
...
CREATE TABLE IF NOT EXISTS `examination_item_results` (
  ...
  `created_user_id` int(11) NOT NULL,
  `created` datetime NOT NULL,
  PRIMARY KEY (`examination_id`,`education_subject_id`,`student_id`,`academic_period_id`),
