...
-- UPDATE `security_functions`
--     SET `name` = 'Overview',
--         `_view` = 'Overview.index|Overview.view',
--         `_edit` = 'Overview.edit',
--         `_add` = NULL,
--         `_delete` = NULL,
--         `_execute` = 'Overview.excel',
--         `description` = 'Overview edit will only take effect when student edit and classes permission is granted.'
--     WHERE `id` = 2000;
