...
UPDATE `labels` set `field`='paid', `en`='Paid' WHERE `module`='StudentFees' AND `field`='amount_paid';
UPDATE `labels` set `field`='outstanding', `en`='Outstanding' WHERE `module`='StudentFees' AND `field`='outstanding_fee';
