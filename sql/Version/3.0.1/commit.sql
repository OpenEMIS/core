...
SELECT 'Active' AS `name`
     ...
     , '2014-06-04 16:54:58' AS `created`
FROM `field_options` AS `fo`
WHERE `fo`.`code`='StaffStatuses';

INSERT INTO `field_option_values` (`name`, `order`, `visible`, `editable`, `default`, `field_option_id`, `created_user_id`, `created`) 
SELECT 'Resigned' AS `name`
     , '1' AS `order`
     , '1' AS `visible`
     , '1' AS `editable`
     , '0' AS `default`
