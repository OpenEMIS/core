...
use App\Models\QualificationSpecialisations;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class QualificationSpecialisationsFactory extends Factory
{
    protected $model = QualificationSpecialisations::class;
