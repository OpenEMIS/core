...
use App\Models\InstitutionContactPersons;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class InstitutionContactPersonsFactory extends Factory
{
    protected $model = InstitutionContactPersons::class;
    ...
    'designation' => $this->faker->lexify(str_repeat("?", 100)),
