...
use App\Models\InfrastructureWashWaterFunctionalities;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class InfrastructureWashWaterFunctionalitiesFactory extends Factory
{
    protected $model = InfrastructureWashWaterFunctionalities::class;
