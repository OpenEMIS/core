...
class InstitutionStudentVisitsFactory extends Factory
{
    ...
    'student_visit_type_id' => \App\Models\StudentVisitTypes::inRandomOrder()->value('id') ?? \App\Models\StudentVisitTypes::factory()->create()->id,
    'student_visit_purpose_type_id' => \App\Models\StudentVisitPurposeTypes::inRandomOrder()->value('id') ?? \App\Models\StudentVisitPurposeTypes::factory()->create()->id,
