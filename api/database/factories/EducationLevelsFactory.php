...
class EducationLevelsFactory extends Factory
{
    ...
    'education_system_id' => \App\Models\EducationSystems::inRandomOrder()->value('id') ?? 1,
    'education_level_isced_id' => \App\Models\EducationLevelIsced::inRandomOrder()->value('id') ?? 1,
