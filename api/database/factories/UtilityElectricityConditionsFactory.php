...
use App\Models\UtilityElectricityConditions;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class UtilityElectricityConditionsFactory extends Factory
{
    protected $model = UtilityElectricityConditions::class;
