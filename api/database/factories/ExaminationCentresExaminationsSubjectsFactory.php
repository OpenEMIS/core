...
class ExaminationCentresExaminationsSubjectsFactory extends Factory
{
    ...
    public function definition(): array
    {
        $attempts = 0;
do {
    $examination_centre_id = $this->faker->randomElement(\App\Models\ExaminationCentresExaminationsSubjects::pluck('examination_centre_id')->toArray()) ?? 1;
            $examination_subject_id = $this->faker->randomElement(\App\Models\ExaminationCentresExaminationsSubjects::pluck('examination_subject_id')->toArray()) ?? 1;
    $exists = ExaminationCentresExaminationsSubjects::where('examination_centre_id', $examination_centre_id)
