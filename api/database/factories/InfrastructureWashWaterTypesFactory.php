...
use App\Models\InfrastructureWashWaterTypes;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class InfrastructureWashWaterTypesFactory extends Factory
{
    protected $model = InfrastructureWashWaterTypes::class;
