...
class InfrastructureWashSanitationsFactory extends Factory
{
    ...
    'infrastructure_wash_sanitation_type_id' => \App\Models\InfrastructureWashSanitationTypes::inRandomOrder()->value('id') ?? 1,
    'infrastructure_wash_sanitation_use_id' => \App\Models\InfrastructureWashSanitationUses::inRandomOrder()->value('id') ?? 1,
