...
use App\Models\SpecialNeedsDiagnosticsTypes;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class SpecialNeedsDiagnosticsTypesFactory extends Factory
{
    protected $model = SpecialNeedsDiagnosticsTypes::class;
