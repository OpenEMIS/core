...
use App\Models\InfrastructureWashWaterProximities;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class InfrastructureWashWaterProximitiesFactory extends Factory
{
    protected $model = InfrastructureWashWaterProximities::class;
