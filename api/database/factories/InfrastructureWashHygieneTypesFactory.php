...
use App\Models\InfrastructureWashHygieneTypes;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class InfrastructureWashHygieneTypesFactory extends Factory
{
    protected $model = InfrastructureWashHygieneTypes::class;
