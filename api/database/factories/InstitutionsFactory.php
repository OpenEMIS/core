...
class InstitutionsFactory extends Factory
{
    ...
    'area_administrative_id' => \App\Models\AreaAdministratives::inRandomOrder()->value('id') ?? 1,
    'institution_locality_id' => \App\Models\InstitutionLocalities::inRandomOrder()->value('id') ?? 1,
    'institution_type_id' => \App\Models\InstitutionTypes::inRandomOrder()->value('id') ?? 1,
    'institution_ownership_id' => \App\Models\InstitutionOwnerships::inRandomOrder()->value('id') ?? 1,
    'institution_status_id' => \App\Models\InstitutionStatuses::inRandomOrder()->value('id') ?? 1,
