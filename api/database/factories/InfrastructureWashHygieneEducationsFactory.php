...
use App\Models\InfrastructureWashHygieneEducations;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class InfrastructureWashHygieneEducationsFactory extends Factory
{
    protected $model = InfrastructureWashHygieneEducations::class;
