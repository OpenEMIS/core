...
use App\Models\InstitutionStaffReleases;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class InstitutionStaffReleasesFactory extends Factory
{
    protected $model = InstitutionStaffReleases::class;
    ...
    'previous_start_date' => \Carbon\Carbon::now()->format("Y-m-d"),
