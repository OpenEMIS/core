...
class InstitutionStudentSurveyAnswersFactory extends Factory
{
    protected $model = InstitutionStudentSurveyAnswers::class;
    ...
    'institution_student_survey_id' => \App\Models\InstitutionStudentSurveys::inRandomOrder()->value('id') ?? 1,
