...
class ScholarshipApplicationInstitutionChoicesFactory extends Factory
{
    ...
    'scholarship_institution_choice_type_id' => \App\Models\ScholarshipInstitutionChoiceTypes::inRandomOrder()->value('id') ?? 1,
    'estimated_cost' => $this->faker->randomFloat(2, 10, 1000),
    'course_name' => $this->faker->lexify(str_repeat("?", 150)),
    'start_date' => \Carbon\Carbon::now()->format("Y-m-d"),
    'end_date' => \Carbon\Carbon::now()->format("Y-m-d"),
    'is_selected' => $this->faker->numberBetween(1, 1000),
    'order' => $this->faker->numberBetween(1, 1000),
    'country_id' => \App\Models\Countries::inRandomOrder()->value('id') ?? 1,
    'scholarship_institution_choice_status_id' => \App\Models\ScholarshipInstitutionChoiceStatuses::inRandomOrder()->value('id') ?? 1,
