...
use App\Models\InfrastructureWashSanitationTypes;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class InfrastructureWashSanitationTypesFactory extends Factory
{
    protected $model = InfrastructureWashSanitationTypes::class;
