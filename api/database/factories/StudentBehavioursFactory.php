...
class StudentBehavioursFactory extends Factory
{
    ...
    'student_behaviour_category_id' => \App\Models\StudentBehaviourCategories::inRandomOrder()->value('id') ?? \App\Models\StudentBehaviourCategories::factory()->create()->id,
    'assignee_id' => $this->faker->numberBetween(1, 1000),
    'modified_user_id' => $this->faker->numberBetween(1, 2),
    'modified' => \Carbon\Carbon::now()->format("Y-m-d H:i:s"),
    'created_user_id' => $this->faker->numberBetween(1, 2),
    'created' => \Carbon\Carbon::now()->format("Y-m-d H:i:s"),
    'student_behaviour_classification_id' => \App\Models\StudentBehaviourClassifications::inRandomOrder()->value('id') ?? \App\Models\StudentBehaviourClassifications::factory()->create()->id,
];
    }
}
