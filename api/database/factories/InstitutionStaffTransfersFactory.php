...
class InstitutionStaffTransfersFactory extends Factory
{
    ...
    'new_institution_id' => \App\Models\Institutions::inRandomOrder()->value('id') ?? 1,
    ...
    'new_institution_position_id' => \App\Models\InstitutionPositions::inRandomOrder()->value('id') ?? 1,
    'new_staff_type_id' => \App\Models\StaffTypes::inRandomOrder()->value('id') ?? 1,
    ...
    'previous_institution_staff_id' => \App\Models\InstitutionStaff::inRandomOrder()->value('id') ?? 1,
    'previous_staff_type_id' => \App\Models\StaffTypes::inRandomOrder()->value('id') ?? 1,
