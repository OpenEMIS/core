...
use App\Models\InfrastructureWashWaterQualities;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class InfrastructureWashWaterQualitiesFactory extends Factory
{
    protected $model = InfrastructureWashWaterQualities::class;
