...
class InstitutionRoomsFactory extends Factory
{
    protected $model = InstitutionRooms::class;
    ...
    'room_type_id' => $this->faker->numberBetween(1, 1000),
    'room_status_id' => $this->faker->numberBetween(1, 1000),
    'institution_floor_id' => $this->faker->numberBetween(1, 1000),
