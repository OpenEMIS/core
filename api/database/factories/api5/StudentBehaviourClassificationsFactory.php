...
use App\Models\Api5\StudentBehaviourClassifications;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class StudentBehaviourClassificationsFactory extends Factory
{
    protected $model = StudentBehaviourClassifications::class;
