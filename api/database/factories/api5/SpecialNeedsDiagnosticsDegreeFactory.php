...
class SpecialNeedsDiagnosticsDegreeFactory extends Factory
{
    protected $model = SpecialNeedsDiagnosticsDegree::class;
    ...
    'special_needs_diagnostics_types_id' => $this->faker->numberBetween(1, 1000),
