...
use App\Models\Api5\InstitutionStaffSurveyTableCells;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class InstitutionStaffSurveyTableCellsFactory extends Factory
{
    protected $model = InstitutionStaffSurveyTableCells::class;
