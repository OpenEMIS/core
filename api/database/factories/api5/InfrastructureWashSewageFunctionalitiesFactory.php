...
use App\Models\Api5\InfrastructureWashSewageFunctionalities;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class InfrastructureWashSewageFunctionalitiesFactory extends Factory
{
    protected $model = InfrastructureWashSewageFunctionalities::class;
