...
use App\Models\Api5\InstitutionClassesCustomFieldValues;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class InstitutionClassesCustomFieldValuesFactory extends Factory
{
    protected $model = InstitutionClassesCustomFieldValues::class;
