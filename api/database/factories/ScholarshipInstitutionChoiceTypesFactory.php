...
use App\Models\ScholarshipInstitutionChoiceTypes;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class ScholarshipInstitutionChoiceTypesFactory extends Factory
{
    protected $model = ScholarshipInstitutionChoiceTypes::class;
