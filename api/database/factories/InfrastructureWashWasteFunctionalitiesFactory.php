...
use App\Models\InfrastructureWashWasteFunctionalities;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Log;

class InfrastructureWashWasteFunctionalitiesFactory extends Factory
{
    protected $model = InfrastructureWashWasteFunctionalities::class;
