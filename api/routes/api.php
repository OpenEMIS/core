...
Route::group(
    ...
    function () {
        ...
        Route::get('get-unique-openemis-id', 'DirectoryController@getUniqueOpenemisId');
        Route::get('get-auto-generated-password', 'DirectoryController@getAutoGeneratedPassword');
        //POCOR-8104 End...
    }
);