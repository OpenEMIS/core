...
class ExaminationCentresExaminationsSubjectsStudents extends Model
{
    use HasFactory;
    ...
    protected $fillable = ['id', 'total_mark', 'examination_centre_id', 'examination_subject_id', 'student_id', 'examination_id', 'education_subject_id', 'created_user_id', 'created'];
    ...
    protected $primaryKey = ['examination_centre_id', 'examination_subject_id', 'student_id'];
 ...
 * @OA\Get(
 *     path="/api/v5/examination-centres-examinations-subjects-students",
 *     summary="Get list of ExaminationCentresExaminationsSubjectsStudents",
...
/**
 * @OA\Get(
 *     path="/api/v5/examination1-2centres_examinations_subjects_students/examination_centre_id/{examination_centre_id}/examination_subject_id/{examination_subject_id}/student_id/{student_id}",
