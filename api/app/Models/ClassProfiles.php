...
/**
 * @OA\Get(
 *     path="/api/v5/class-profiles/class_profile_template_id/{class_profile_template_id}/institution_class_id/{institution_class_id}/institution_id/{institution_id}/academic_period_id/{academic_period_id}",
 *     summary="Get ClassProfiles record by composite key",
 *     tags={"ClassProfiles"},
 *     @OA\Parameter(
 *         name="class_profile_template_id",
 *         in="path",
 *         required=true,
 *         description="class_profile_template_id",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Parameter(
