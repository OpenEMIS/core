...
/**
 * @OA\Get(
 *     path="/api/v5/institution-student-absence-details/{id}",
 *     summary="Get InstitutionStudentAbsenceDetails by ID",
 *     tags={"InstitutionStudentAbsenceDetails"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionStudentAbsenceDetails",
 ...
 * @OA\Put(
 *     path="/api/v5/institution-student-absence-details/{id}",
 *     summary="Update InstitutionStudentAbsenceDetails",
 *     tags={"InstitutionStudentAbsenceDetails"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-student-absence-details/{id}",
 *     summary="Delete InstitutionStudentAbsenceDetails",
 *     tags={"InstitutionStudentAbsenceDetails"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
