...
use UuidId;
    ...
    protected $fillable = ['id', 'text_value', 'number_value', 'decimal_value', 'textarea_value', 'date_value', 'time_value', 'file', 'staff_custom_field_id', 'staff_id', 'modified_user_id', 'modified', 'created_user_id', 'created', 'staff_custom_field_id', 'staff_id', 'modified_user_id', 'created_user_id'];
...
/**
 * @OA\PathItem(
 *     path="/api/v5/staff-custom-field-values"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/staff-custom-field-values",
 *     summary="Get list of StaffCustomFieldValues",
 *     tags={"StaffCustomFieldValues"},
 *     @OA\Response(
 *         response=200,
...
/**
 * @OA\Get(
 *     path="/api/v5/staff-custom-field-values/{id}",
 *     summary="Get StaffCustomFieldValues by ID",
 *     tags={"StaffCustomFieldValues"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the StaffCustomFieldValues",
 ...
 * @OA\Post(
 *     path="/api/v5/staff-custom-field-values",
 *     summary="Create a new StaffCustomFieldValues",
 *     tags={"StaffCustomFieldValues"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
 ...
 * @OA\Put(
 *     path="/api/v5/staff-custom-field-values/{id}",
 *     summary="Update StaffCustomFieldValues",
 *     tags={"StaffCustomFieldValues"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/staff-custom-field-values/{id}",
 *     summary="Delete StaffCustomFieldValues",
 *     tags={"StaffCustomFieldValues"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
