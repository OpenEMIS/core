...
/**
 * @OA\PathItem(
 *     path="/api/v5/survey-table-columns"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/survey-table-columns",
 *     summary="Get list of SurveyTableColumns",
 *     tags={"SurveyTableColumns"},
 *     @OA\Response(
 *         response=200,
...
/**
 * @OA\Get(
 *     path="/api/v5/survey-table-columns/{id}",
 *     summary="Get SurveyTableColumns by ID",
 *     tags={"SurveyTableColumns"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the SurveyTableColumns",
 ...
 * @OA\Post(
 *     path="/api/v5/survey-table-columns",
 *     summary="Create a new SurveyTableColumns",
 *     tags={"SurveyTableColumns"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
 ...
 * @OA\Put(
 *     path="/api/v5/survey-table-columns/{id}",
 *     summary="Update SurveyTableColumns",
 *     tags={"SurveyTableColumns"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/survey-table-columns/{id}",
 *     summary="Delete SurveyTableColumns",
 *     tags={"SurveyTableColumns"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
