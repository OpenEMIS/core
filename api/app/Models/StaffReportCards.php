...
/**
 * @OA\Get(
 *     path="/api/v5/staff-report-cards/{id}",
 *     summary="Get StaffReportCards by ID",
 *     tags={"StaffReportCards"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the StaffReportCards",
 ...
 * @OA\Put(
 *     path="/api/v5/staff-report-cards/{id}",
 *     summary="Update StaffReportCards",
 *     tags={"StaffReportCards"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/staff-report-cards/{id}",
 *     summary="Delete StaffReportCards",
 *     tags={"StaffReportCards"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
