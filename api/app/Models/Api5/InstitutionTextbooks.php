...
/**
 * @OA\PathItem(
 *     path="/api/v5/institution-textbooks"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/institution-textbooks",
 *     summary="Get list of InstitutionTextbooks",
 *     tags={"InstitutionTextbooks"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 *                     type="object",
                          ...
                          @OA\Property(property="textbook_status_id", type="integer", example=null),
                          @OA\Property(property="textbook_condition_id", type="integer", example=null),
                          ...
                          @OA\Property(property="textbook_id", type="integer", example=null),
 ...
 * @OA\Post(
 *     path="/api/v5/institution-textbooks",
 *     summary="Create a new InstitutionTextbooks",
 *     tags={"InstitutionTextbooks"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-textbooks/{id}",
 *     summary="Get InstitutionTextbooks by ID",
 *     tags={"InstitutionTextbooks"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionTextbooks",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/institution-textbooks/{id}",
 *     summary="Update InstitutionTextbooks",
 *     tags={"InstitutionTextbooks"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-textbooks/{id}",
 *     summary="Delete InstitutionTextbooks",
 *     tags={"InstitutionTextbooks"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
