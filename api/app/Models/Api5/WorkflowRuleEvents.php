...
class WorkflowRuleEvents extends Model
{
    use HasFactory;

    protected $table = 'workflow_rule_events';

    // ✅ Allow mass assignment
    protected $fillable = ['workflow_rule_id', 'event_key'];
    ...
    protected $primaryKey = ['workflow_rule_id', 'event_key'];
 ...
 * @OA\Get(
 *     path="/api/v5/workflow-rule-events",
 *     summary="Get list of WorkflowRuleEvents",
