...
/**
 * @OA\PathItem(
 *     path="/api/v5/competency-periods"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/competency-periods",
 *     summary="Get list of CompetencyPeriods",
 *     tags={"CompetencyPeriods"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/competency-periods",
 *     summary="Create a new CompetencyPeriods",
 *     tags={"CompetencyPeriods"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/competency-periods/{id}",
 *     summary="Get CompetencyPeriods by ID",
 *     tags={"CompetencyPeriods"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the CompetencyPeriods",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/competency-periods/{id}",
 *     summary="Update CompetencyPeriods",
 *     tags={"CompetencyPeriods"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/competency-periods/{id}",
 *     summary="Delete CompetencyPeriods",
 *     tags={"CompetencyPeriods"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
