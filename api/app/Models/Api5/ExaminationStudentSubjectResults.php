...
class ExaminationStudentSubjectResults extends Model
{
    use HasFactory;
use InstitutionScope;
    ...
    protected $fillable = ['id', 'marks', 'examination_subject_id', 'student_id', 'academic_period_id', 'examination_id', 'examination_centre_id', 'education_subject_id', 'examination_grading_option_id', 'institution_id', 'modified_user_id', 'modified', 'created_user_id', 'created'];
    ...
    protected $primaryKey = ['examination_subject_id', 'student_id'];
...
/**
 * @OA\PathItem(
 *     path="/api/v5/examination-student-subject-results"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/examination-student-subject-results",
 *     summary="Get list of ExaminationStudentSubjectResults",
 ...
 *                     type="object",
                          ...
                          @OA\Property(property="examination_grading_option_id", type="integer", example=null),
 ...
 * @OA\Post(
 *     path="/api/v5/examination-student-subject-results",
 *     summary="Create a new ExaminationStudentSubjectResults",
 *     tags={"ExaminationStudentSubjectResults"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
