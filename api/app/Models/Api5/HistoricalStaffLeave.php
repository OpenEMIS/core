...
class HistoricalStaffLeave extends Model
{
    use HasFactory;
use InstitutionScope;

    protected $table = 'historical_staff_leave';

    // ✅ Allow mass assignment
    protected $fillable = ['id', 'date_from', 'date_to', 'start_time', 'end_time', 'full_day', 'comments', 'staff_id', 'staff_leave_type_id', 'institution_id', 'number_of_days', 'file_name', 'file_content', 'modified_user_id', 'modified', 'created_user_id', 'created'];
...
/**
 * @OA\PathItem(
 *     path="/api/v5/historical-staff-leave"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/historical-staff-leave",
 *     summary="Get list of HistoricalStaffLeave",
 *     tags={"HistoricalStaffLeave"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/historical-staff-leave",
 *     summary="Create a new HistoricalStaffLeave",
 *     tags={"HistoricalStaffLeave"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/historical-staff-leave/{id}",
 *     summary="Get HistoricalStaffLeave by ID",
 *     tags={"HistoricalStaffLeave"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the HistoricalStaffLeave",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/historical-staff-leave/{id}",
 *     summary="Update HistoricalStaffLeave",
 *     tags={"HistoricalStaffLeave"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/historical-staff-leave/{id}",
 *     summary="Delete HistoricalStaffLeave",
 *     tags={"HistoricalStaffLeave"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
