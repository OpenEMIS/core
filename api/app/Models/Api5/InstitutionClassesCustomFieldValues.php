...
use UuidId;
    ...
    protected $fillable = ['id', 'text_value', 'number_value', 'decimal_value', 'textarea_value', 'date_value', 'time_value', 'file', 'institution_custom_field_id', 'institution_class_id', 'modified_user_id', 'modified', 'created_user_id', 'created'];
...
/**
 * @OA\PathItem(
 *     path="/api/v5/institution-classes-custom-field-values"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/institution-classes-custom-field-values",
 *     summary="Get list of InstitutionClassesCustomFieldValues",
 *     tags={"InstitutionClassesCustomFieldValues"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/institution-classes-custom-field-values",
 *     summary="Create a new InstitutionClassesCustomFieldValues",
 *     tags={"InstitutionClassesCustomFieldValues"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-classes-custom-field-values/{id}",
 *     summary="Get InstitutionClassesCustomFieldValues by ID",
 *     tags={"InstitutionClassesCustomFieldValues"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionClassesCustomFieldValues",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/institution-classes-custom-field-values/{id}",
 *     summary="Update InstitutionClassesCustomFieldValues",
 *     tags={"InstitutionClassesCustomFieldValues"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-classes-custom-field-values/{id}",
 *     summary="Delete InstitutionClassesCustomFieldValues",
 *     tags={"InstitutionClassesCustomFieldValues"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
