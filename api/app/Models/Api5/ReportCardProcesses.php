...
class ReportCardProcesses extends Model
{
    use HasFactory;
use InstitutionScope;

    protected $table = 'report_card_processes';

    // ✅ Allow mass assignment
    protected $fillable = ['report_card_id', 'institution_class_id', 'student_id', 'status', 'institution_id', 'education_grade_id', 'academic_period_id', 'modified', 'created'];
...
/**
 * @OA\PathItem(
 *     path="/api/v5/report-card-processes"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/report-card-processes",
 *     summary="Get list of ReportCardProcesses",
 ...
 * @OA\Post(
 *     path="/api/v5/report-card-processes",
 *     summary="Create a new ReportCardProcesses",
 *     tags={"ReportCardProcesses"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
