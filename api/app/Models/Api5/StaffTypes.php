 ...
 * @OA\Get(
 *     path="/api/v5/staff-types",
 *     summary="Get list of StaffTypes",
 *     tags={"StaffTypes"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 ...
 * @OA\Post(
 *     path="/api/v5/staff-types",
 *     summary="Create a new StaffTypes",
 *     tags={"StaffTypes"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/staff-types/{id}",
 *     summary="Get StaffTypes by ID",
 *     tags={"StaffTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the StaffTypes",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
