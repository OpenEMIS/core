 ...
 * @OA\Get(
 *     path="/api/v5/shift-options",
 *     summary="Get list of ShiftOptions",
 *     tags={"ShiftOptions"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 ...
 * @OA\Post(
 *     path="/api/v5/shift-options",
 *     summary="Create a new ShiftOptions",
 *     tags={"ShiftOptions"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/shift-options/{id}",
 *     summary="Get ShiftOptions by ID",
 *     tags={"ShiftOptions"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the ShiftOptions",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
