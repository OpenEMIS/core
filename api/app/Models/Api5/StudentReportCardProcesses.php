...
class StudentReportCardProcesses extends Model
{
    use HasFactory;
use InstitutionScope;

    protected $table = 'student_report_card_processes';

    // ✅ Allow mass assignment
    protected $fillable = ['student_profile_template_id', 'student_id', 'status', 'institution_id', 'academic_period_id', 'education_grade_id', 'created'];
 ...
 * @OA\Get(
 *     path="/api/v5/student-report-card-processes",
 *     summary="Get list of StudentReportCardProcesses",
...
/**
 * @OA\Get(
 *     path="/api/v5/student-report-card-processes/student_profile_template_id/{student_profile_template_id}/student_id/{student_id}",
