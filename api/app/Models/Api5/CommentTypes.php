 ...
 * @OA\Get(
 *     path="/api/v5/comment-types",
 *     summary="Get list of CommentTypes",
 *     tags={"CommentTypes"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 ...
 * @OA\Post(
 *     path="/api/v5/comment-types",
 *     summary="Create a new CommentTypes",
 *     tags={"CommentTypes"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/comment-types/{id}",
 *     summary="Get CommentTypes by ID",
 *     tags={"CommentTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the CommentTypes",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
