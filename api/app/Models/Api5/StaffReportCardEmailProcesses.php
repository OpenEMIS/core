...
use InstitutionScope;
    ...
    protected $fillable = ['staff_profile_template_id', 'staff_id', 'status', 'error_message', 'institution_id', 'academic_period_id', 'created'];
 ...
 * @OA\Get(
 *     path="/api/v5/staff-report-card-email-processes",
 *     summary="Get list of StaffReportCardEmailProcesses",
...
/**
 * @OA\Get(
 *     path="/api/v5/staff-report-card-email-processes/staff_profile_template_id/{staff_profile_template_id}/staff_id/{staff_id}",
