...
/**
 * @OA\PathItem(
 *     path="/api/v5/institution-grades"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/institution-grades",
 *     summary="Get list of InstitutionGrades",
 *     tags={"InstitutionGrades"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/institution-grades",
 *     summary="Create a new InstitutionGrades",
 *     tags={"InstitutionGrades"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-grades/{id}",
 *     summary="Get InstitutionGrades by ID",
 *     tags={"InstitutionGrades"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionGrades",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/institution-grades/{id}",
 *     summary="Update InstitutionGrades",
 *     tags={"InstitutionGrades"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-grades/{id}",
 *     summary="Delete InstitutionGrades",
 *     tags={"InstitutionGrades"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
