...
/**
 * @OA\Get(
 *     path="/api/v5/bus-types/{id}",
 *     summary="Get BusTypes by ID",
 *     tags={"BusTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the BusTypes",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
