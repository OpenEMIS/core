...
/**
 * @OA\PathItem(
 *     path="/api/v5/institution-class-grades"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/institution-class-grades",
 *     summary="Get list of InstitutionClassGrades",
 *     tags={"InstitutionClassGrades"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/institution-class-grades",
 *     summary="Create a new InstitutionClassGrades",
 *     tags={"InstitutionClassGrades"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-class-grades/{id}",
 *     summary="Get InstitutionClassGrades by ID",
 *     tags={"InstitutionClassGrades"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionClassGrades",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/institution-class-grades/{id}",
 *     summary="Update InstitutionClassGrades",
 *     tags={"InstitutionClassGrades"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-class-grades/{id}",
 *     summary="Delete InstitutionClassGrades",
 *     tags={"InstitutionClassGrades"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
