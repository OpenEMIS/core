 ...
 *                     type="object",
                          ...
                          @OA\Property(property="pdf_page_number", type="integer", example=null),
 ...
 * @OA\Post(
 *     path="/api/v5/report-cards",
 *     summary="Create a new ReportCards",
 *     tags={"ReportCards"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/report-cards/{id}",
 *     summary="Get ReportCards by ID",
 *     tags={"ReportCards"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the ReportCards",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
