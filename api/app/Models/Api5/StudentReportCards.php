...
/**
 * @OA\Get(
 *     path="/api/v5/student-report-cards/student_profile_template_id/{student_profile_template_id}/student_id/{student_id}/institution_id/{institution_id}/academic_period_id/{academic_period_id}",
 *     summary="Get StudentReportCards record by composite key",
 *     tags={"StudentReportCards"},
 *     @OA\Parameter(
 ...
 * @OA\Put(
 *     path="/api/v5/student-report-cards/student_profile_template_id/{student_profile_template_id}/student_id/{student_id}/institution_id/{institution_id}/academic_period_id/{academic_period_id}",
 *     summary="Update StudentReportCards record by composite key",
 *     tags={"StudentReportCards"},
 *     @OA\Parameter(
 *         name="student_profile_template_id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/student-report-cards/student_profile_template_id/{student_profile_template_id}/student_id/{student_id}/institution_id/{institution_id}/academic_period_id/{academic_period_id}",
 *     summary="Delete StudentReportCards record by composite key",
 *     tags={"StudentReportCards"},
 *     @OA\Parameter(
 *         name="student_profile_template_id",
 *         in="path",
