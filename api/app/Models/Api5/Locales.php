 ...
 *                     type="object",
                          ...
                          @OA\Property(property="iso", type="string", example=null),
                          @OA\Property(property="name", type="string", example=null),
                          @OA\Property(property="editable", type="integer", example=null),
                          @OA\Property(property="direction", type="string", example=null),
...
/**
 * @OA\Get(
 *     path="/api/v5/locales/{id}",
 *     summary="Get Locales by ID",
 *     tags={"Locales"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the Locales",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
