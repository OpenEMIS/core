...
class InstitutionStaffLeaveArchived extends Model
{
    use HasFactory;
use InstitutionScope;
    ...
    protected $fillable = ['id', 'date_from', 'date_to', 'start_time', 'end_time', 'full_day', 'comments', 'staff_id', 'staff_leave_type_id', 'institution_id', 'assignee_id', 'academic_period_id', 'status_id', 'number_of_days', 'file_name', 'file_content', 'modified_user_id', 'modified', 'created_user_id', 'created'];
...
/**
 * @OA\PathItem(
 *     path="/api/v5/institution-staff-leave-archived"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/institution-staff-leave-archived",
 *     summary="Get list of InstitutionStaffLeaveArchived",
 *     tags={"InstitutionStaffLeaveArchived"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/institution-staff-leave-archived",
 *     summary="Create a new InstitutionStaffLeaveArchived",
 *     tags={"InstitutionStaffLeaveArchived"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-staff-leave-archived/{id}",
 *     summary="Get InstitutionStaffLeaveArchived by ID",
 *     tags={"InstitutionStaffLeaveArchived"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionStaffLeaveArchived",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/institution-staff-leave-archived/{id}",
 *     summary="Update InstitutionStaffLeaveArchived",
 *     tags={"InstitutionStaffLeaveArchived"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-staff-leave-archived/{id}",
 *     summary="Delete InstitutionStaffLeaveArchived",
 *     tags={"InstitutionStaffLeaveArchived"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
