 ...
 * @OA\Get(
 *     path="/api/v5/institution-meal-programmes",
 *     summary="Get list of InstitutionMealProgrammes",
 ...
 *                     type="object",
                          ...
                          @OA\Property(property="date_received", type="string", format="date", example=null),
                          @OA\Property(property="quantity_received", type="integer", example=null),
                          @OA\Property(property="delivery_status_id", type="integer", example=null),
                          @OA\Property(property="comment", type="string", example=null),
                          @OA\Property(property="modified_user_id", type="integer", example=null),
                          @OA\Property(property="modified", type="string", format="date-time", example=null),
                          @OA\Property(property="created_user_id", type="integer", example=null),
                          @OA\Property(property="created", type="string", format="date-time", example=null),
                          @OA\Property(property="meal_rating_id", type="integer", example=null)
 *                 )
 *             )
 *         )
 *     ),
 ...
 * @OA\Put(
 *     path="/api/v5/institution-meal-programmes/{id}",
 *     summary="Update InstitutionMealProgrammes",
 *     tags={"InstitutionMealProgrammes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-meal-programmes/{id}",
 *     summary="Delete InstitutionMealProgrammes",
 *     tags={"InstitutionMealProgrammes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
