...
/**
 * @OA\PathItem(
 *     path="/api/v5/institution-competency-results"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/institution-competency-results",
 *     summary="Get list of InstitutionCompetencyResults",
 *     tags={"InstitutionCompetencyResults"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 *                     type="object",
                          ...
                          @OA\Property(property="competency_grading_option_id", type="integer", example=null),
                          ...
                          @OA\Property(property="competency_criteria_id", type="integer", example=null),
 ...
 * @OA\Post(
 *     path="/api/v5/institution-competency-results",
 *     summary="Create a new InstitutionCompetencyResults",
 *     tags={"InstitutionCompetencyResults"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-competency-results/{id}",
 *     summary="Get InstitutionCompetencyResults by ID",
 *     tags={"InstitutionCompetencyResults"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionCompetencyResults",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/institution-competency-results/{id}",
 *     summary="Update InstitutionCompetencyResults",
 *     tags={"InstitutionCompetencyResults"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-competency-results/{id}",
 *     summary="Delete InstitutionCompetencyResults",
 *     tags={"InstitutionCompetencyResults"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
