 ...
 * @OA\Get(
 *     path="/api/v5/custom-modules",
 *     summary="Get list of CustomModules",
 *     tags={"CustomModules"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 ...
 * @OA\Post(
 *     path="/api/v5/custom-modules",
 *     summary="Create a new CustomModules",
 *     tags={"CustomModules"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/custom-modules/{id}",
 *     summary="Get CustomModules by ID",
 *     tags={"CustomModules"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the CustomModules",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
