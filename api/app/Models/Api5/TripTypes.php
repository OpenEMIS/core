 ...
 * @OA\Post(
 *     path="/api/v5/trip-types",
 *     summary="Create a new TripTypes",
 *     tags={"TripTypes"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/trip-types/{id}",
 *     summary="Get TripTypes by ID",
 *     tags={"TripTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the TripTypes",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
