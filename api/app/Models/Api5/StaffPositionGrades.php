...
/**
 * @OA\PathItem(
 *     path="/api/v5/staff-position-grades"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/staff-position-grades",
 *     summary="Get list of StaffPositionGrades",
 *     tags={"StaffPositionGrades"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/staff-position-grades",
 *     summary="Create a new StaffPositionGrades",
 *     tags={"StaffPositionGrades"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/staff-position-grades/{id}",
 *     summary="Get StaffPositionGrades by ID",
 *     tags={"StaffPositionGrades"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the StaffPositionGrades",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/staff-position-grades/{id}",
 *     summary="Update StaffPositionGrades",
 *     tags={"StaffPositionGrades"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/staff-position-grades/{id}",
 *     summary="Delete StaffPositionGrades",
 *     tags={"StaffPositionGrades"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
