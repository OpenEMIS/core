...
/**
 * @OA\PathItem(
 *     path="/api/v5/institution-custom-forms-fields"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/institution-custom-forms-fields",
 *     summary="Get list of InstitutionCustomFormsFields",
 *     tags={"InstitutionCustomFormsFields"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/institution-custom-forms-fields",
 *     summary="Create a new InstitutionCustomFormsFields",
 *     tags={"InstitutionCustomFormsFields"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-custom-forms-fields/{id}",
 *     summary="Get InstitutionCustomFormsFields by ID",
 *     tags={"InstitutionCustomFormsFields"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionCustomFormsFields",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/institution-custom-forms-fields/{id}",
 *     summary="Update InstitutionCustomFormsFields",
 *     tags={"InstitutionCustomFormsFields"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-custom-forms-fields/{id}",
 *     summary="Delete InstitutionCustomFormsFields",
 *     tags={"InstitutionCustomFormsFields"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
