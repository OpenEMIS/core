 ...
 * @OA\Get(
 *     path="/api/v5/asset-types",
 *     summary="Get list of AssetTypes",
 *     tags={"AssetTypes"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 ...
 * @OA\Post(
 *     path="/api/v5/asset-types",
 *     summary="Create a new AssetTypes",
 *     tags={"AssetTypes"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/asset-types/{id}",
 *     summary="Get AssetTypes by ID",
 *     tags={"AssetTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the AssetTypes",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
