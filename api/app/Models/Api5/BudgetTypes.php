 ...
 * @OA\Get(
 *     path="/api/v5/budget-types",
 *     summary="Get list of BudgetTypes",
 *     tags={"BudgetTypes"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 ...
 *         in="path",
 *         required=true,
 *         description="ID of the BudgetTypes",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
