 ...
 * @OA\Get(
 *     path="/api/v5/institution-units",
 *     summary="Get list of InstitutionUnits",
 *     tags={"InstitutionUnits"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/institution-units",
 *     summary="Create a new InstitutionUnits",
 *     tags={"InstitutionUnits"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-units/{id}",
 *     summary="Get InstitutionUnits by ID",
 *     tags={"InstitutionUnits"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionUnits",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/institution-units/{id}",
 *     summary="Update InstitutionUnits",
 *     tags={"InstitutionUnits"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-units/{id}",
 *     summary="Delete InstitutionUnits",
 *     tags={"InstitutionUnits"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
