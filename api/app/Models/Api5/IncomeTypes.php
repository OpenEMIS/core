 ...
 * @OA\Get(
 *     path="/api/v5/income-types",
 *     summary="Get list of IncomeTypes",
 *     tags={"IncomeTypes"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 ...
 * @OA\Post(
 *     path="/api/v5/income-types",
 *     summary="Create a new IncomeTypes",
 *     tags={"IncomeTypes"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/income-types/{id}",
 *     summary="Get IncomeTypes by ID",
 *     tags={"IncomeTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the IncomeTypes",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
