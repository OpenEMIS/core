 ...
 * @OA\Get(
 *     path="/api/v5/summary-institution-grades",
 *     summary="Get list of SummaryInstitutionGrades",
 *     tags={"SummaryInstitutionGrades"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 *                     type="object",
                          ...
                          @OA\Property(property="total_classes_female", type="integer", example=null),
                          @OA\Property(property="total_classes_male", type="integer", example=null),
                          @OA\Property(property="total_classes_mixed", type="integer", example=null),
                          ...
                          @OA\Property(property="total_home_room_teachers", type="integer", example=null),
                          @OA\Property(property="total_secondary_teachers", type="integer", example=null)
 *                 )
 *             )
 *         )
 *     ),
 ...
 * @OA\Post(
 *     path="/api/v5/summary-institution-grades",
 *     summary="Create a new SummaryInstitutionGrades",
 *     tags={"SummaryInstitutionGrades"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/summary-institution-grades/{id}",
 *     summary="Get SummaryInstitutionGrades by ID",
 *     tags={"SummaryInstitutionGrades"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the SummaryInstitutionGrades",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/summary-institution-grades/{id}",
 *     summary="Update SummaryInstitutionGrades",
 *     tags={"SummaryInstitutionGrades"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/summary-institution-grades/{id}",
 *     summary="Delete SummaryInstitutionGrades",
 *     tags={"SummaryInstitutionGrades"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
