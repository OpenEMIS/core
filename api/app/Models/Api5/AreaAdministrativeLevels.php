...
class AreaAdministrativeLevels extends Model
{
    ...
    /**
     * @OA\PathItem(
     *     path="/api/v5/area-administrative-levels"
     * )
     */
     ...
     * @OA\Get(
     *     path="/api/v5/area-administrative-levels",
     *     summary="Get list of AreaAdministrativeLevels",
     *     tags={"AreaAdministrativeLevels"},
     *     @OA\Parameter(
     *         name="limit",
     *         in="query",
     *         required=false,
     ...
     * @OA\Post(
     *     path="/api/v5/area-administrative-levels",
     *     summary="Create a new AreaAdministrativeLevels",
     *     tags={"AreaAdministrativeLevels"},
     *     @OA\RequestBody(
     *         required=true,
     *         @OA\JsonContent(
    ...
    /**
     * @OA\Get(
     *     path="/api/v5/area-administrative-levels/{id}",
     *     summary="Get AreaAdministrativeLevels by ID",
     *     tags={"AreaAdministrativeLevels"},
     *     @OA\Parameter(
     *         name="id",
     *         in="path",
     *         required=true,
     *         description="ID of the AreaAdministrativeLevels",
     *         @OA\Schema(type="string")
     *     ),
     *     @OA\Response(
     *         response=200,
     ...
     * @OA\Put(
     *     path="/api/v5/area-administrative-levels/{id}",
     *     summary="Update AreaAdministrativeLevels",
     *     tags={"AreaAdministrativeLevels"},
     *     @OA\Parameter(
     *         name="id",
     *         in="path",
     ...
     * @OA\Delete(
     *     path="/api/v5/area-administrative-levels/{id}",
     *     summary="Delete AreaAdministrativeLevels",
     *     tags={"AreaAdministrativeLevels"},
     *     @OA\Parameter(
     *         name="id",
     *         in="path",
