 ...
 * @OA\Post(
 *     path="/api/v5/land-types",
 *     summary="Create a new LandTypes",
 *     tags={"LandTypes"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/land-types/{id}",
 *     summary="Get LandTypes by ID",
 *     tags={"LandTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the LandTypes",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
