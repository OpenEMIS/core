...
class Counsellings extends Model
{
    use HasFactory;
 ...
 * @OA\Get(
 *     path="/api/v5/counsellings",
 *     summary="Get list of Counsellings",
 *     tags={"Counsellings"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 ...
 *                     type="object",
                          ...
                          @OA\Property(property="guidance_utilized", type="string", example=null),
                          @OA\Property(property="description", type="string", example=null),
                          @OA\Property(property="intervention", type="string", example=null),
 ...
 * @OA\Post(
 *     path="/api/v5/counsellings",
 *     summary="Create a new Counsellings",
 *     tags={"Counsellings"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/counsellings/{id}",
 *     summary="Get Counsellings by ID",
 *     tags={"Counsellings"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the Counsellings",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
