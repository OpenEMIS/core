...
/**
 * @OA\Get(
 *     path="/api/v5/appraisal-score-answers/appraisal_form_id/{appraisal_form_id}/appraisal_criteria_id/{appraisal_criteria_id}/institution_staff_appraisal_id/{institution_staff_appraisal_id}",
