 ...
 * @OA\Get(
 *     path="/api/v5/income-sources",
 *     summary="Get list of IncomeSources",
 *     tags={"IncomeSources"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 ...
 * @OA\Post(
 *     path="/api/v5/income-sources",
 *     summary="Create a new IncomeSources",
 *     tags={"IncomeSources"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/income-sources/{id}",
 *     summary="Get IncomeSources by ID",
 *     tags={"IncomeSources"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the IncomeSources",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
