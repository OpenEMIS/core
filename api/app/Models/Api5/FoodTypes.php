 ...
 * @OA\Post(
 *     path="/api/v5/food-types",
 *     summary="Create a new FoodTypes",
 *     tags={"FoodTypes"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/food-types/{id}",
 *     summary="Get FoodTypes by ID",
 *     tags={"FoodTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the FoodTypes",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
