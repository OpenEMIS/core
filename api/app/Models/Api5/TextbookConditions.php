...
/**
 * @OA\PathItem(
 *     path="/api/v5/textbook-conditions"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/textbook-conditions",
 *     summary="Get list of TextbookConditions",
 *     tags={"TextbookConditions"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/textbook-conditions",
 *     summary="Create a new TextbookConditions",
 *     tags={"TextbookConditions"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/textbook-conditions/{id}",
 *     summary="Get TextbookConditions by ID",
 *     tags={"TextbookConditions"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the TextbookConditions",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/textbook-conditions/{id}",
 *     summary="Update TextbookConditions",
 *     tags={"TextbookConditions"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/textbook-conditions/{id}",
 *     summary="Delete TextbookConditions",
 *     tags={"TextbookConditions"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
