 ...
 * @OA\Get(
 *     path="/api/v5/custom-fields",
 *     summary="Get list of CustomFields",
 *     tags={"CustomFields"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 ...
 * @OA\Post(
 *     path="/api/v5/custom-fields",
 *     summary="Create a new CustomFields",
 *     tags={"CustomFields"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/custom-fields/{id}",
 *     summary="Get CustomFields by ID",
 *     tags={"CustomFields"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the CustomFields",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
