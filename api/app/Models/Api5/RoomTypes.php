...
class RoomTypes extends Model
{
    ...
    protected $fillable = ['id', 'name', 'order', 'visible', 'editable', 'default', 'classification', 'international_code', 'national_code', 'modified_user_id', 'modified', 'created_user_id', 'created'];
 ...
 * @OA\Post(
 *     path="/api/v5/room-types",
 *     summary="Create a new RoomTypes",
 *     tags={"RoomTypes"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/room-types/{id}",
 *     summary="Get RoomTypes by ID",
 *     tags={"RoomTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the RoomTypes",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
