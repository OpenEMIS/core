 ...
 * @OA\Get(
 *     path="/api/v5/textbook-statuses",
 *     summary="Get list of TextbookStatuses",
 *     tags={"TextbookStatuses"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/textbook-statuses",
 *     summary="Create a new TextbookStatuses",
 *     tags={"TextbookStatuses"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/textbook-statuses/{id}",
 *     summary="Get TextbookStatuses by ID",
 *     tags={"TextbookStatuses"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the TextbookStatuses",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/textbook-statuses/{id}",
 *     summary="Update TextbookStatuses",
 *     tags={"TextbookStatuses"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/textbook-statuses/{id}",
 *     summary="Delete TextbookStatuses",
 *     tags={"TextbookStatuses"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
