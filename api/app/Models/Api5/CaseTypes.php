 ...
 * @OA\Post(
 *     path="/api/v5/case-types",
 *     summary="Create a new CaseTypes",
 *     tags={"CaseTypes"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/case-types/{id}",
 *     summary="Get CaseTypes by ID",
 *     tags={"CaseTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the CaseTypes",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
