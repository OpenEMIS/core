...
class InsertedRecords extends Model
{
    use HasFactory;

    protected $table = 'inserted_records';

    // ✅ Allow mass assignment
    protected $fillable = ['id', 'inserted_date', 'reference_table', 'reference_key', 'data', 'action_type', 'created_user_id', 'created'];
    ...
    protected $primaryKey = ['id', 'inserted_date'];
