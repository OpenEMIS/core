...
class StudentProfileTemplates extends Model
{
    use HasFactory;

    protected $table = 'student_profile_templates';
...
/**
 * @OA\PathItem(
 *     path="/api/v5/student-profile-templates"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/student-profile-templates",
 *     summary="Get list of StudentProfileTemplates",
 *     tags={"StudentProfileTemplates"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/student-profile-templates",
 *     summary="Create a new StudentProfileTemplates",
 *     tags={"StudentProfileTemplates"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/student-profile-templates/{id}",
 *     summary="Get StudentProfileTemplates by ID",
 *     tags={"StudentProfileTemplates"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the StudentProfileTemplates",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/student-profile-templates/{id}",
 *     summary="Update StudentProfileTemplates",
 *     tags={"StudentProfileTemplates"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/student-profile-templates/{id}",
 *     summary="Delete StudentProfileTemplates",
 *     tags={"StudentProfileTemplates"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
