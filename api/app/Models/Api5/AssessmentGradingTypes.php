...
/**
 * @OA\PathItem(
 *     path="/api/v5/assessment-grading-types"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/assessment-grading-types",
 *     summary="Get list of AssessmentGradingTypes",
 *     tags={"AssessmentGradingTypes"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/assessment-grading-types",
 *     summary="Create a new AssessmentGradingTypes",
 *     tags={"AssessmentGradingTypes"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/assessment-grading-types/{id}",
 *     summary="Get AssessmentGradingTypes by ID",
 *     tags={"AssessmentGradingTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the AssessmentGradingTypes",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/assessment-grading-types/{id}",
 *     summary="Update AssessmentGradingTypes",
 *     tags={"AssessmentGradingTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/assessment-grading-types/{id}",
 *     summary="Delete AssessmentGradingTypes",
 *     tags={"AssessmentGradingTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
