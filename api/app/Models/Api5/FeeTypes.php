...
/**
 * @OA\Get(
 *     path="/api/v5/fee-types/{id}",
 *     summary="Get FeeTypes by ID",
 *     tags={"FeeTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the FeeTypes",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
