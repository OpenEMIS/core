 ...
 * @OA\Get(
 *     path="/api/v5/area-levels",
 *     summary="Get list of AreaLevels",
 *     tags={"AreaLevels"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 ...
 * @OA\Post(
 *     path="/api/v5/area-levels",
 *     summary="Create a new AreaLevels",
 *     tags={"AreaLevels"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/area-levels/{id}",
 *     summary="Get AreaLevels by ID",
 *     tags={"AreaLevels"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the AreaLevels",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
