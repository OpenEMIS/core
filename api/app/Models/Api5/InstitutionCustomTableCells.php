...
class InstitutionCustomTableCells extends Model
{
    use HasFactory;
use InstitutionScope;

    protected $table = 'institution_custom_table_cells';

    // ✅ Allow mass assignment
    protected $fillable = ['text_value', 'number_value', 'decimal_value', 'institution_custom_field_id', 'institution_custom_table_column_id', 'institution_custom_table_row_id', 'institution_id', 'modified_user_id', 'modified', 'created_user_id', 'created'];
    ...
    protected $primaryKey = ['institution_custom_field_id', 'institution_custom_table_column_id', 'institution_custom_table_row_id', 'institution_id'];
 ...
 * @OA\Get(
 *     path="/api/v5/institution-custom-table-cells",
 *     summary="Get list of InstitutionCustomTableCells",
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-custom-table-cells/institution_custom_field_id/{institution_custom_field_id}/institution_custom_table_column_id/{institution_custom_table_column_id}/institution_custom_table_row_id/{institution_custom_table_row_id}/institution_id/{institution_id}",
