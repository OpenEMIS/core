 ...
 * @OA\Get(
 *     path="/api/v5/user-insurances",
 *     summary="Get list of UserInsurances",
 *     tags={"UserInsurances"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 ...
 *                     type="object",
                          ...
                          @OA\Property(property="insurance_provider_id", type="integer", example=null),
                          @OA\Property(property="insurance_type_id", type="integer", example=null),
 ...
 * @OA\Post(
 *     path="/api/v5/user-insurances",
 *     summary="Create a new UserInsurances",
 *     tags={"UserInsurances"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/user-insurances/{id}",
 *     summary="Get UserInsurances by ID",
 *     tags={"UserInsurances"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the UserInsurances",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
