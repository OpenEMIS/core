...
class DemographicTypes extends Model
{
    ...
    protected $fillable = ['id', 'name', 'description', 'order', 'visible', 'editable', 'default', 'international_code', 'national_code', 'modified_user_id', 'modified', 'created_user_id', 'created'];
 ...
 * @OA\Get(
 *     path="/api/v5/demographic-types",
 *     summary="Get list of DemographicTypes",
 *     tags={"DemographicTypes"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/demographic-types",
 *     summary="Create a new DemographicTypes",
 *     tags={"DemographicTypes"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/demographic-types/{id}",
 *     summary="Get DemographicTypes by ID",
 *     tags={"DemographicTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the DemographicTypes",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/demographic-types/{id}",
 *     summary="Update DemographicTypes",
 *     tags={"DemographicTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/demographic-types/{id}",
 *     summary="Delete DemographicTypes",
 *     tags={"DemographicTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
