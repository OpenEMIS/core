...
/**
 * @OA\PathItem(
 *     path="/api/v5/survey-question-choices"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/survey-question-choices",
 *     summary="Get list of SurveyQuestionChoices",
 *     tags={"SurveyQuestionChoices"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/survey-question-choices",
 *     summary="Create a new SurveyQuestionChoices",
 *     tags={"SurveyQuestionChoices"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/survey-question-choices/{id}",
 *     summary="Get SurveyQuestionChoices by ID",
 *     tags={"SurveyQuestionChoices"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the SurveyQuestionChoices",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/survey-question-choices/{id}",
 *     summary="Update SurveyQuestionChoices",
 *     tags={"SurveyQuestionChoices"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/survey-question-choices/{id}",
 *     summary="Delete SurveyQuestionChoices",
 *     tags={"SurveyQuestionChoices"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
