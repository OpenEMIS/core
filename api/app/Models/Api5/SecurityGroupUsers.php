...
/**
 * @OA\PathItem(
 *     path="/api/v5/security-group-users"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/security-group-users",
 *     summary="Get list of SecurityGroupUsers",
 *     tags={"SecurityGroupUsers"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/security-group-users",
 *     summary="Create a new SecurityGroupUsers",
 *     tags={"SecurityGroupUsers"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/security-group-users/{id}",
 *     summary="Get SecurityGroupUsers by ID",
 *     tags={"SecurityGroupUsers"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the SecurityGroupUsers",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/security-group-users/{id}",
 *     summary="Update SecurityGroupUsers",
 *     tags={"SecurityGroupUsers"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/security-group-users/{id}",
 *     summary="Delete SecurityGroupUsers",
 *     tags={"SecurityGroupUsers"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
