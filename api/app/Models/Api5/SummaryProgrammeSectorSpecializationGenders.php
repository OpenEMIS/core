 ...
 * @OA\Get(
 *     path="/api/v5/summary-programme-sector-specialization-genders",
 *     summary="Get list of SummaryProgrammeSectorSpecializationGenders",
 ...
 *                     type="object",
                          ...
                          @OA\Property(property="education_level_isced_level", type="string", example=null),
                          ...
                          @OA\Property(property="staff_training_category_name", type="string", example=null),
 ...
 * @OA\Put(
 *     path="/api/v5/summary-programme-sector-specialization-genders/{id}",
 *     summary="Update SummaryProgrammeSectorSpecializationGenders",
 *     tags={"SummaryProgrammeSectorSpecializationGenders"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/summary-programme-sector-specialization-genders/{id}",
 *     summary="Delete SummaryProgrammeSectorSpecializationGenders",
 *     tags={"SummaryProgrammeSectorSpecializationGenders"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
