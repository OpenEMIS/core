...
/**
 * @OA\Get(
 *     path="/api/v5/examination-centres-examinations-subjects-students/examination_centre_id/{examination_centre_id}/examination_subject_id/{examination_subject_id}/student_id/{student_id}",
