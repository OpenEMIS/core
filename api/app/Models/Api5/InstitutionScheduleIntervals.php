...
/**
 * @OA\PathItem(
 *     path="/api/v5/institution-schedule-intervals"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/institution-schedule-intervals",
 *     summary="Get list of InstitutionScheduleIntervals",
 *     tags={"InstitutionScheduleIntervals"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/institution-schedule-intervals",
 *     summary="Create a new InstitutionScheduleIntervals",
 *     tags={"InstitutionScheduleIntervals"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-schedule-intervals/{id}",
 *     summary="Get InstitutionScheduleIntervals by ID",
 *     tags={"InstitutionScheduleIntervals"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionScheduleIntervals",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/institution-schedule-intervals/{id}",
 *     summary="Update InstitutionScheduleIntervals",
 *     tags={"InstitutionScheduleIntervals"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-schedule-intervals/{id}",
 *     summary="Delete InstitutionScheduleIntervals",
 *     tags={"InstitutionScheduleIntervals"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
