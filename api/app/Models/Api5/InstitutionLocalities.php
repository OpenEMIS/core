...
/**
 * @OA\PathItem(
 *     path="/api/v5/institution-localities"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/institution-localities",
 *     summary="Get list of InstitutionLocalities",
 *     tags={"InstitutionLocalities"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/institution-localities",
 *     summary="Create a new InstitutionLocalities",
 *     tags={"InstitutionLocalities"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-localities/{id}",
 *     summary="Get InstitutionLocalities by ID",
 *     tags={"InstitutionLocalities"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionLocalities",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/institution-localities/{id}",
 *     summary="Update InstitutionLocalities",
 *     tags={"InstitutionLocalities"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-localities/{id}",
 *     summary="Delete InstitutionLocalities",
 *     tags={"InstitutionLocalities"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
