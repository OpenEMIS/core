...
/**
 * @OA\PathItem(
 *     path="/api/v5/institution-ownerships"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/institution-ownerships",
 *     summary="Get list of InstitutionOwnerships",
 *     tags={"InstitutionOwnerships"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/institution-ownerships",
 *     summary="Create a new InstitutionOwnerships",
 *     tags={"InstitutionOwnerships"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-ownerships/{id}",
 *     summary="Get InstitutionOwnerships by ID",
 *     tags={"InstitutionOwnerships"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionOwnerships",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/institution-ownerships/{id}",
 *     summary="Update InstitutionOwnerships",
 *     tags={"InstitutionOwnerships"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-ownerships/{id}",
 *     summary="Delete InstitutionOwnerships",
 *     tags={"InstitutionOwnerships"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
