...
/**
 * @OA\PathItem(
 *     path="/api/v5/summary-grade-status-genders"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/summary-grade-status-genders",
 *     summary="Get list of SummaryGradeStatusGenders",
 *     tags={"SummaryGradeStatusGenders"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 *                     type="object",
                          ...
                          @OA\Property(property="student_status_name", type="string", example=null),
 ...
 * @OA\Post(
 *     path="/api/v5/summary-grade-status-genders",
 *     summary="Create a new SummaryGradeStatusGenders",
 *     tags={"SummaryGradeStatusGenders"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/summary-grade-status-genders/{id}",
 *     summary="Get SummaryGradeStatusGenders by ID",
 *     tags={"SummaryGradeStatusGenders"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the SummaryGradeStatusGenders",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/summary-grade-status-genders/{id}",
 *     summary="Update SummaryGradeStatusGenders",
 *     tags={"SummaryGradeStatusGenders"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/summary-grade-status-genders/{id}",
 *     summary="Delete SummaryGradeStatusGenders",
 *     tags={"SummaryGradeStatusGenders"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
