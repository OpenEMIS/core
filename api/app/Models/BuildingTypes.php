 ...
 * @OA\Get(
 *     path="/api/v5/building-types",
 *     summary="Get list of BuildingTypes",
 *     tags={"BuildingTypes"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
...
/**
 * @OA\Get(
 *     path="/api/v5/building-types/{id}",
 *     summary="Get BuildingTypes by ID",
 *     tags={"BuildingTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the BuildingTypes",
 ...
 * @OA\Post(
 *     path="/api/v5/building-types",
 *     summary="Create a new BuildingTypes",
 *     tags={"BuildingTypes"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
