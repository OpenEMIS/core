...
/**
 * @OA\PathItem(
 *     path="/api/v5/institution-shifts"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/institution-shifts",
 *     summary="Get list of InstitutionShifts",
 *     tags={"InstitutionShifts"},
 *     @OA\Response(
 *         response=200,
 ...
 *                     type="object",
                          ...
                          @OA\Property(property="location_institution_id", type="integer", example=null),
                          @OA\Property(property="shift_option_id", type="integer", example=null),
                          @OA\Property(property="previous_shift_id", type="integer", example=null),
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-shifts/{id}",
 *     summary="Get InstitutionShifts by ID",
 *     tags={"InstitutionShifts"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionShifts",
 ...
 * @OA\Post(
 *     path="/api/v5/institution-shifts",
 *     summary="Create a new InstitutionShifts",
 *     tags={"InstitutionShifts"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
 ...
 * @OA\Put(
 *     path="/api/v5/institution-shifts/{id}",
 *     summary="Update InstitutionShifts",
 *     tags={"InstitutionShifts"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-shifts/{id}",
 *     summary="Delete InstitutionShifts",
 *     tags={"InstitutionShifts"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
