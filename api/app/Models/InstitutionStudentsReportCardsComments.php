...
/**
 * @OA\Get(
 *     path="/api/v5/institution-students_report_cards_comments/report_card_id/{report_card_id}/student_id/{student_id}/institution_id/{institution_id}/academic_period_id/{academic_period_id}/education_grade_id/{education_grade_id}/education_subject_id/{education_subject_id}",
