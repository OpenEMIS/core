...
/**
 * @OA\Get(
 *     path="/api/v5/outcome-criterias/id/{id}/academic_period_id/{academic_period_id}/outcome_template_id/{outcome_template_id}/education_grade_id/{education_grade_id}/education_subject_id/{education_subject_id}",
