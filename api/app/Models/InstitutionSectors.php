...
/**
 * @OA\PathItem(
 *     path="/api/v5/institution-sectors"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/institution-sectors",
 *     summary="Get list of InstitutionSectors",
 *     tags={"InstitutionSectors"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/institution-sectors",
 *     summary="Create a new InstitutionSectors",
 *     tags={"InstitutionSectors"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-sectors/{id}",
 *     summary="Get InstitutionSectors by ID",
 *     tags={"InstitutionSectors"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionSectors",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/institution-sectors/{id}",
 *     summary="Update InstitutionSectors",
 *     tags={"InstitutionSectors"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-sectors/{id}",
 *     summary="Delete InstitutionSectors",
 *     tags={"InstitutionSectors"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
