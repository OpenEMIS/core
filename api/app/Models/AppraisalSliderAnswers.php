...
class AppraisalSliderAnswers extends Model
{
    use HasFactory;

    protected $table = 'appraisal_slider_answers';
...
/**
 * @OA\PathItem(
 *     path="/api/v5/appraisal-slider-answers"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/appraisal-slider-answers",
 *     summary="Get list of AppraisalSliderAnswers",
 ...
 * @OA\Post(
 *     path="/api/v5/appraisal-slider-answers",
 *     summary="Create a new AppraisalSliderAnswers",
 *     tags={"AppraisalSliderAnswers"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/appraisal1-2slider_answers/appraisal_form_id/{appraisal_form_id}/appraisal_criteria_id/{appraisal_criteria_id}/institution_staff_appraisal_id/{institution_staff_appraisal_id}",
