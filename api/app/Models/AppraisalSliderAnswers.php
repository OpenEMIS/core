...
/**
 * @OA\Get(
 *     path="/api/v5/appraisal-slider-answers/{id}",
 *     summary="Get AppraisalSliderAnswers by ID",
 *     tags={"AppraisalSliderAnswers"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the AppraisalSliderAnswers",
 ...
 * @OA\Put(
 *     path="/api/v5/appraisal-slider-answers/{id}",
 *     summary="Update AppraisalSliderAnswers",
 *     tags={"AppraisalSliderAnswers"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/appraisal-slider-answers/{id}",
 *     summary="Delete AppraisalSliderAnswers",
 *     tags={"AppraisalSliderAnswers"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
