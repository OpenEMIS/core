...
/**
 * @OA\Get(
 *     path="/api/v5/appraisal-score-answers/{id}",
 *     summary="Get AppraisalScoreAnswers by ID",
 *     tags={"AppraisalScoreAnswers"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the AppraisalScoreAnswers",
 ...
 * @OA\Put(
 *     path="/api/v5/appraisal-score-answers/{id}",
 *     summary="Update AppraisalScoreAnswers",
 *     tags={"AppraisalScoreAnswers"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/appraisal-score-answers/{id}",
 *     summary="Delete AppraisalScoreAnswers",
 *     tags={"AppraisalScoreAnswers"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
