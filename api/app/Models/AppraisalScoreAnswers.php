...
/**
 * @OA\PathItem(
 *     path="/api/v5/appraisal-score-answers"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/appraisal-score-answers",
 *     summary="Get list of AppraisalScoreAnswers",
 *     tags={"AppraisalScoreAnswers"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 *                     type="object",
                          ...
                          @OA\Property(property="answer", type="number", example=null),
 ...
 * @OA\Post(
 *     path="/api/v5/appraisal-score-answers",
 *     summary="Create a new AppraisalScoreAnswers",
 *     tags={"AppraisalScoreAnswers"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/appraisal1-2score_answers/appraisal_form_id/{appraisal_form_id}/appraisal_criteria_id/{appraisal_criteria_id}/institution_staff_appraisal_id/{institution_staff_appraisal_id}",
 *     summary="Get AppraisalScoreAnswers record by composite key",
 *     tags={"AppraisalScoreAnswers"},
 *     @OA\Parameter(
 ...
 * @OA\Put(
 *     path="/api/v5/appraisal1-2score_answers/appraisal_form_id/{appraisal_form_id}/appraisal_criteria_id/{appraisal_criteria_id}/institution_staff_appraisal_id/{institution_staff_appraisal_id}",
 *     summary="Update AppraisalScoreAnswers record by composite key",
 *     tags={"AppraisalScoreAnswers"},
 *     @OA\Parameter(
 *         name="appraisal_form_id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/appraisal1-2score_answers/appraisal_form_id/{appraisal_form_id}/appraisal_criteria_id/{appraisal_criteria_id}/institution_staff_appraisal_id/{institution_staff_appraisal_id}",
 *     summary="Delete AppraisalScoreAnswers record by composite key",
 *     tags={"AppraisalScoreAnswers"},
 *     @OA\Parameter(
 *         name="appraisal_form_id",
 *         in="path",
