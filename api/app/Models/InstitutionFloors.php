...
/**
 * @OA\PathItem(
 *     path="/api/v5/institution-floors"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/institution-floors",
 *     summary="Get list of InstitutionFloors",
 *     tags={"InstitutionFloors"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 *                     type="object",
                          ...
                          @OA\Property(property="institution_building_id", type="integer", example=null),
                          @OA\Property(property="institution_id", type="integer", example=null),
                          @OA\Property(property="floor_type_id", type="integer", example=null),
                          @OA\Property(property="floor_status_id", type="integer", example=null),
                          @OA\Property(property="infrastructure_condition_id", type="integer", example=null),
                          @OA\Property(property="previous_institution_floor_id", type="integer", example=null),
 ...
 * @OA\Post(
 *     path="/api/v5/institution-floors",
 *     summary="Create a new InstitutionFloors",
 *     tags={"InstitutionFloors"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-floors/{id}",
 *     summary="Get InstitutionFloors by ID",
 *     tags={"InstitutionFloors"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionFloors",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/institution-floors/{id}",
 *     summary="Update InstitutionFloors",
 *     tags={"InstitutionFloors"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-floors/{id}",
 *     summary="Delete InstitutionFloors",
 *     tags={"InstitutionFloors"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
