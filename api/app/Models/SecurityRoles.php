 ...
 * @OA\Get(
 *     path="/api/v5/security-roles",
 *     summary="Get list of SecurityRoles",
 *     tags={"SecurityRoles"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
...
/**
 * @OA\Get(
 *     path="/api/v5/security-roles/{id}",
 *     summary="Get SecurityRoles by ID",
 *     tags={"SecurityRoles"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the SecurityRoles",
 ...
 * @OA\Post(
 *     path="/api/v5/security-roles",
 *     summary="Create a new SecurityRoles",
 *     tags={"SecurityRoles"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
