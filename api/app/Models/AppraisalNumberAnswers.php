...
/**
 * @OA\Get(
 *     path="/api/v5/appraisal1-2number_answers/appraisal_form_id/{appraisal_form_id}/appraisal_criteria_id/{appraisal_criteria_id}/institution_staff_appraisal_id/{institution_staff_appraisal_id}",
 *     summary="Get AppraisalNumberAnswers record by composite key",
 *     tags={"AppraisalNumberAnswers"},
 *     @OA\Parameter(
 ...
 * @OA\Put(
 *     path="/api/v5/appraisal1-2number_answers/appraisal_form_id/{appraisal_form_id}/appraisal_criteria_id/{appraisal_criteria_id}/institution_staff_appraisal_id/{institution_staff_appraisal_id}",
 *     summary="Update AppraisalNumberAnswers record by composite key",
 *     tags={"AppraisalNumberAnswers"},
 *     @OA\Parameter(
 *         name="appraisal_form_id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/appraisal1-2number_answers/appraisal_form_id/{appraisal_form_id}/appraisal_criteria_id/{appraisal_criteria_id}/institution_staff_appraisal_id/{institution_staff_appraisal_id}",
 *     summary="Delete AppraisalNumberAnswers record by composite key",
 *     tags={"AppraisalNumberAnswers"},
 *     @OA\Parameter(
 *         name="appraisal_form_id",
 *         in="path",
