...
/**
 * @OA\PathItem(
 *     path="/api/v5/staff-profile-templates"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/staff-profile-templates",
 *     summary="Get list of StaffProfileTemplates",
 *     tags={"StaffProfileTemplates"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
...
/**
 * @OA\Get(
 *     path="/api/v5/staff-profile-templates/{id}",
 *     summary="Get StaffProfileTemplates by ID",
 *     tags={"StaffProfileTemplates"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the StaffProfileTemplates",
 ...
 * @OA\Post(
 *     path="/api/v5/staff-profile-templates",
 *     summary="Create a new StaffProfileTemplates",
 *     tags={"StaffProfileTemplates"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
 ...
 * @OA\Put(
 *     path="/api/v5/staff-profile-templates/{id}",
 *     summary="Update StaffProfileTemplates",
 *     tags={"StaffProfileTemplates"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/staff-profile-templates/{id}",
 *     summary="Delete StaffProfileTemplates",
 *     tags={"StaffProfileTemplates"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
