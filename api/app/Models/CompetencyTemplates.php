...
/**
 * @OA\PathItem(
 *     path="/api/v5/competency-templates"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/competency-templates",
 *     summary="Get list of CompetencyTemplates",
 *     tags={"CompetencyTemplates"},
 *     @OA\Response(
 *         response=200,
...
/**
 * @OA\Get(
 *     path="/api/v5/competency-templates/{id}",
 *     summary="Get CompetencyTemplates by ID",
 *     tags={"CompetencyTemplates"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the CompetencyTemplates",
 ...
 * @OA\Post(
 *     path="/api/v5/competency-templates",
 *     summary="Create a new CompetencyTemplates",
 *     tags={"CompetencyTemplates"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
 ...
 * @OA\Put(
 *     path="/api/v5/competency-templates/{id}",
 *     summary="Update CompetencyTemplates",
 *     tags={"CompetencyTemplates"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/competency-templates/{id}",
 *     summary="Delete CompetencyTemplates",
 *     tags={"CompetencyTemplates"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
