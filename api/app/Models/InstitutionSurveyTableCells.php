...
/**
 * @OA\Get(
 *     path="/api/v5/institution1-2survey_table_cells/survey_question_id/{survey_question_id}/survey_table_column_id/{survey_table_column_id}/survey_table_row_id/{survey_table_row_id}/institution_survey_id/{institution_survey_id}",
 ...
 *     ),
 *     @OA\Parameter(
 *         name="institution_survey_id",
 *         in="path",
 *         required=true,
 *         description="institution_survey_id",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
