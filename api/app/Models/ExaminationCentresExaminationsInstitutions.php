...
/**
 * @OA\Get(
 *     path="/api/v5/examination_centres_examinations_institutions/examination_centre_id/{examination_centre_id}/examination_id/{examination_id}/institution_id/{institution_id}",
