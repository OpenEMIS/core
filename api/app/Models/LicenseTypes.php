 ...
 * @OA\Get(
 *     path="/api/v5/license-types",
 *     summary="Get list of LicenseTypes",
 *     tags={"LicenseTypes"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 ...
 * @OA\Post(
 *     path="/api/v5/license-types",
 *     summary="Create a new LicenseTypes",
 *     tags={"LicenseTypes"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/license-types/{id}",
 *     summary="Get LicenseTypes by ID",
 *     tags={"LicenseTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the LicenseTypes",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
