...
/**
 * @OA\Get(
 *     path="/api/v5/custom1-2table_cells/custom_field_id/{custom_field_id}/custom_table_column_id/{custom_table_column_id}/custom_table_row_id/{custom_table_row_id}/custom_record_id/{custom_record_id}",
