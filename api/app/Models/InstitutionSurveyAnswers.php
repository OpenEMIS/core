...
/**
 * @OA\PathItem(
 *     path="/api/v5/institution-survey-answers"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/institution-survey-answers",
 *     summary="Get list of InstitutionSurveyAnswers",
 *     tags={"InstitutionSurveyAnswers"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 * @OA\Post(
 *     path="/api/v5/institution-survey-answers",
 *     summary="Create a new InstitutionSurveyAnswers",
 *     tags={"InstitutionSurveyAnswers"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-survey-answers/{id}",
 *     summary="Get InstitutionSurveyAnswers by ID",
 *     tags={"InstitutionSurveyAnswers"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionSurveyAnswers",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/institution-survey-answers/{id}",
 *     summary="Update InstitutionSurveyAnswers",
 *     tags={"InstitutionSurveyAnswers"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-survey-answers/{id}",
 *     summary="Delete InstitutionSurveyAnswers",
 *     tags={"InstitutionSurveyAnswers"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
