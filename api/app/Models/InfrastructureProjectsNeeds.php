...
/**
 * @OA\Get(
 *     path="/api/v5/infrastructure1-2projects_needs/infrastructure_project_id/{infrastructure_project_id}/infrastructure_need_id/{infrastructure_need_id}",
 *     summary="Get InfrastructureProjectsNeeds record by composite key",
 *     tags={"InfrastructureProjectsNeeds"},
 *     @OA\Parameter(
 *         name="infrastructure_project_id",
 *         in="path",
 *         required=true,
 *         description="infrastructure_project_id",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Parameter(
 *         name="infrastructure_need_id",
 *         in="path",
 *         required=true,
 *         description="infrastructure_need_id",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
