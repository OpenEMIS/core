 ...
 * @OA\Get(
 *     path="/api/v5/identity-types",
 *     summary="Get list of IdentityTypes",
 *     tags={"IdentityTypes"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 ...
 *                     type="object",
                          ...
                          @OA\Property(property="validation_pattern", type="string", example=null),
 ...
 * @OA\Post(
 *     path="/api/v5/identity-types",
 *     summary="Create a new IdentityTypes",
 *     tags={"IdentityTypes"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/identity-types/{id}",
 *     summary="Get IdentityTypes by ID",
 *     tags={"IdentityTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the IdentityTypes",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
