...
class ProfileTemplates extends Model
{
    use HasFactory;
 ...
 * @OA\Get(
 *     path="/api/v5/profile-templates",
 *     summary="Get list of ProfileTemplates",
 *     tags={"ProfileTemplates"},
 *     @OA\Response(
 *         response=200,
...
/**
 * @OA\Get(
 *     path="/api/v5/profile-templates/{id}",
 *     summary="Get ProfileTemplates by ID",
 *     tags={"ProfileTemplates"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the ProfileTemplates",
 ...
 * @OA\Post(
 *     path="/api/v5/profile-templates",
 *     summary="Create a new ProfileTemplates",
 *     tags={"ProfileTemplates"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
 ...
 * @OA\Put(
 *     path="/api/v5/profile-templates/{id}",
 *     summary="Update ProfileTemplates",
 *     tags={"ProfileTemplates"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/profile-templates/{id}",
 *     summary="Delete ProfileTemplates",
 *     tags={"ProfileTemplates"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
