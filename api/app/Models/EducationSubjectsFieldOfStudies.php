...
class EducationSubjectsFieldOfStudies extends Model
{
    use HasFactory;

    protected $table = 'education_subjects_field_of_studies';

    // ✅ Allow mass assignment
    protected $fillable = ['id', 'education_subject_id', 'education_field_of_study_id', 'modified_user_id', 'modified', 'created_user_id', 'created'];
    ...
    protected $primaryKey = ['education_subject_id', 'education_field_of_study_id'];
 ...
 * @OA\Get(
 *     path="/api/v5/education-subjects-field-of-studies",
 *     summary="Get list of EducationSubjectsFieldOfStudies",
...
/**
 * @OA\Get(
 *     path="/api/v5/education-subjects-field-of-studies/education_subject_id/{education_subject_id}/education_field_of_study_id/{education_field_of_study_id}",
