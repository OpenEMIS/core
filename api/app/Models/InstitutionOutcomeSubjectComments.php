...
/**
 * @OA\Get(
 *     path="/api/v5/institution_outcome_subject_comments/student_id/{student_id}/outcome_template_id/{outcome_template_id}/outcome_period_id/{outcome_period_id}/education_grade_id/{education_grade_id}/education_subject_id/{education_subject_id}/institution_id/{institution_id}/academic_period_id/{academic_period_id}",
