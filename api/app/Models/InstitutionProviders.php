...
/**
 * @OA\PathItem(
 *     path="/api/v5/institution-providers"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/institution-providers",
 *     summary="Get list of InstitutionProviders",
 *     tags={"InstitutionProviders"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-providers/{id}",
 *     summary="Get InstitutionProviders by ID",
 *     tags={"InstitutionProviders"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionProviders",
 ...
 * @OA\Post(
 *     path="/api/v5/institution-providers",
 *     summary="Create a new InstitutionProviders",
 *     tags={"InstitutionProviders"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
 ...
 * @OA\Put(
 *     path="/api/v5/institution-providers/{id}",
 *     summary="Update InstitutionProviders",
 *     tags={"InstitutionProviders"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-providers/{id}",
 *     summary="Delete InstitutionProviders",
 *     tags={"InstitutionProviders"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
