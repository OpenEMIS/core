...
/**
 * @OA\Get(
 *     path="/api/v5/staff1-2custom_table_cells/staff_custom_field_id/{staff_custom_field_id}/staff_custom_table_column_id/{staff_custom_table_column_id}/staff_custom_table_row_id/{staff_custom_table_row_id}/staff_id/{staff_id}",
 *     summary="Get StaffCustomTableCells record by composite key",
 *     tags={"StaffCustomTableCells"},
 *     @OA\Parameter(
 *         name="staff_custom_field_id",
 *         in="path",
 *         required=true,
 *         description="staff_custom_field_id",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Parameter(
 *         name="staff_custom_table_column_id",
 *         in="path",
 *         required=true,
 *         description="staff_custom_table_column_id",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Parameter(
 *         name="staff_custom_table_row_id",
 *         in="path",
 *         required=true,
 *         description="staff_custom_table_row_id",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Parameter(
 *         name="staff_id",
