...
/**
 * @OA\Get(
 *     path="/api/v5/staff_custom_table_cells/staff_custom_field_id/{staff_custom_field_id}/staff_custom_table_column_id/{staff_custom_table_column_id}/staff_custom_table_row_id/{staff_custom_table_row_id}/staff_id/{staff_id}",
