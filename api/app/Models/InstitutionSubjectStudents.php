...
/**
 * @OA\Get(
 *     path="/api/v5/institution_subject_students/student_id/{student_id}/institution_class_id/{institution_class_id}/institution_id/{institution_id}/academic_period_id/{academic_period_id}/education_subject_id/{education_subject_id}/education_grade_id/{education_grade_id}",
