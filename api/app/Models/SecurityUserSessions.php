...
class SecurityUserSessions extends Model
{
    use HasFactory;

    protected $table = 'security_user_sessions';
 ...
 * @OA\Get(
 *     path="/api/v5/security-user-sessions",
 *     summary="Get list of SecurityUserSessions",
...
/**
 * @OA\Get(
 *     path="/api/v5/security1-2user_sessions/id/{id}/username/{username}",
