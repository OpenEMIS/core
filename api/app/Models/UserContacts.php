 ...
 * @OA\Get(
 *     path="/api/v5/user-contacts",
 *     summary="Get list of UserContacts",
 *     tags={"UserContacts"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 ...
 *                     type="object",
                          ...
                          @OA\Property(property="contact_type_id", type="integer", example=null),
...
/**
 * @OA\Get(
 *     path="/api/v5/user-contacts/{id}",
 *     summary="Get UserContacts by ID",
 *     tags={"UserContacts"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the UserContacts",
 ...
 * @OA\Post(
 *     path="/api/v5/user-contacts",
 *     summary="Create a new UserContacts",
 *     tags={"UserContacts"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
