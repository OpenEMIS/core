 ...
 * @OA\Get(
 *     path="/api/v5/institution-types",
 *     summary="Get list of InstitutionTypes",
 *     tags={"InstitutionTypes"},
 *     @OA\Response(
 *         response=200,
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-types/{id}",
 *     summary="Get InstitutionTypes by ID",
 *     tags={"InstitutionTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionTypes",
 ...
 * @OA\Post(
 *     path="/api/v5/institution-types",
 *     summary="Create a new InstitutionTypes",
 *     tags={"InstitutionTypes"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
 ...
 * @OA\Put(
 *     path="/api/v5/institution-types/{id}",
 *     summary="Update InstitutionTypes",
 *     tags={"InstitutionTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-types/{id}",
 *     summary="Delete InstitutionTypes",
 *     tags={"InstitutionTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
