 ...
 * @OA\Get(
 *     path="/api/v5/insurance-types",
 *     summary="Get list of InsuranceTypes",
 *     tags={"InsuranceTypes"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 ...
 * @OA\Post(
 *     path="/api/v5/insurance-types",
 *     summary="Create a new InsuranceTypes",
 *     tags={"InsuranceTypes"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/insurance-types/{id}",
 *     summary="Get InsuranceTypes by ID",
 *     tags={"InsuranceTypes"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InsuranceTypes",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
