...
class ExaminationCentreSpecialNeeds extends Model
{
    use HasFactory;

    protected $table = 'examination_centre_special_needs';

    // ✅ Allow mass assignment
    protected $fillable = ['id', 'examination_centre_id', 'special_need_type_id', 'created_user_id', 'created'];
    ...
    protected $primaryKey = ['examination_centre_id', 'special_need_type_id'];
...
/**
 * @OA\Get(
 *     path="/api/v5/examination1-2centre_special_needs/examination_centre_id/{examination_centre_id}/special_need_type_id/{special_need_type_id}",
 ...
 *     ),
 *     @OA\Parameter(
 *         name="special_need_type_id",
 *         in="path",
 *         required=true,
 *         description="special_need_type_id",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
