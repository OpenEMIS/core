...
/**
 * @OA\Get(
 *     path="/api/v5/appraisal_forms_criterias_scores_links/appraisal_form_id/{appraisal_form_id}/appraisal_criteria_id/{appraisal_criteria_id}/appraisal_criteria_linked_id/{appraisal_criteria_linked_id}",
