...
class SecurityRoleFunctions extends Model
{
    ...
    protected $fillable = ['_view', '_edit', '_add', '_delete', '_execute', 'security_role_id', 'security_function_id', 'modified_user_id', 'modified', 'created_user_id', 'created', 'security_role_id', 'security_function_id', 'modified_user_id', 'created_user_id'];
