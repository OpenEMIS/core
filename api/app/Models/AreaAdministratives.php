...
/**
 * @OA\PathItem(
 *     path="/api/v5/area-administratives"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/area-administratives",
 *     summary="Get list of AreaAdministratives",
 *     tags={"AreaAdministratives"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 *                     type="object",
                          ...
                          @OA\Property(property="is_main_country", type="integer", example=null),
                          @OA\Property(property="parent_id", type="integer", example=null),
                          @OA\Property(property="lft", type="integer", example=null),
                          @OA\Property(property="rght", type="integer", example=null),
                          @OA\Property(property="area_administrative_level_id", type="integer", example=null),
 ...
 * @OA\Post(
 *     path="/api/v5/area-administratives",
 *     summary="Create a new AreaAdministratives",
 *     tags={"AreaAdministratives"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
...
/**
 * @OA\Get(
 *     path="/api/v5/area-administratives/{id}",
 *     summary="Get AreaAdministratives by ID",
 *     tags={"AreaAdministratives"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the AreaAdministratives",
 *         @OA\Schema(type="string")
 *     ),
 *     @OA\Response(
 *         response=200,
 ...
 * @OA\Put(
 *     path="/api/v5/area-administratives/{id}",
 *     summary="Update AreaAdministratives",
 *     tags={"AreaAdministratives"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/area-administratives/{id}",
 *     summary="Delete AreaAdministratives",
 *     tags={"AreaAdministratives"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
