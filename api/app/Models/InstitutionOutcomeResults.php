...
/**
 * @OA\PathItem(
 *     path="/api/v5/institution-outcome-results"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/institution-outcome-results",
 *     summary="Get list of InstitutionOutcomeResults",
 ...
 *                     type="object",
                          ...
                          @OA\Property(property="outcome_grading_option_id", type="integer", example=null),
                          ...
                          @OA\Property(property="outcome_criteria_id", type="integer", example=null),
...
/**
 * @OA\Get(
 *     path="/api/v5/institution-outcome-results/{id}",
 *     summary="Get InstitutionOutcomeResults by ID",
 *     tags={"InstitutionOutcomeResults"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the InstitutionOutcomeResults",
 ...
 * @OA\Post(
 *     path="/api/v5/institution-outcome-results",
 *     summary="Create a new InstitutionOutcomeResults",
 *     tags={"InstitutionOutcomeResults"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
 ...
 * @OA\Put(
 *     path="/api/v5/institution-outcome-results/{id}",
 *     summary="Update InstitutionOutcomeResults",
 *     tags={"InstitutionOutcomeResults"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/institution-outcome-results/{id}",
 *     summary="Delete InstitutionOutcomeResults",
 *     tags={"InstitutionOutcomeResults"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
