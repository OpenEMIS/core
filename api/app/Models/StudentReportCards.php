...
/**
 * @OA\Get(
 *     path="/api/v5/student_report_cards/student_profile_template_id/{student_profile_template_id}/student_id/{student_id}/institution_id/{institution_id}/academic_period_id/{academic_period_id}",
