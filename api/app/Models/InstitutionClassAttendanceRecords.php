...
/**
 * @OA\Get(
 *     path="/api/v5/institution_class_attendance_records/institution_class_id/{institution_class_id}/academic_period_id/{academic_period_id}/year/{year}/month/{month}",
