 ...
 * @OA\Get(
 *     path="/api/v5/survey-table-rows",
 *     summary="Get list of SurveyTableRows",
 *     tags={"SurveyTableRows"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
...
/**
 * @OA\Get(
 *     path="/api/v5/survey-table-rows/{id}",
 *     summary="Get SurveyTableRows by ID",
 *     tags={"SurveyTableRows"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the SurveyTableRows",
 ...
 * @OA\Post(
 *     path="/api/v5/survey-table-rows",
 *     summary="Create a new SurveyTableRows",
 *     tags={"SurveyTableRows"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
 ...
 * @OA\Put(
 *     path="/api/v5/survey-table-rows/{id}",
 *     summary="Update SurveyTableRows",
 *     tags={"SurveyTableRows"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/survey-table-rows/{id}",
 *     summary="Delete SurveyTableRows",
 *     tags={"SurveyTableRows"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
