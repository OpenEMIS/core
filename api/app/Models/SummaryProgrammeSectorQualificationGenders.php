...
class SummaryProgrammeSectorQualificationGenders extends Model
{
    use HasFactory;

    protected $table = 'summary_programme_sector_qualification_genders';

    // ✅ Allow mass assignment
    protected $fillable = ['academic_period_id', 'academic_period_name', 'institution_sector_id', 'institution_sector_name', 'education_system_id', 'education_system_name', 'education_level_isced_id', 'education_level_isced_name', 'education_level_isced_level', 'education_level_id', 'education_level_name', 'education_cycle_id', 'education_cycle_name', 'education_programme_id', 'education_programme_code', 'education_programme_name', 'staff_gender_id', 'staff_gender_name', 'staff_qualification_title_id', 'staff_qualification_title_name', 'total_staff_teaching', 'total_staff_teaching_newly_recruited'];
...
/**
 * @OA\PathItem(
 *     path="/api/v5/summary-programme-sector-qualification-genders"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/summary-programme-sector-qualification-genders",
 *     summary="Get list of SummaryProgrammeSectorQualificationGenders",
 *     tags={"SummaryProgrammeSectorQualificationGenders"},
 *     @OA\Parameter(
 *         name="limit",
 *         in="query",
 *         required=false,
 ...
 *                     type="object",
                          ...
                          @OA\Property(property="staff_gender_id", type="integer", example=null),
                          @OA\Property(property="staff_gender_name", type="string", example=null),
                          @OA\Property(property="staff_qualification_title_id", type="integer", example=null),
                          @OA\Property(property="staff_qualification_title_name", type="string", example=null),
...
/**
 * @OA\Get(
 *     path="/api/v5/summary-programme-sector-qualification-genders/{id}",
 *     summary="Get SummaryProgrammeSectorQualificationGenders by ID",
 *     tags={"SummaryProgrammeSectorQualificationGenders"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the SummaryProgrammeSectorQualificationGenders",
 ...
 * @OA\Post(
 *     path="/api/v5/summary-programme-sector-qualification-genders",
 *     summary="Create a new SummaryProgrammeSectorQualificationGenders",
 *     tags={"SummaryProgrammeSectorQualificationGenders"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
 ...
 * @OA\Put(
 *     path="/api/v5/summary-programme-sector-qualification-genders/{id}",
 *     summary="Update SummaryProgrammeSectorQualificationGenders",
 *     tags={"SummaryProgrammeSectorQualificationGenders"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/summary-programme-sector-qualification-genders/{id}",
 *     summary="Delete SummaryProgrammeSectorQualificationGenders",
 *     tags={"SummaryProgrammeSectorQualificationGenders"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
