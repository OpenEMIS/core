...
/**
 * @OA\PathItem(
 *     path="/api/v5/competency-criterias"
 * )
 */
 ...
 * @OA\Get(
 *     path="/api/v5/competency-criterias",
 *     summary="Get list of CompetencyCriterias",
 *     tags={"CompetencyCriterias"},
 *     @OA\Response(
 *         response=200,
...
/**
 * @OA\Get(
 *     path="/api/v5/competency-criterias/{id}",
 *     summary="Get CompetencyCriterias by ID",
 *     tags={"CompetencyCriterias"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 *         required=true,
 *         description="ID of the CompetencyCriterias",
 ...
 * @OA\Post(
 *     path="/api/v5/competency-criterias",
 *     summary="Create a new CompetencyCriterias",
 *     tags={"CompetencyCriterias"},
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
 ...
 * @OA\Put(
 *     path="/api/v5/competency-criterias/{id}",
 *     summary="Update CompetencyCriterias",
 *     tags={"CompetencyCriterias"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
 ...
 * @OA\Delete(
 *     path="/api/v5/competency-criterias/{id}",
 *     summary="Delete CompetencyCriterias",
 *     tags={"CompetencyCriterias"},
 *     @OA\Parameter(
 *         name="id",
 *         in="path",
